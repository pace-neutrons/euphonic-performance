...
|   o-> phonon_real_to_fine                      3572        3572      3.44s  |
|   o-> phonon_enforce_dmat_sumrule              3571        3571     33.80s  |
|   o-> phonon_prepare_and_diagonalise           3571        3571      5.41s  |
|   o-> phonon_accumulate_adp                    3571        3571      0.15s  |
|   o-> comms_send_complex                       3571        3571    552.86s  |
...
|   o-> phonon_diagonalise_d_cmplx              10713       10713      6.79s  |
|   o-> secondd_find_acoustics                   3571        3571      0.37s  |
|   o-> secondd_symmetrize_dmat_cmplx            3571        3571     26.07s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_real_to_fine                      3572                         |
|  /o-- phonon_enforce_dmat_sumrule              3571                         |
|  /o-- phonon_prepare_and_diagonalise           3571                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx             10714       10714     31.66s  |
|    /                                                                        |
|   o-> two_q_is_a_g                            10714       10714      0.03s  |
|   o-> hermitian4                              10714       10714      0.11s  |
|   o-> cell_copy_symmetry                      21428       21428      0.19s  |
|   o-> cell_reduce_symmetry_ops_wrapped        10714       10714      3.55s  |
|   o-> secondd_group_symmetrize_dmat           10714       10714     23.65s  |
|   o-> cell_deallocate                         10714       10714      0.04s  |
|   o-> secondd_find_inversion                  10714       10714      0.04s  |
|   o-> secondd_tr_symmetrize_dmat              10714       10714      3.66s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> model_continuation                            1           1     28.35s  |
...
|   o-> ion_initialise                              1           1     18.49s  |
|   o-> basis_initialise                            2           2      0.63s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion     189320      189320     20.54s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          189320                         |
|  /o-- secondd_tr_symmetrize_dmat              10714                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       200034      200034     21.74s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            200034      200034      6.97s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_generate_psp                       3           3     16.67s  |
|   o-> ion_set_data                                3           3      0.16s  |
|   o-> ion_atom_deallocate_pspot                   7           7      0.00s  |
|   o-> ion_set_psp                                 3           3      0.05s  |
|   o-> ion_atom_pseudo_scf                         3           3      1.51s  |
...
|   o-> ion_atom_radial_transform                  92          92      2.64s  |
...
|  /o-- phonon_prepare_and_diagonalise           3571                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                14284       14284      9.09s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> cell_reread                                   1           1      8.76s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            3571        3571      2.80s  |
|   o-> phonon_constrain_dmat                    3571        3571      0.01s  |
|   o-> phonon_mass_weight_dmat                  3571        3571      0.04s  |
|   o-> phonon_diagonalise_d_cmplx               3571        3571      2.30s  |
+-----------------------------------------------------------------------------+
...
| O-> secondd_tr_symmetrize_dmat                10714       10714      3.66s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                10714       10714      2.25s  |
...
| O-> cell_reduce_symmetry_ops_wrapped          10714       10714      3.55s  |
|    /                                                                        |
|   o-> cell_check_group                        10714       10714      3.36s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            3572        3572      2.79s  |
+-----------------------------------------------------------------------------+
...
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.21s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           10714                         |
|  /o-- secondd_tr_symmetrize_dmat              10714                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  21428       21428      2.35s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            350014      350014      1.11s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                          108         108      1.07s  |
...
| |/                                                                          |
| O-> ion_atom_regin                           158454      158454      0.56s  |
+-----------------------------------------------------------------------------+
...
|          o-> wave_Sorthonormalise_wv              1           1      0.26s  |
|    /                                                                        |
...
| O-> wave_Sorthonormalise_wv                       1           1      0.26s  |
|    /                                                                        |
|   o-> wave_Sorthonormalise_wv_ks                  5           5      0.26s  |
+-----------------------------------------------------------------------------+
...
|   o-> wave_beta_phi_wv_ks                         5           5      0.23s  |
...
| O-> ion_all_beta_multi_phi_recip                  5           5      0.21s  |
|    /                                                                        |
|   o-> ion_beta_recip_set                          5           5      0.10s  |
...
|   o-> comms_map_transpose                         2           2      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              6                         |
|  /                                                                          |
| O-> ion_atom_allocate_pspot                       6           6      0.10s  |
...
|   o-> ion_beta_recip_interpolation             1320        1320      0.04s  |
...
| O-> comms_map_transpose                           2           2      0.09s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.09s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.09s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_send_real                            7145        7145      0.07s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
...
|   o-> model_write_occ_eigenvalues                 1           1      0.03s  |
