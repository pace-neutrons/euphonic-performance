...
|   o-> phonon_real_to_fine                      3572        3572      3.49s  |
|   o-> phonon_enforce_dmat_sumrule              3571        3571     33.86s  |
|   o-> phonon_prepare_and_diagonalise           3571        3571      5.44s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx             10714       10714     31.75s  |
|    /                                                                        |
...
|   o-> secondd_tr_symmetrize_dmat              10714       10714      3.72s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> model_continuation                            1           1     27.65s  |
...
|   o-> ion_initialise                              1           1     18.35s  |
|   o-> basis_initialise                            2           2      0.57s  |
...
|  /o-- phonon_prepare_and_diagonalise           3571                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                14284       14284      9.15s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> cell_read_wrapped                             1           1      8.74s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            350014      350014      1.14s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                          108         108      1.08s  |
...
|   o-> basis_distribute_grids                      1           1      0.17s  |
...
| O-> ion_all_beta_multi_phi_recip                  5           5      0.19s  |
|    /                                                                        |
|   o-> ion_beta_recip_set                          5           5      0.09s  |
