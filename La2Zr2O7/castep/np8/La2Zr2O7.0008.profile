...
|   o-> model_continuation                          1           1     28.35s  |
...
|   o-> phonon_calculate                            1           1    596.01s  |
...
|   o-> phonon_real_to_fine                      3572        3572      3.51s  |
|   o-> phonon_enforce_dmat_sumrule              3571        3571     33.92s  |
|   o-> phonon_prepare_and_diagonalise           3571        3571      5.46s  |
|   o-> phonon_accumulate_adp                    3571        3571      0.15s  |
|   o-> comms_send_complex                       3571        3571    552.68s  |
|   o-> comms_send_real                          7142        7142      0.04s  |
|   o-> comms_reduce_gv_real                        1           1      0.00s  |
|   o-> comms_reduce_bnd_real                       1           1      0.00s  |
|   o-> comms_reduce_kp_real                        1           1      0.09s  |
...
| O-> phonon_enforce_dmat_sumrule                3571        3571     33.92s  |
|    /                                                                        |
|   o-> phonon_mass_weight_dmat                  7142        7142      0.08s  |
|   o-> phonon_diagonalise_d_cmplx              10713       10713      6.83s  |
|   o-> secondd_find_acoustics                   3571        3571      0.37s  |
|   o-> secondd_symmetrize_dmat_cmplx            3571        3571     26.15s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_real_to_fine                      3572                         |
|  /o-- phonon_enforce_dmat_sumrule              3571                         |
|  /o-- phonon_prepare_and_diagonalise           3571                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx             10714       10714     31.86s  |
|    /                                                                        |
|   o-> two_q_is_a_g                            10714       10714      0.03s  |
|   o-> hermitian4                              10714       10714      0.11s  |
|   o-> cell_copy_symmetry                      21428       21428      0.19s  |
|   o-> cell_reduce_symmetry_ops_wrapped        10714       10714      3.56s  |
|   o-> secondd_group_symmetrize_dmat           10714       10714     23.73s  |
|   o-> cell_deallocate                         10714       10714      0.05s  |
|   o-> secondd_find_inversion                  10714       10714      0.04s  |
|   o-> secondd_tr_symmetrize_dmat              10714       10714      3.75s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> model_continuation                            1           1     28.35s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           10714                         |
|  /                                                                          |
| O-> secondd_group_symmetrize_dmat             10714       10714     23.73s  |
|    /                                                                        |
|   o-> cell_factor_group_symmetry_wrapped      10714       10714      0.14s  |
|   o-> secondd_check_equiv_ions                10714       10714      0.10s  |
|   o-> secondd_apply_symmetry_to_dmat_ion     189320      189320     20.60s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          189320                         |
|  /o-- secondd_tr_symmetrize_dmat              10714                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       200034      200034     21.80s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            200034      200034      6.98s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_construct_psp                      3           3     14.83s  |
...
|   o-> ion_atom_radial_transform                  92          92      2.55s  |
...
| |/                                                                          |
| O-> comms_gcopy_integer                         436         436     10.35s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> cell_read_wrapped                             1           1      9.16s  |
...
|   o-> comms_gcopy_integer                        64          64      9.16s  |
...
|  /o-- phonon_prepare_and_diagonalise           3571                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                14284       14284      9.14s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> cell_reread                                   1           1      8.76s  |
|    /                                                                        |
|   o-> cell_setup_keywords                         1           1      0.00s  |
|   o-> comms_gcopy_integer                        60          60      1.18s  |
|   o-> comms_gcopy_real                           78          78      7.58s  |
|   o-> comms_gcopy_character                      29          29      0.00s  |
...
| |/                                                                          |
| O-> comms_gcopy_real                            522         522      7.59s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion     200034                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases              200034      200034      6.98s  |
|    /                                                                        |
|   o-> q_is_a_g                               185766      185766      0.56s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         3571                         |
|  /                                                                          |
| O-> phonon_prepare_and_diagonalise             3571        3571      5.46s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            3571        3571      2.84s  |
|   o-> phonon_constrain_dmat                    3571        3571      0.01s  |
|   o-> phonon_mass_weight_dmat                  3571        3571      0.04s  |
|   o-> phonon_diagonalise_d_cmplx               3571        3571      2.31s  |
+-----------------------------------------------------------------------------+
...
| O-> secondd_tr_symmetrize_dmat                10714       10714      3.75s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                10714       10714      2.34s  |
|   o-> secondd_apply_symmetry_to_dmat_ion      10714       10714      1.20s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           10714                         |
|  /                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped          10714       10714      3.56s  |
|    /                                                                        |
|   o-> cell_check_group                        10714       10714      3.37s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            3572        3572      2.88s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped        10714                         |
|  /                                                                          |
| O-> cell_check_group                          10714       10714      3.37s  |
|    /                                                                        |
|   o-> algor_invert_real                      178606      178606      0.54s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           10714                         |
|  /o-- secondd_tr_symmetrize_dmat              10714                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  21428       21428      2.44s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            350014      350014      1.16s  |
+-----------------------------------------------------------------------------+
...
| O-> ion_atom_ps_diag                            108         108      1.05s  |
|    /                                                                        |
|   o-> ion_atom_regin                         139221      139221      0.48s  |
...
|   o-> basis_distribute_grids                      1           1      0.28s  |
...
|   o-> basis_count_plane_waves                     1           1      0.51s  |
...
|  /o-- secondd_compute_atom_phases            185766                         |
|  /o-- phonon_prepare_and_diagonalise           7142                         |
| |/                                                                          |
| O-> q_is_a_g                                 192918      192918      0.58s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           158454      158454      0.54s  |
+-----------------------------------------------------------------------------+
...
|  /o-- cell_check_group                       178606                         |
| |/                                                                          |
| O-> algor_invert_real                        178619      178619      0.54s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_reduce_kp_integer                     3           3      0.51s  |
+-----------------------------------------------------------------------------+
...
|          o-> wave_Sorthonormalise_wv              1           1      0.27s  |
|    /                                                                        |
...
|   o-> comms_map_transpose                         2           2      0.27s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.27s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.27s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.27s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.27s  |
+-----------------------------------------------------------------------------+
...
| O-> wave_Sorthonormalise_wv                       1           1      0.27s  |
|    /                                                                        |
|   o-> wave_Sorthonormalise_wv_ks                  5           5      0.27s  |
+-----------------------------------------------------------------------------+
|   o-- wave_Sorthonormalise_wv                     5                         |
|  /                                                                          |
| O-> wave_Sorthonormalise_wv_ks                    5           5      0.27s  |
|    /                                                                        |
|   o-> wave_calc_Soverlap_wv_ks                    5           5      0.24s  |
...
| O-> wave_calc_Soverlap_wv_ks                      5           5      0.24s  |
|    /                                                                        |
|   o-> coeffs_dot_all_self                         5           5      0.02s  |
|   o-> wave_beta_phi_wv_ks                         5           5      0.22s  |
...
|   o-> ion_all_beta_multi_phi_recip                5           5      0.21s  |
+-----------------------------------------------------------------------------+
|   o-- wave_beta_phi_wv_ks                         5                         |
|  /                                                                          |
| O-> ion_all_beta_multi_phi_recip                  5           5      0.21s  |
|    /                                                                        |
|   o-> ion_beta_recip_set                          5           5      0.11s  |
|   o-> algor_matmul_cmplx_cmplx                    5           5      0.08s  |
|   o-> comms_reduce_gv_complex                     5           5      0.02s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           21428                         |
|  /                                                                          |
| O-> cell_copy_symmetry                        21428       21428      0.19s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
...
|  /o-- phonon_prepare_and_diagonalise           3571                         |
| |/                                                                          |
| O-> phonon_mass_weight_dmat                   10713       10713      0.13s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          2                         |
|  /                                                                          |
| O-> cell_restore_wrapped                          2           2      0.13s  |
...
|   o-> ion_beta_recip_interpolation             1320        1320      0.05s  |
...
| |/                                                                          |
| O-> comms_reduce_kp_real                          3           3      0.09s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       3                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip                5                         |
|  /                                                                          |
| O-> algor_matmul_cmplx_cmplx                      5           5      0.08s  |
...
| |/                                                                          |
| O-> cell_deallocate                           10733       10733      0.05s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_complex                   15          15      0.02s  |
+-----------------------------------------------------------------------------+
...
|  /o-- wave_calc_Soverlap_wv_ks                    5                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                      10          10      0.02s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                 10          10      0.02s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_real_to_fine                      3572                         |
|  /                                                                          |
| O-> check_image_list                           3572        3572      0.02s  |
...
| O-> coeffs_dot_all_self                           5           5      0.02s  |
|    /                                                                        |
|   o-> local_dot_all_self                          5           5      0.02s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_real_to_fine                      3572                         |
| |/                                                                          |
| O-> cell_num_supercells                        3577        3577      0.01s  |
+-----------------------------------------------------------------------------+
