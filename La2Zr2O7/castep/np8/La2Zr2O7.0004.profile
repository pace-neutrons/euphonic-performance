...
|   o-> phonon_real_to_fine                      3573        3573      3.50s  |
|   o-> phonon_enforce_dmat_sumrule              3572        3572     33.85s  |
|   o-> phonon_prepare_and_diagonalise           3572        3572      5.46s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            3572        3572     26.08s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_real_to_fine                      3573                         |
|  /o-- phonon_enforce_dmat_sumrule              3572                         |
|  /o-- phonon_prepare_and_diagonalise           3572                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx             10717       10717     31.77s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat           10717       10717     23.66s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion     189383      189383     20.54s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          189383                         |
|  /o-- secondd_tr_symmetrize_dmat              10717                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       200100      200100     21.74s  |
|    /                                                                        |
...
|   o-> ion_atom_generate_psp                       3           3     16.84s  |
...
|   o-> ion_atom_construct_psp                      3           3     15.10s  |
...
|   o-> ion_atom_Q_pseudise                        95          95      4.79s  |
|   o-> ion_atom_write_beta                         3           3      0.00s  |
|   o-> ion_atom_radial_transform                  92          92      2.72s  |
...
|  /o-- phonon_prepare_and_diagonalise           3572                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                14288       14288      9.15s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> cell_reread                                   1           1      8.76s  |
...
| O-> cell_check_group                          10717       10717      3.37s  |
|    /                                                                        |
|   o-> algor_invert_real                      178666      178666      0.54s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_define_psp                         3                         |
|  /o-- ion_atom_construct_psp                     92                         |
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.28s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            350122      350122      1.15s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        178679      178679      0.54s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_distribute_grids                      1           1      0.52s  |
...
|   o-> comms_map_transpose                         2           2      0.51s  |
+-----------------------------------------------------------------------------+
...
| O-> comms_map_transpose                           2           2      0.51s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.51s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.51s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.51s  |
+-----------------------------------------------------------------------------+
