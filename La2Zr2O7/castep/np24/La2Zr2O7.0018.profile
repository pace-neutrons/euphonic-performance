...
|   o-> comms_send_complex                       1087        1087    595.28s  |
...
|   o-> ion_atom_construct_psp                      3           3     15.09s  |
...
|   o-> ion_atom_radial_transform                  92          92      2.76s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              3262        3262      9.85s  |
|    /                                                                        |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      57662       57662      6.31s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           57662                         |
|  /o-- secondd_tr_symmetrize_dmat               3262                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60924       60924      6.68s  |
|    /                                                                        |
...
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.34s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_distribute_grids                      1           1      0.23s  |
...
|   o-> algor_matmul_cmplx_cmplx                    5           5      0.02s  |
...
| |/                                                                          |
| O-> comms_reduce_array_complex                   15          15      0.12s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip                5                         |
|  /o-- wave_calc_Soverlap_wv_ks                    5                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                      10          10      0.12s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                 10          10      0.12s  |
+-----------------------------------------------------------------------------+
