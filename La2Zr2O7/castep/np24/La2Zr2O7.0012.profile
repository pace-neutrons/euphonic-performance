...
|   o-> phonon_real_to_fine                      1088        1088      1.12s  |
...
|   o-> comms_send_complex                       1087        1087    595.19s  |
...
|   o-> ion_initialise                              1           1     19.60s  |
|   o-> basis_initialise                            2           2      0.26s  |
...
|   o-> ion_atom_generate_psp                       3           3     16.89s  |
...
|   o-> ion_atom_construct_psp                      3           3     15.13s  |
...
|   o-> ion_atom_radial_transform                  92          92      2.78s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      57662       57662      6.30s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           57662                         |
|  /o-- secondd_tr_symmetrize_dmat               3262                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60924       60924      6.67s  |
|    /                                                                        |
...
|   o-> ion_atom_init_pseudo_atom                   3           3      0.37s  |
...
| O-> cell_check_group                           3262        3262      1.08s  |
|    /                                                                        |
|   o-> algor_invert_real                       54400       54400      0.17s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_distribute_grids                      1           1      0.25s  |
...
| |/                                                                          |
| O-> algor_invert_real                         54413       54413      0.17s  |
+-----------------------------------------------------------------------------+
