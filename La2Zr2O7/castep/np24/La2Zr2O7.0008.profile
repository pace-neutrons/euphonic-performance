...
|   o-> ion_atom_construct_psp                      3           3     15.16s  |
...
|   o-> ion_atom_radial_transform                  92          92      2.81s  |
...
|   o-> phonon_diagonalise_d_cmplx               3261        3261      2.35s  |
...
|   o-> cell_deallocate                          3262        3262      0.02s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      57664       57664      6.30s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           57664                         |
|  /o-- secondd_tr_symmetrize_dmat               3262                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60926       60926      6.67s  |
|    /                                                                        |
...
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.39s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              3261                         |
|  /o-- phonon_prepare_and_diagonalise           1087                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 4348        4348      3.14s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              3                         |
|  /                                                                          |
| O-> ion_atom_pseudo_scf                           3           3      2.44s  |
...
|   o-> ion_atom_init_pseudo_atom                   3           3      0.43s  |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.36s  |
+-----------------------------------------------------------------------------+
