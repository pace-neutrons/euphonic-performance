...
|   o-> model_continuation                          1           1     28.56s  |
...
|   o-> comms_reduce_gv_real                        1           1      0.23s  |
...
|   o-> ion_initialise                              1           1     19.50s  |
|   o-> basis_initialise                            2           2      0.36s  |
...
|   o-> model_check_dependencies                    1           1      0.04s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_pseudo_scf                         3           3      2.41s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              3262        3262      9.82s  |
|    /                                                                        |
...
|   o-> basis_distribute_grids                      1           1      0.29s  |
...
|   o-> comms_gather_gv_integer                    12          12      0.25s  |
...
| O-> model_check_dependencies                      1           1      0.04s  |
|    /                                                                        |
|   o-> model_symmetry_unchanged                    1           1      0.04s  |
