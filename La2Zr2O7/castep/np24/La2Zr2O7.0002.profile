...
|   o-> comms_send_complex                       1087        1087    594.95s  |
...
|   o-> ion_initialise                              1           1     19.63s  |
|   o-> basis_initialise                            2           2      0.23s  |
...
|   o-> ion_atom_construct_psp                      3           3     15.15s  |
...
|   o-> ion_atom_radial_transform                  92          92      2.80s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              3262        3262      9.83s  |
|    /                                                                        |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      57670       57670      6.30s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           57670                         |
|  /o-- secondd_tr_symmetrize_dmat               3262                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60932       60932      6.66s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             60932       60932      2.13s  |
+-----------------------------------------------------------------------------+
...
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.38s  |
+-----------------------------------------------------------------------------+
...
| O-> cell_check_group                           3262        3262      1.08s  |
|    /                                                                        |
|   o-> algor_invert_real                       54408       54408      0.16s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            106584      106584      0.36s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               106584                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              106584      106584      0.36s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
...
|   o-> comms_map_transpose                         2           2      0.21s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.21s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.21s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.21s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.21s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_compute_atom_phases             56604                         |
|  /o-- phonon_prepare_and_diagonalise           2174                         |
| |/                                                                          |
| O-> q_is_a_g                                  58788       58788      0.18s  |
+-----------------------------------------------------------------------------+
...
|  /o-- cell_check_group                        54408                         |
| |/                                                                          |
| O-> algor_invert_real                         54421       54421      0.16s  |
+-----------------------------------------------------------------------------+
