...
|   o-> ion_atom_pseudo_scf                         3           3      2.20s  |
...
|   o-> ion_atom_ps_diag                          108         108      1.63s  |
...
| O-> ion_atom_ps_diag                            108         108      1.63s  |
|    /                                                                        |
|   o-> ion_atom_regin                         139221      139221      0.75s  |
...
| |/                                                                          |
| O-> ion_atom_regin                           158454      158454      0.84s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               3           3      0.80s  |
...
|   o-> comms_map_transpose                         2           2      0.55s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.55s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.55s  |
+-----------------------------------------------------------------------------+
