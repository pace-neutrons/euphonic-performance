...
|   o-> phonon_real_to_fine                      1088        1088      1.15s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087     10.72s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      1.82s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.05s  |
|   o-> comms_send_complex                       1087        1087    595.08s  |
...
|   o-> ion_atom_radial_transform                  92          92      2.82s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              3262        3262      9.88s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            3262        3262      7.31s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      57668       57668      6.34s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           57668                         |
|  /o-- secondd_tr_symmetrize_dmat               3262                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60930       60930      6.70s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             60930       60930      2.14s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                          108         108      1.80s  |
...
| O-> ion_atom_ps_diag                            108         108      1.80s  |
|    /                                                                        |
|   o-> ion_atom_regin                         139221      139221      0.78s  |
...
| O-> cell_check_group                           3262        3262      1.08s  |
|    /                                                                        |
|   o-> algor_invert_real                       54406       54406      0.16s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.32s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_descreen_psp                         3           3      0.27s  |
...
| |/                                                                          |
| O-> algor_invert_real                         54419       54419      0.16s  |
+-----------------------------------------------------------------------------+
