...
|   o-> ion_atom_generate_psp                       3           3     16.80s  |
...
|   o-> ion_atom_construct_psp                      3           3     15.03s  |
...
|   o-> ion_atom_radial_transform                  92          92      2.71s  |
...
|   o-> secondd_group_symmetrize_dmat            3262        3262      7.25s  |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60922       60922      6.65s  |
|    /                                                                        |
...
| O-> cell_check_group                           3262        3262      1.07s  |
|    /                                                                        |
|   o-> algor_invert_real                       54398       54398      0.16s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           158454      158454      0.89s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               3           3      0.79s  |
...
|   o-> basis_distribute_grids                      1           1      0.14s  |
...
| O-> wave_Sorthonormalise_wv_ks                    5           5      0.18s  |
|    /                                                                        |
|   o-> wave_calc_Soverlap_wv_ks                    5           5      0.16s  |
...
| |/                                                                          |
| O-> algor_invert_real                         54411       54411      0.16s  |
+-----------------------------------------------------------------------------+
