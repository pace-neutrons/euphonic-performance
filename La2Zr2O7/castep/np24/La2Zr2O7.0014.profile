...
|   o-> phonon_real_to_fine                      1088        1088      1.13s  |
...
|   o-> comms_send_complex                       1087        1087    359.11s  |
|   o-> comms_send_real                          2174        2174      0.01s  |
|   o-> comms_reduce_gv_real                        1           1      0.13s  |
...
|   o-> cell_restore_wrapped                        2           2      0.16s  |
...
|   o-> ion_atom_generate_psp                       3           3     16.78s  |
|   o-> ion_set_data                                3           3      0.13s  |
...
|   o-> ion_atom_radial_transform                  92          92      2.68s  |
...
|   o-> secondd_tr_symmetrize_dmat               3262        3262      1.15s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      57660       57660      6.29s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           57660                         |
|  /o-- secondd_tr_symmetrize_dmat               3262                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60922       60922      6.66s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             60922       60922      2.12s  |
+-----------------------------------------------------------------------------+
...
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.25s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_init_pseudo_atom                   3           3      0.35s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      60922                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               60922       60922      2.12s  |
|    /                                                                        |
|   o-> q_is_a_g                                56574       56574      0.17s  |
+-----------------------------------------------------------------------------+
...
| O-> ion_atom_ps_diag                            108         108      1.71s  |
|    /                                                                        |
|   o-> ion_atom_regin                         139221      139221      0.80s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1088        1088      0.88s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         3262                         |
|  /                                                                          |
| O-> cell_check_group                           3262        3262      1.08s  |
|    /                                                                        |
|   o-> algor_invert_real                       54398       54398      0.17s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_tr_symmetrize_dmat               3262                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                   6524        6524      0.75s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            106574      106574      0.36s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_distribute_grids                      1           1      0.26s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               106574                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              106574      106574      0.36s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_map_transpose                         2           2      0.24s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.24s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.24s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.24s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.24s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_compute_atom_phases             56574                         |
|  /o-- phonon_prepare_and_diagonalise           2174                         |
| |/                                                                          |
| O-> q_is_a_g                                  58758       58758      0.18s  |
+-----------------------------------------------------------------------------+
...
|  /o-- cell_check_group                        54398                         |
| |/                                                                          |
| O-> algor_invert_real                         54411       54411      0.17s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          2                         |
|  /                                                                          |
| O-> cell_restore_wrapped                          2           2      0.16s  |
...
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.13s  |
|    /                                                                        |
