...
|   o-> phonon_real_to_fine                      1087        1087      1.14s  |
|   o-> phonon_enforce_dmat_sumrule              1086        1086     10.69s  |
|   o-> phonon_prepare_and_diagonalise           1086        1086      1.83s  |
|   o-> phonon_accumulate_adp                    1086        1086      0.05s  |
|   o-> comms_send_complex                       1086        1086    594.90s  |
|   o-> comms_send_real                          2172        2172      0.01s  |
|   o-> comms_reduce_gv_real                        1           1      0.50s  |
...
|   o-> ion_initialise                              1           1     19.70s  |
|   o-> basis_initialise                            2           2      0.16s  |
|   o-> model_store_dependencies                    1           1      0.00s  |
|   o-> cell_reread                                 1           1      8.24s  |
...
|   o-> ion_atom_allocate_pspot                     6           6      0.13s  |
|   o-> ion_atom_generate_psp                       3           3     16.87s  |
|   o-> ion_set_data                                3           3      0.19s  |
|   o-> ion_atom_deallocate_pspot                   7           7      0.00s  |
|   o-> ion_set_psp                                 3           3      0.07s  |
|   o-> ion_atom_pseudo_scf                         3           3      2.43s  |
...
|   o-> ion_atom_ae_scf                             3           3      0.80s  |
|   o-> ion_atom_define_psp                         3           3      0.70s  |
|   o-> ion_atom_construct_psp                      3           3     15.11s  |
...
|   o-> ion_atom_pseudise                          21          21      0.09s  |
|   o-> ion_atom_write_pwave                        3           3      0.00s  |
|   o-> ion_atom_radin                          61185       61185      0.92s  |
|   o-> ion_atom_Q_pseudise                        95          95      4.71s  |
|   o-> ion_atom_write_beta                         3           3      0.00s  |
|   o-> ion_atom_radial_transform                  92          92      2.77s  |
...
|   o-> phonon_diagonalise_d_cmplx               3258        3258      2.35s  |
|   o-> secondd_find_acoustics                   1086        1086      0.13s  |
|   o-> secondd_symmetrize_dmat_cmplx            1086        1086      8.03s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_real_to_fine                      1087                         |
|  /o-- phonon_enforce_dmat_sumrule              1086                         |
|  /o-- phonon_prepare_and_diagonalise           1086                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              3259        3259      9.85s  |
|    /                                                                        |
...
|   o-> cell_deallocate                          3259        3259      0.02s  |
|   o-> secondd_find_inversion                   3259        3259      0.01s  |
|   o-> secondd_tr_symmetrize_dmat               3259        3259      1.16s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_gcopy_integer                        64          64      8.79s  |
...
| |/                                                                          |
| O-> comms_gcopy_real                            522         522      7.52s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60870       60870      6.67s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             60870       60870      2.13s  |
+-----------------------------------------------------------------------------+
...
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.35s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              3258                         |
|  /o-- phonon_prepare_and_diagonalise           1086                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 4344        4344      3.14s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              3                         |
|  /                                                                          |
| O-> ion_atom_pseudo_scf                           3           3      2.43s  |
...
|   o-> ion_atom_init_pseudo_atom                   3           3      0.41s  |
|   o-> ion_atom_init_pseudo_H                      3           3      0.00s  |
|   o-> ion_atom_ps_diag                          108         108      1.81s  |
...
| |/                                                                          |
| O-> ion_atom_radin                           153701      153701      2.00s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1086                         |
|  /                                                                          |
| O-> phonon_prepare_and_diagonalise             1086        1086      1.83s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1086        1086      0.93s  |
|   o-> phonon_constrain_dmat                    1086        1086      0.00s  |
|   o-> phonon_mass_weight_dmat                  1086        1086      0.01s  |
|   o-> phonon_diagonalise_d_cmplx               1086        1086      0.79s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pseudo_scf                       108                         |
|  /                                                                          |
| O-> ion_atom_ps_diag                            108         108      1.81s  |
|    /                                                                        |
|   o-> ion_atom_regin                         139221      139221      0.83s  |
...
| O-> secondd_tr_symmetrize_dmat                 3259        3259      1.16s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 3259        3259      0.73s  |
...
| O-> cell_reduce_symmetry_ops_wrapped           3259        3259      1.14s  |
|    /                                                                        |
|   o-> cell_check_group                         3259        3259      1.08s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      0.89s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         3259                         |
|  /                                                                          |
| O-> cell_check_group                           3259        3259      1.08s  |
|    /                                                                        |
|   o-> algor_invert_real                       54352       54352      0.17s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           158454      158454      0.92s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               3           3      0.80s  |
...
|  /o-- secondd_tr_symmetrize_dmat               3259                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                   6518        6518      0.76s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.52s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.50s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.50s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_locate                         12410       12410      0.07s  |
|   o-> ion_atom_interpolate                    12410       12410      0.07s  |
...
|   o-> algor_matmul_cmplx_cmplx                    5           5      0.04s  |
|   o-> comms_reduce_gv_complex                     5           5      0.10s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                         54365       54365      0.17s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_count_plane_waves                     1           1      0.06s  |
...
| |/                                                                          |
| O-> comms_reduce_array_complex                   15          15      0.10s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip                5                         |
|  /o-- wave_calc_Soverlap_wv_ks                    5                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                      10          10      0.10s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                 10          10      0.10s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_qc_pseudise                       18          18      0.09s  |
+-----------------------------------------------------------------------------+
...
| O-> ion_atom_qc_pseudise                         18          18      0.09s  |
|    /                                                                        |
|   o-> ion_atom_qc_pseudise_fn                    18          18      0.09s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_regin                           1296        1296      0.01s  |
...
| |/                                                                          |
| O-> ion_atom_interpolate                      12454       12454      0.07s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_init_pseudo_atom               12410                         |
|  /                                                                          |
| O-> ion_atom_locate                           12410       12410      0.07s  |
...
|   o-> comms_reduce_kp_integer                     3           3      0.06s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.02s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> density_read                                  1           1      0.02s  |
...
|  /o-- nlxc_initialise                             1                         |
| |/                                                                          |
| O-> cell_generate_qpoints_local                   2           2      0.02s  |
|    /                                                                        |
...
|   o-> cell_generate_qpoints_local                 1           1      0.02s  |
...
| |/                                                                          |
| O-> cell_deallocate                            3278        3278      0.02s  |
+-----------------------------------------------------------------------------+
