...
|   o-> comms_send_complex                       1087        1087    358.93s  |
|   o-> comms_send_real                          2174        2174      0.01s  |
|   o-> comms_reduce_gv_real                        1           1      0.30s  |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60924       60924      6.64s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.30s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.30s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       3                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.30s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_map_transpose                         2           2      0.26s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_descreen_psp                         3           3      0.26s  |
...
| O-> comms_map_transpose                           2           2      0.26s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.26s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.26s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.26s  |
+-----------------------------------------------------------------------------+
