...
|   o-> phonon_real_to_fine                      1088        1088      1.17s  |
...
|   o-> comms_send_complex                       1087        1087    594.96s  |
|   o-> comms_send_real                          2174        2174      0.01s  |
|   o-> comms_reduce_gv_real                        1           1      0.47s  |
...
|   o-> ion_atom_pseudo_scf                         3           3      2.38s  |
...
|   o-> ion_atom_construct_psp                      3           3     15.00s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      57662       57662      6.29s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           57662                         |
|  /o-- secondd_tr_symmetrize_dmat               3262                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60924       60924      6.66s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             60924       60924      2.13s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                          108         108      1.77s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            106576      106576      0.35s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_define_psp                           3           3      0.69s  |
...
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.47s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.47s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       3                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.47s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_gather_gv_integer                    12          12      0.26s  |
...
| |/                                                                          |
| O-> comms_gather_gv_integer                      18          18      0.33s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_descreen_psp                         3           3      0.26s  |
...
| |/                                                                          |
| O-> algor_invert_real                         54413       54413      0.16s  |
+-----------------------------------------------------------------------------+
...
| O-> model_symmetry_unchanged                      1           1      0.03s  |
|    /                                                                        |
|   o-> model_compare_matrices                   2304        2304      0.02s  |
