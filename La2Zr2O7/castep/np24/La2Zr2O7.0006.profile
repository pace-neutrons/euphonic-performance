...
|   o-> cell_restore_wrapped                        2           2      0.19s  |
...
|   o-> ion_atom_pseudo_scf                         3           3      2.29s  |
...
|   o-> ion_atom_construct_psp                      3           3     14.97s  |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60926       60926      6.66s  |
|    /                                                                        |
...
|   o-> basis_distribute_grids                      1           1      0.39s  |
...
|   o-> comms_map_transpose                         2           2      0.38s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.38s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.38s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.38s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.38s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.26s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.26s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> wave_initialise_wv                            1           1      0.22s  |
...
|   o-> cell_analyse_symmetry_wrapped               2           2      0.18s  |
+-----------------------------------------------------------------------------+
