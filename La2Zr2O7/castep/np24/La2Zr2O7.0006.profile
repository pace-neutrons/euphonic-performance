...
|   o-> phonon_real_to_fine                      1088        1088      1.14s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087     10.71s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      1.82s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.05s  |
|   o-> comms_send_complex                       1087        1087    595.01s  |
...
|   o-> ion_atom_generate_psp                       3           3     16.95s  |
|   o-> ion_set_data                                3           3      0.20s  |
|   o-> ion_atom_deallocate_pspot                   7           7      0.00s  |
|   o-> ion_set_psp                                 3           3      0.07s  |
|   o-> ion_atom_pseudo_scf                         3           3      2.35s  |
...
|   o-> ion_atom_construct_psp                      3           3     15.18s  |
...
|   o-> ion_atom_pseudise                          21          21      0.10s  |
|   o-> ion_atom_write_pwave                        3           3      0.00s  |
|   o-> ion_atom_radin                          61185       61185      0.92s  |
|   o-> ion_atom_Q_pseudise                        95          95      4.72s  |
|   o-> ion_atom_write_beta                         3           3      0.00s  |
|   o-> ion_atom_radial_transform                  92          92      2.84s  |
...
|   o-> phonon_diagonalise_d_cmplx               3261        3261      2.34s  |
|   o-> secondd_find_acoustics                   1087        1087      0.13s  |
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      8.05s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_real_to_fine                      1088                         |
|  /o-- phonon_enforce_dmat_sumrule              1087                         |
|  /o-- phonon_prepare_and_diagonalise           1087                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              3262        3262      9.87s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            3262        3262      7.29s  |
|   o-> cell_deallocate                          3262        3262      0.01s  |
|   o-> secondd_find_inversion                   3262        3262      0.01s  |
|   o-> secondd_tr_symmetrize_dmat               3262        3262      1.16s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      57664       57664      6.32s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           57664                         |
|  /o-- secondd_tr_symmetrize_dmat               3262                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60926       60926      6.69s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             60926       60926      2.13s  |
+-----------------------------------------------------------------------------+
...
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.42s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              3261                         |
|  /o-- phonon_prepare_and_diagonalise           1087                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 4348        4348      3.13s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              3                         |
|  /                                                                          |
| O-> ion_atom_pseudo_scf                           3           3      2.35s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      0.93s  |
...
| O-> secondd_tr_symmetrize_dmat                 3262        3262      1.16s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 3262        3262      0.73s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1088        1088      0.89s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         3262                         |
|  /                                                                          |
| O-> cell_check_group                           3262        3262      1.08s  |
|    /                                                                        |
|   o-> algor_invert_real                       54402       54402      0.17s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           158454      158454      0.90s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               3           3      0.79s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            106578      106578      0.36s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_radial_transform                   3           3      0.58s  |
...
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.41s  |
|    /                                                                        |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               106578                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              106578      106578      0.36s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
...
|  /o-- secondd_compute_atom_phases             56586                         |
|  /o-- phonon_prepare_and_diagonalise           2174                         |
| |/                                                                          |
| O-> q_is_a_g                                  58770       58770      0.18s  |
+-----------------------------------------------------------------------------+
...
|  /o-- cell_check_group                        54402                         |
| |/                                                                          |
| O-> algor_invert_real                         54415       54415      0.17s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_qc_pseudise                       18          18      0.10s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pseudise                          18                         |
|  /                                                                          |
| O-> ion_atom_qc_pseudise                         18          18      0.10s  |
|    /                                                                        |
|   o-> ion_atom_qc_pseudise_fn                    18          18      0.10s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_deallocate                            3281        3281      0.02s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_set_ae_H                         207                         |
|  /o-- ion_atom_descreen_psp                       3                         |
| |/                                                                          |
