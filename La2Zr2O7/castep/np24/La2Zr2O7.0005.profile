...
|   o-> phonon_enforce_dmat_sumrule              1087        1087     10.66s  |
...
|   o-> comms_reduce_gv_real                        1           1      0.43s  |
...
|   o-> ion_initialise                              1           1     19.48s  |
|   o-> basis_initialise                            2           2      0.38s  |
...
|   o-> ion_atom_radial_transform                  92          92      2.67s  |
...
|   o-> secondd_group_symmetrize_dmat            3262        3262      7.26s  |
|   o-> cell_deallocate                          3262        3262      0.01s  |
|   o-> secondd_find_inversion                   3262        3262      0.01s  |
|   o-> secondd_tr_symmetrize_dmat               3262        3262      1.13s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      57664       57664      6.29s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           57664                         |
|  /o-- secondd_tr_symmetrize_dmat               3262                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60926       60926      6.65s  |
|    /                                                                        |
...
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.24s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              3261                         |
|  /o-- phonon_prepare_and_diagonalise           1087                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 4348        4348      3.11s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              3                         |
|  /                                                                          |
| O-> ion_atom_pseudo_scf                           3           3      2.40s  |
...
|   o-> ion_atom_init_pseudo_atom                   3           3      0.39s  |
|   o-> ion_atom_init_pseudo_H                      3           3      0.00s  |
|   o-> ion_atom_ps_diag                          108         108      1.79s  |
...
| O-> ion_atom_ps_diag                            108         108      1.79s  |
|    /                                                                        |
|   o-> ion_atom_regin                         139221      139221      0.82s  |
...
| O-> secondd_tr_symmetrize_dmat                 3262        3262      1.13s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 3262        3262      0.70s  |
...
| O-> cell_check_group                           3262        3262      1.07s  |
|    /                                                                        |
|   o-> algor_invert_real                       54402       54402      0.16s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            106578      106578      0.35s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_define_psp                           3           3      0.70s  |
...
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.43s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.43s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       3                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.43s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_gather_gv_integer                    12          12      0.28s  |
...
| |/                                                                          |
| O-> comms_gather_gv_integer                      18          18      0.35s  |
+-----------------------------------------------------------------------------+
...
| O-> wave_Sorthonormalise_wv_ks                    5           5      0.21s  |
|    /                                                                        |
|   o-> wave_calc_Soverlap_wv_ks                    5           5      0.18s  |
...
|   o-> wave_beta_phi_wv_ks                         5           5      0.17s  |
...
| |/                                                                          |
| O-> algor_invert_real                         54415       54415      0.16s  |
+-----------------------------------------------------------------------------+
