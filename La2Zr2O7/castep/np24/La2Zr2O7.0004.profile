...
|   o-> ion_atom_allocate_pspot                     6           6      0.14s  |
|   o-> ion_atom_generate_psp                       3           3     16.94s  |
|   o-> ion_set_data                                3           3      0.22s  |
|   o-> ion_atom_deallocate_pspot                   7           7      0.00s  |
|   o-> ion_set_psp                                 3           3      0.06s  |
|   o-> ion_atom_pseudo_scf                         3           3      2.33s  |
...
|   o-> ion_atom_construct_psp                      3           3     15.17s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      57668       57668      6.30s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           57668                         |
|  /o-- secondd_tr_symmetrize_dmat               3262                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60930       60930      6.67s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             60930       60930      2.13s  |
+-----------------------------------------------------------------------------+
...
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.41s  |
+-----------------------------------------------------------------------------+
...
| O-> ion_atom_ps_diag                            108         108      1.73s  |
|    /                                                                        |
|   o-> ion_atom_regin                         139221      139221      0.79s  |
...
| O-> cell_check_group                           3262        3262      1.08s  |
|    /                                                                        |
|   o-> algor_invert_real                       54406       54406      0.17s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           158454      158454      0.88s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               3           3      0.80s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            106582      106582      0.36s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.45s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.45s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       3                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.45s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               106582                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              106582      106582      0.36s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
...
|  /o-- secondd_compute_atom_phases             56598                         |
|  /o-- phonon_prepare_and_diagonalise           2174                         |
| |/                                                                          |
| O-> q_is_a_g                                  58782       58782      0.18s  |
+-----------------------------------------------------------------------------+
...
|  /o-- cell_check_group                        54406                         |
| |/                                                                          |
| O-> algor_invert_real                         54419       54419      0.17s  |
+-----------------------------------------------------------------------------+
