...
|   o-> comms_send_complex                       1087        1087    358.98s  |
...
|   o-> ion_atom_pseudo_scf                         3           3      2.45s  |
...
|   o-> ion_atom_ps_diag                          108         108      1.84s  |
...
| O-> ion_atom_ps_diag                            108         108      1.84s  |
|    /                                                                        |
|   o-> ion_atom_regin                         139221      139221      0.85s  |
...
| |/                                                                          |
| O-> ion_atom_regin                           158454      158454      0.93s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               3           3      0.79s  |
...
| |/                                                                          |
| O-> comms_reduce_array_complex                   15          15      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip                5                         |
|  /o-- wave_calc_Soverlap_wv_ks                    5                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                      10          10      0.09s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                 10          10      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- model_write                                 1                         |
|  /                                                                          |
| O-> model_write_all                               1           1      0.08s  |
