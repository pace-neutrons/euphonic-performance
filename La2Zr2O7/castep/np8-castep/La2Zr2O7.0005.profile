...
|   o-> model_continuation                          1           1     27.65s  |
...
|   o-> phonon_calculate                            1           1    373.06s  |
|   o-> check_forces_stresses                       1           1      0.00s  |
|   o-> model_write                                 1           1      0.84s  |
...
|   o-> phonon_real_to_fine                      3572        3572      3.40s  |
|   o-> phonon_enforce_dmat_sumrule              3571        3571     33.79s  |
|   o-> phonon_prepare_and_diagonalise           3571        3571      5.41s  |
|   o-> phonon_accumulate_adp                    3571        3571      0.15s  |
|   o-> comms_send_complex                       3571        3571    330.02s  |
...
|   o-> phonon_diagonalise_d_cmplx              10713       10713      6.78s  |
|   o-> secondd_find_acoustics                   3571        3571      0.37s  |
|   o-> secondd_symmetrize_dmat_cmplx            3571        3571     26.06s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_real_to_fine                      3572                         |
|  /o-- phonon_enforce_dmat_sumrule              3571                         |
|  /o-- phonon_prepare_and_diagonalise           3571                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx             10714       10714     31.64s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat           10714       10714     23.64s  |
...
|   o-> wave_initialise_wv                          1           1      0.27s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion     189320      189320     20.53s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          189320                         |
|  /o-- secondd_tr_symmetrize_dmat              10714                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       200034      200034     21.73s  |
|    /                                                                        |
...
|   o-> ion_atom_construct_psp                      3           3     14.85s  |
...
| |/                                                                          |
| O-> comms_gcopy_integer                         436         436      9.50s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_gcopy_integer                        64          64      8.74s  |
...
| |/                                                                          |
| O-> comms_gcopy_real                            522         522      7.53s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            3571        3571      2.79s  |
...
| O-> secondd_tr_symmetrize_dmat                10714       10714      3.65s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                10714       10714      2.24s  |
...
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.12s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                          108         108      1.10s  |
...
| |/                                                                          |
| O-> comms_send_real                            7145        7145      0.75s  |
+-----------------------------------------------------------------------------+
...
|   o-> model_write_occ_eigenvalues                 1           1      0.72s  |
...
|   o-> basis_distribute_grids                      1           1      0.11s  |
...
|   o-> basis_count_plane_waves                     1           1      0.38s  |
...
|   o-> comms_reduce_kp_integer                     3           3      0.38s  |
+-----------------------------------------------------------------------------+
...
|          o-> wave_Sorthonormalise_wv              1           1      0.25s  |
|    /                                                                        |
...
| O-> wave_Sorthonormalise_wv                       1           1      0.25s  |
|    /                                                                        |
|   o-> wave_Sorthonormalise_wv_ks                  5           5      0.25s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.10s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              3                         |
|  /                                                                          |
| O-> ion_set_data                                  3           3      0.10s  |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.04s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.04s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_init_pseudo_atom               12410                         |
|  /                                                                          |
| O-> ion_atom_locate                           12410       12410      0.04s  |
