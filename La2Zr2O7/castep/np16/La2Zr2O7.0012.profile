...
|   o-> phonon_real_to_fine                      1667        1667      1.67s  |
...
|   o-> comms_send_complex                       1666        1666    573.05s  |
|   o-> comms_send_real                          3332        3332      0.02s  |
|   o-> comms_reduce_gv_real                        1           1      0.31s  |
...
|   o-> ion_initialise                              1           1     18.76s  |
|   o-> basis_initialise                            2           2      0.67s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4999        4999     14.91s  |
|    /                                                                        |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      88351       88351      9.60s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           88351                         |
|  /o-- secondd_tr_symmetrize_dmat               4999                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        93350       93350     10.16s  |
|    /                                                                        |
...
|  /o-- phonon_prepare_and_diagonalise           1666                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 6664        6664      4.51s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.34s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.31s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.31s  |
+-----------------------------------------------------------------------------+
