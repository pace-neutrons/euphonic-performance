...
|   o-- phonons                                     1                         |
|  /                                                                          |
| O-> phonon_calculate                              1           1    388.22s  |
|    /                                                                        |
...
|   o-> phonon_enforce_dmat_sumrule              1666        1666     15.10s  |
|   o-> phonon_prepare_and_diagonalise           1666        1666      2.53s  |
|   o-> phonon_accumulate_adp                    1666        1666      0.07s  |
|   o-> comms_send_complex                       1666        1666    368.56s  |
...
|   o-> phonon_diagonalise_d_cmplx               4998        4998      3.26s  |
|   o-> secondd_find_acoustics                   1666        1666      0.13s  |
|   o-> secondd_symmetrize_dmat_cmplx            1666        1666     11.45s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_real_to_fine                      1667                         |
|  /o-- phonon_enforce_dmat_sumrule              1666                         |
|  /o-- phonon_prepare_and_diagonalise           1666                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4999        4999     14.04s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            4999        4999     10.33s  |
|   o-> cell_deallocate                          4999        4999      0.02s  |
|   o-> secondd_find_inversion                   4999        4999      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               4999        4999      1.66s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      88353       88353      8.73s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           88353                         |
|  /o-- secondd_tr_symmetrize_dmat               4999                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        93352       93352      9.24s  |
|    /                                                                        |
...
|   o-> secondd_symmetrize_dmat_cmplx            1666        1666      1.30s  |
...
| O-> secondd_tr_symmetrize_dmat                 4999        4999      1.66s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 4999        4999      1.05s  |
...
|  /o-- secondd_tr_symmetrize_dmat               4999                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                   9998        9998      1.10s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            163322      163322      0.52s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      0.18s  |
+-----------------------------------------------------------------------------+
