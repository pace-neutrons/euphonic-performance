...
|   o-> comms_send_complex                       1667        1667    573.06s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      88406       88406      9.63s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           88406                         |
|  /o-- secondd_tr_symmetrize_dmat               5002                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        93408       93408     10.20s  |
|    /                                                                        |
...
|  /o-- phonon_prepare_and_diagonalise           1667                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 6668        6668      4.55s  |
+-----------------------------------------------------------------------------+
...
|   o-> phonon_diagonalise_d_cmplx               1667        1667      1.15s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_distribute_grids                      1           1      0.71s  |
...
|   o-> comms_map_transpose                         2           2      0.70s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.70s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.70s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.70s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.70s  |
+-----------------------------------------------------------------------------+
