...
|   o-> phonon_real_to_fine                      1667        1667      1.69s  |
|   o-> phonon_enforce_dmat_sumrule              1666        1666     16.28s  |
|   o-> phonon_prepare_and_diagonalise           1666        1666      2.77s  |
|   o-> phonon_accumulate_adp                    1666        1666      0.08s  |
|   o-> comms_send_complex                       1666        1666    351.81s  |
|   o-> comms_send_real                          3332        3332      0.02s  |
|   o-> comms_reduce_gv_real                        1           1      0.19s  |
...
|   o-> ion_initialise                              1           1     18.74s  |
|   o-> basis_initialise                            2           2      0.40s  |
...
|   o-> ion_atom_construct_psp                      3           3     14.90s  |
...
|   o-> phonon_diagonalise_d_cmplx               4998        4998      3.55s  |
|   o-> secondd_find_acoustics                   1666        1666      0.19s  |
|   o-> secondd_symmetrize_dmat_cmplx            1666        1666     12.25s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_real_to_fine                      1667                         |
|  /o-- phonon_enforce_dmat_sumrule              1666                         |
|  /o-- phonon_prepare_and_diagonalise           1666                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4999        4999     14.97s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             4999        4999      0.02s  |
|   o-> hermitian4                               4999        4999      0.05s  |
|   o-> cell_copy_symmetry                       9998        9998      0.09s  |
|   o-> cell_reduce_symmetry_ops_wrapped         4999        4999      1.74s  |
|   o-> secondd_group_symmetrize_dmat            4999        4999     11.09s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      88351       88351      9.61s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           88351                         |
|  /o-- secondd_tr_symmetrize_dmat               4999                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        93350       93350     10.17s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             93350       93350      3.25s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_prepare_and_diagonalise           1666                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 6664        6664      4.75s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      93350                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               93350       93350      3.25s  |
|    /                                                                        |
|   o-> q_is_a_g                                86694       86694      0.26s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_define_psp                         3                         |
|  /o-- ion_atom_construct_psp                     92                         |
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.14s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1666                         |
|  /                                                                          |
| O-> phonon_prepare_and_diagonalise             1666        1666      2.77s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1666        1666      1.41s  |
|   o-> phonon_constrain_dmat                    1666        1666      0.01s  |
|   o-> phonon_mass_weight_dmat                  1666        1666      0.02s  |
|   o-> phonon_diagonalise_d_cmplx               1666        1666      1.20s  |
+-----------------------------------------------------------------------------+
...
| O-> cell_reduce_symmetry_ops_wrapped           4999        4999      1.74s  |
|    /                                                                        |
|   o-> cell_check_group                         4999        4999      1.64s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4999                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4999        4999      1.74s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1667        1667      1.31s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         4999                         |
|  /                                                                          |
| O-> cell_check_group                           4999        4999      1.64s  |
|    /                                                                        |
|   o-> algor_invert_real                       83352       83352      0.25s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            163320      163320      0.54s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               3           3      0.79s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               163320                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              163320      163320      0.54s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_compute_atom_phases             86694                         |
|  /o-- phonon_prepare_and_diagonalise           3332                         |
| |/                                                                          |
| O-> q_is_a_g                                  90036       90036      0.27s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_descreen_psp                         3           3      0.26s  |
...
|  /o-- cell_check_group                        83352                         |
| |/                                                                          |
| O-> algor_invert_real                         83365       83365      0.25s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.20s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.19s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.19s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_map_transpose                         2           2      0.15s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.15s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.15s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.15s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.15s  |
+-----------------------------------------------------------------------------+
