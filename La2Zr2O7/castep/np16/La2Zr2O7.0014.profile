...
|   o-> phonon_enforce_dmat_sumrule              1666        1666     16.08s  |
|   o-> phonon_prepare_and_diagonalise           1666        1666      2.66s  |
|   o-> phonon_accumulate_adp                    1666        1666      0.08s  |
|   o-> comms_send_complex                       1666        1666    573.03s  |
...
|   o-> ion_initialise                              1           1     18.68s  |
|   o-> basis_initialise                            2           2      0.75s  |
...
|   o-> ion_atom_construct_psp                      3           3     14.88s  |
...
|   o-> phonon_diagonalise_d_cmplx               4998        4998      3.39s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4999        4999     14.94s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             4999        4999      0.02s  |
|   o-> hermitian4                               4999        4999      0.05s  |
|   o-> cell_copy_symmetry                       9998        9998      0.09s  |
|   o-> cell_reduce_symmetry_ops_wrapped         4999        4999      1.72s  |
...
|   o-> secondd_tr_symmetrize_dmat               4999        4999      1.76s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_radial_transform                  92          92      2.59s  |
...
|    /                                                                        |
|   o-> secondd_compute_atom_phases             93352       93352      3.26s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_prepare_and_diagonalise           1666                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 6664        6664      4.53s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1666        1666      1.37s  |
|   o-> phonon_constrain_dmat                    1666        1666      0.01s  |
|   o-> phonon_mass_weight_dmat                  1666        1666      0.02s  |
|   o-> phonon_diagonalise_d_cmplx               1666        1666      1.14s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                          108         108      1.33s  |
...
|  /o-- secondd_tr_symmetrize_dmat               4999                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                   9998        9998      1.14s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            163322      163322      0.54s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               3           3      0.79s  |
...
|   o-> basis_count_plane_waves                     1           1      0.58s  |
...
|   o-> comms_reduce_kp_integer                     3           3      0.58s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_complex                   15          15      0.08s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip                5                         |
|  /o-- wave_calc_Soverlap_wv_ks                    5                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                      10          10      0.08s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                 10          10      0.08s  |
+-----------------------------------------------------------------------------+
