...
|   o-> comms_send_complex                       1667        1667    351.97s  |
...
|   o-> cell_reduce_symmetry_ops_wrapped         5002        5002      1.75s  |
...
|   o-> comms_map_transpose                         2           2      0.42s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.42s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.42s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.42s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.42s  |
+-----------------------------------------------------------------------------+
