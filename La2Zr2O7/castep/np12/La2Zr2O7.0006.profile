...
|   o-> phonon_real_to_fine                      2274        2274      2.25s  |
...
|   o-> comms_send_complex                       2273        2273    573.53s  |
...
|   o-> phonon_diagonalise_d_cmplx               6819        6819      4.42s  |
...
|   o-> ion_atom_define_psp                         3           3      0.75s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion     120528      120528     13.09s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       127348      127348     13.85s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            127348      127348      4.44s  |
+-----------------------------------------------------------------------------+
...
| O-> secondd_compute_atom_phases              127348      127348      4.44s  |
|    /                                                                        |
|   o-> q_is_a_g                               118276      118276      0.36s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         2273                         |
|  /                                                                          |
| O-> phonon_prepare_and_diagonalise             2273        2273      3.51s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            222812      222812      0.74s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_distribute_grids                      1           1      0.48s  |
...
| |/                                                                          |
| O-> algor_invert_real                        113721      113721      0.34s  |
+-----------------------------------------------------------------------------+
