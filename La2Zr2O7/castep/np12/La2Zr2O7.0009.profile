...
|   o-> phonon_enforce_dmat_sumrule              2273        2273     21.56s  |
|   o-> phonon_prepare_and_diagonalise           2273        2273      3.46s  |
|   o-> phonon_accumulate_adp                    2273        2273      0.10s  |
|   o-> comms_send_complex                       2273        2273    573.72s  |
...
|   o-> ion_initialise                              1           1     18.50s  |
|   o-> basis_initialise                            2           2      0.52s  |
...
|   o-> secondd_tr_symmetrize_dmat               6820        6820      2.34s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_pseudo_scf                         3           3      1.62s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion     120524      120524     13.09s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       127344      127344     13.85s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            127344      127344      4.44s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_prepare_and_diagonalise           2273                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 9092        9092      5.81s  |
+-----------------------------------------------------------------------------+
...
| O-> secondd_tr_symmetrize_dmat                 6820        6820      2.34s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 6820        6820      1.44s  |
...
| O-> cell_check_group                           6820        6820      2.14s  |
|    /                                                                        |
|   o-> algor_invert_real                      113704      113704      0.34s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                          108         108      1.18s  |
...
| |/                                                                          |
| O-> algor_invert_real                        113717      113717      0.34s  |
+-----------------------------------------------------------------------------+
...
|          o-> wave_Sorthonormalise_wv              1           1      0.19s  |
|    /                                                                        |
...
| O-> wave_Sorthonormalise_wv                       1           1      0.19s  |
|    /                                                                        |
|   o-> wave_Sorthonormalise_wv_ks                  5           5      0.19s  |
+-----------------------------------------------------------------------------+
