...
|   o-> phonon_enforce_dmat_sumrule              2272        2272     21.59s  |
|   o-> phonon_prepare_and_diagonalise           2272        2272      3.49s  |
|   o-> phonon_accumulate_adp                    2272        2272      0.10s  |
|   o-> comms_send_complex                       2272        2272    573.45s  |
|   o-> comms_send_real                          4544        4544      0.03s  |
...
|   o-> phonon_diagonalise_d_cmplx               6816        6816      4.39s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              6817        6817     20.23s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             6817        6817      0.02s  |
|   o-> hermitian4                               6817        6817      0.07s  |
|   o-> cell_copy_symmetry                      13634       13634      0.12s  |
|   o-> cell_reduce_symmetry_ops_wrapped         6817        6817      2.27s  |
...
|   o-> ion_atom_pseudo_scf                         3           3      1.60s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion     120473      120473     13.07s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       127290      127290     13.83s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            127290      127290      4.43s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_prepare_and_diagonalise           2272                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 9088        9088      5.88s  |
+-----------------------------------------------------------------------------+
...
| O-> secondd_compute_atom_phases              127290      127290      4.43s  |
|    /                                                                        |
|   o-> q_is_a_g                               118218      118218      0.35s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         2272                         |
|  /                                                                          |
| O-> phonon_prepare_and_diagonalise             2272        2272      3.49s  |
...
| O-> cell_reduce_symmetry_ops_wrapped           6817        6817      2.27s  |
|    /                                                                        |
|   o-> cell_check_group                         6817        6817      2.15s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            2273        2273      1.83s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         6817                         |
|  /                                                                          |
| O-> cell_check_group                           6817        6817      2.15s  |
|    /                                                                        |
|   o-> algor_invert_real                      113656      113656      0.34s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        113669      113669      0.34s  |
+-----------------------------------------------------------------------------+
