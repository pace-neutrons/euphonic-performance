...
|   o-> phonon_enforce_dmat_sumrule              2273        2273     21.61s  |
|   o-> phonon_prepare_and_diagonalise           2273        2273      3.49s  |
|   o-> phonon_accumulate_adp                    2273        2273      0.10s  |
|   o-> comms_send_complex                       2273        2273    573.49s  |
...
|   o-> ion_initialise                              1           1     18.52s  |
|   o-> basis_initialise                            2           2      0.50s  |
...
|   o-> phonon_diagonalise_d_cmplx               6819        6819      4.39s  |
|   o-> secondd_find_acoustics                   2273        2273      0.24s  |
|   o-> secondd_symmetrize_dmat_cmplx            2273        2273     16.62s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_real_to_fine                      2274                         |
|  /o-- phonon_enforce_dmat_sumrule              2273                         |
|  /o-- phonon_prepare_and_diagonalise           2273                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              6820        6820     20.27s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       127344      127344     13.86s  |
|    /                                                                        |
...
|  /o-- phonon_prepare_and_diagonalise           2273                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 9092        9092      5.87s  |
+-----------------------------------------------------------------------------+
...
|   o-> phonon_diagonalise_d_cmplx               2273        2273      1.48s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_tr_symmetrize_dmat               6820                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  13640       13640      1.55s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            222808      222808      0.74s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_distribute_grids                      1           1      0.49s  |
...
|   o-> comms_map_transpose                         2           2      0.48s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.48s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.48s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.48s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.48s  |
+-----------------------------------------------------------------------------+
