...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              6820        6820     19.12s  |
|    /                                                                        |
...
|   o-> secondd_tr_symmetrize_dmat               6820        6820      2.29s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion     120520      120520     11.87s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          120520                         |
|  /o-- secondd_tr_symmetrize_dmat               6820                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       127340      127340     12.56s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            127340      127340      3.44s  |
+-----------------------------------------------------------------------------+
...
| O-> secondd_compute_atom_phases              127340      127340      3.44s  |
|    /                                                                        |
|   o-> q_is_a_g                               118252      118252      0.35s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         2273                         |
|  /                                                                          |
| O-> phonon_prepare_and_diagonalise             2273        2273      3.41s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            222804      222804      0.73s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        113705      113705      0.34s  |
+-----------------------------------------------------------------------------+
|   o-- phonons                                     1                         |
|  /                                                                          |
...
|   o-> basis_map_fine_recip_half_full              1           1      0.01s  |
