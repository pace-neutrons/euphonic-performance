...
|   o-> phonon_real_to_fine                      2274        2274      2.27s  |
...
|   o-> comms_send_complex                       2273        2273    573.52s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              6820        6820     20.26s  |
|    /                                                                        |
...
|   o-> secondd_tr_symmetrize_dmat               6820        6820      2.38s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion     120520      120520     13.09s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          120520                         |
|  /o-- secondd_tr_symmetrize_dmat               6820                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       127340      127340     13.85s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            127340      127340      4.43s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion     127340                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases              127340      127340      4.43s  |
|    /                                                                        |
|   o-> q_is_a_g                               118252      118252      0.36s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         2273                         |
|  /                                                                          |
| O-> phonon_prepare_and_diagonalise             2273        2273      3.49s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            2273        2273      1.80s  |
...
| O-> cell_check_group                           6820        6820      2.15s  |
|    /                                                                        |
|   o-> algor_invert_real                      113700      113700      0.34s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            222804      222804      0.74s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               222804                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              222804      222804      0.74s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_map_transpose                         2           2      0.46s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.46s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.46s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.46s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.46s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_compute_atom_phases            118252                         |
|  /o-- phonon_prepare_and_diagonalise           4546                         |
| |/                                                                          |
| O-> q_is_a_g                                 122808      122808      0.37s  |
+-----------------------------------------------------------------------------+
