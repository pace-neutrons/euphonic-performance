...
|   o-> phonon_real_to_fine                      1668        1668      1.67s  |
|   o-> phonon_enforce_dmat_sumrule              1667        1667     16.05s  |
|   o-> phonon_prepare_and_diagonalise           1667        1667      2.64s  |
|   o-> phonon_accumulate_adp                    1667        1667      0.07s  |
|   o-> comms_send_complex                       1667        1667    352.28s  |
...
|   o-> ion_atom_pseudo_scf                         3           3      1.88s  |
...
|   o-> phonon_diagonalise_d_cmplx               5001        5001      3.37s  |
|   o-> secondd_find_acoustics                   1667        1667      0.18s  |
|   o-> secondd_symmetrize_dmat_cmplx            1667        1667     12.21s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5002        5002     14.91s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             5002        5002      0.02s  |
|   o-> hermitian4                               5002        5002      0.05s  |
|   o-> cell_copy_symmetry                      10004       10004      0.09s  |
|   o-> cell_reduce_symmetry_ops_wrapped         5002        5002      1.70s  |
|   o-> secondd_group_symmetrize_dmat            5002        5002     11.07s  |
|   o-> cell_deallocate                          5002        5002      0.02s  |
|   o-> secondd_find_inversion                   5002        5002      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               5002        5002      1.75s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      88400       88400      9.60s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           88400                         |
|  /o-- secondd_tr_symmetrize_dmat               5002                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        93402       93402     10.16s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             93402       93402      3.26s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_prepare_and_diagonalise           1667                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 6668        6668      4.51s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      93402                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               93402       93402      3.26s  |
|    /                                                                        |
|   o-> q_is_a_g                                86734       86734      0.26s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1667        1667      1.35s  |
|   o-> phonon_constrain_dmat                    1667        1667      0.01s  |
|   o-> phonon_mass_weight_dmat                  1667        1667      0.02s  |
|   o-> phonon_diagonalise_d_cmplx               1667        1667      1.14s  |
+-----------------------------------------------------------------------------+
...
| O-> secondd_tr_symmetrize_dmat                 5002        5002      1.75s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 5002        5002      1.09s  |
...
| O-> cell_reduce_symmetry_ops_wrapped           5002        5002      1.70s  |
|    /                                                                        |
|   o-> cell_check_group                         5002        5002      1.61s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1668        1668      1.34s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         5002                         |
|  /                                                                          |
| O-> cell_check_group                           5002        5002      1.61s  |
|    /                                                                        |
|   o-> algor_invert_real                       83398       83398      0.25s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            163414      163414      0.54s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               3           3      0.79s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               163414                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              163414      163414      0.54s  |
+-----------------------------------------------------------------------------+
...
|  /o-- bib_output                                  1                         |
| |/                                                                          |
| O-> comms_reduce_gv_logical                      12          12      0.51s  |
|    /                                                                        |
...
|   o-> comms_reduce_bnd_logical                    1           1      0.00s  |
|   o-> comms_reduce_gv_logical                     1           1      0.51s  |
|   o-> comms_reduce_kp_logical                     1           1      0.00s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_compute_atom_phases             86734                         |
|  /o-- phonon_prepare_and_diagonalise           3334                         |
| |/                                                                          |
| O-> q_is_a_g                                  90078       90078      0.27s  |
+-----------------------------------------------------------------------------+
...
|  /o-- cell_check_group                        83398                         |
| |/                                                                          |
| O-> algor_invert_real                         83411       83411      0.25s  |
+-----------------------------------------------------------------------------+
...
|   o-> density_write_parallel                      1           1      0.05s  |
