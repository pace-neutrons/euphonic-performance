...
|   o-> comms_send_complex                       1087        1087    359.21s  |
...
|   o-> ion_atom_define_psp                         3           3      0.76s  |
|   o-> ion_atom_construct_psp                      3           3     15.32s  |
...
|   o-> ion_atom_Q_pseudise                        95          95      5.14s  |
...
|   o-> secondd_group_symmetrize_dmat            3262        3262      7.28s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      57668       57668      6.31s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           57668                         |
|  /o-- secondd_tr_symmetrize_dmat               3262                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60930       60930      6.68s  |
|    /                                                                        |
...
|   o-> ion_atom_ps_diag                          108         108      1.53s  |
...
| O-> ion_atom_ps_diag                            108         108      1.53s  |
|    /                                                                        |
|   o-> ion_atom_regin                         139221      139221      0.70s  |
...
| |/                                                                          |
| O-> ion_atom_regin                           158454      158454      0.79s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_radial_transform                   3           3      0.61s  |
...
|   o-> ion_atom_ps_solve                           3           3      0.05s  |
|   o-> ion_atom_radin                           6167        6167      0.10s  |
...
|   o-> ion_atom_radin                           1217        1217      0.02s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_set_supercell_symmetry                 1           1      0.01s  |
