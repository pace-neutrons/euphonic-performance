...
|   o-> comms_send_complex                       1087        1087    358.91s  |
...
|   o-> ion_initialise                              1           1     19.38s  |
|   o-> basis_initialise                            2           2      0.33s  |
...
|   o-> ion_atom_generate_psp                       3           3     16.72s  |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60932       60932      6.67s  |
|    /                                                                        |
...
| O-> cell_check_group                           3262        3262      1.08s  |
|    /                                                                        |
|   o-> algor_invert_real                       54408       54408      0.17s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_map_transpose                         2           2      0.32s  |
+-----------------------------------------------------------------------------+
...
| O-> comms_map_transpose                           2           2      0.32s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.31s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.31s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.31s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                         54421       54421      0.17s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          2                         |
|  /                                                                          |
| O-> cell_restore_wrapped                          2           2      0.16s  |
