...
|   o-> comms_send_complex                       2273        2273    338.26s  |
...
|   o-> phonon_diagonalise_d_cmplx               6819        6819      4.32s  |
...
|   o-> ion_atom_pseudo_scf                         3           3      1.58s  |
...
|  /o-- phonon_prepare_and_diagonalise           2273                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 9092        9092      5.79s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                          108         108      1.14s  |
...
|   o-> comms_map_transpose                         2           2      0.53s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.53s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.53s  |
+-----------------------------------------------------------------------------+
