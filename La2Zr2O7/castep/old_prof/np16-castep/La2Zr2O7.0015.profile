...
|   o-> phonon_real_to_fine                      1667        1667      1.68s  |
|   o-> phonon_enforce_dmat_sumrule              1666        1666     16.26s  |
|   o-> phonon_prepare_and_diagonalise           1666        1666      2.76s  |
|   o-> phonon_accumulate_adp                    1666        1666      0.08s  |
|   o-> comms_send_complex                       1666        1666    351.88s  |
|   o-> comms_send_real                          3332        3332      0.02s  |
|   o-> comms_reduce_gv_real                        1           1      0.16s  |
...
|   o-> ion_initialise                              1           1     18.77s  |
|   o-> basis_initialise                            2           2      0.37s  |
...
|   o-> ion_atom_generate_psp                       3           3     16.65s  |
...
|   o-> secondd_group_symmetrize_dmat            4999        4999     11.08s  |
|   o-> cell_deallocate                          4999        4999      0.02s  |
|   o-> secondd_find_inversion                   4999        4999      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               4999        4999      1.73s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      88353       88353      9.61s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           88353                         |
|  /o-- secondd_tr_symmetrize_dmat               4999                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        93352       93352     10.17s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> comms_gcopy_integer                         436         436      9.59s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> cell_read_wrapped                             1           1      8.82s  |
...
|  /o-- phonon_prepare_and_diagonalise           1666                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 6664        6664      4.74s  |
+-----------------------------------------------------------------------------+
...
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.16s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1666                         |
|  /                                                                          |
| O-> phonon_prepare_and_diagonalise             1666        1666      2.76s  |
...
|   o-> ion_atom_init_pseudo_atom                   3           3      0.30s  |
...
|   o-> basis_distribute_grids                      1           1      0.13s  |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.17s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> model_write                                   1           1      0.17s  |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.16s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.16s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          2                         |
|  /                                                                          |
| O-> cell_restore_wrapped                          2           2      0.13s  |
...
|   o-> comms_map_transpose                         2           2      0.12s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_define_psp                         3                         |
|  /                                                                          |
| O-> ion_atom_core_pseudise                        3           3      0.12s  |
...
| O-> comms_map_transpose                           2           2      0.12s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.12s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.12s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.12s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_complex                   15          15      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip                5                         |
|  /o-- wave_calc_Soverlap_wv_ks                    5                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                      10          10      0.05s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                 10          10      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_init_pseudo_atom               12410                         |
|  /                                                                          |
| O-> ion_atom_locate                           12410       12410      0.05s  |
