...
|   o-> phonon_real_to_fine                      1667        1667      1.65s  |
|   o-> phonon_enforce_dmat_sumrule              1666        1666     16.00s  |
|   o-> phonon_prepare_and_diagonalise           1666        1666      2.63s  |
|   o-> phonon_accumulate_adp                    1666        1666      0.07s  |
|   o-> comms_send_complex                       1666        1666    352.29s  |
|   o-> comms_send_real                          3332        3332      0.02s  |
|   o-> comms_reduce_gv_real                        1           1      0.17s  |
...
|   o-> ion_atom_generate_psp                       3           3     16.70s  |
...
|   o-> ion_atom_construct_psp                      3           3     14.93s  |
|   o-> ion_atom_descreen_psp                       3           3      0.28s  |
...
|   o-> phonon_diagonalise_d_cmplx               4998        4998      3.35s  |
|   o-> secondd_find_acoustics                   1666        1666      0.18s  |
|   o-> secondd_symmetrize_dmat_cmplx            1666        1666     12.20s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4999        4999     14.88s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             4999        4999      0.02s  |
|   o-> hermitian4                               4999        4999      0.05s  |
|   o-> cell_copy_symmetry                       9998        9998      0.09s  |
|   o-> cell_reduce_symmetry_ops_wrapped         4999        4999      1.69s  |
|   o-> secondd_group_symmetrize_dmat            4999        4999     11.06s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      88353       88353      9.60s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           88353                         |
|  /o-- secondd_tr_symmetrize_dmat               4999                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        93352       93352     10.16s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             93352       93352      3.25s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_gcopy_real                            522         522      7.37s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_prepare_and_diagonalise           1666                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 6664        6664      4.48s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      93352                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               93352       93352      3.25s  |
|    /                                                                        |
|   o-> q_is_a_g                                86700       86700      0.26s  |
+-----------------------------------------------------------------------------+
...
| O-> secondd_tr_symmetrize_dmat                 4999        4999      1.74s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 4999        4999      1.08s  |
...
| O-> cell_reduce_symmetry_ops_wrapped           4999        4999      1.69s  |
|    /                                                                        |
|   o-> cell_check_group                         4999        4999      1.60s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1667        1667      1.33s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         4999                         |
|  /                                                                          |
| O-> cell_check_group                           4999        4999      1.60s  |
|    /                                                                        |
|   o-> algor_invert_real                       83354       83354      0.25s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pseudo_scf                       108                         |
|  /                                                                          |
| O-> ion_atom_ps_diag                            108         108      1.37s  |
|    /                                                                        |
|   o-> ion_atom_regin                         139221      139221      0.62s  |
|   o-> ion_atom_rectoreal                        354         354      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat            4999                         |
|  /o-- secondd_tr_symmetrize_dmat               4999                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                   9998        9998      1.12s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            163322      163322      0.53s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               3           3      0.79s  |
...
| |/                                                                          |
| O-> ion_atom_regin                           158454      158454      0.69s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               163322                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              163322      163322      0.53s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_compute_atom_phases             86700                         |
|  /o-- phonon_prepare_and_diagonalise           3332                         |
| |/                                                                          |
| O-> q_is_a_g                                  90042       90042      0.27s  |
+-----------------------------------------------------------------------------+
...
|  /o-- cell_check_group                        83354                         |
| |/                                                                          |
| O-> algor_invert_real                         83367       83367      0.25s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.19s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              1666                         |
|  /                                                                          |
| O-> secondd_find_acoustics                     1666        1666      0.18s  |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.17s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.17s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> model_write                                   1           1      0.17s  |
...
|   o-> algor_matmul_cmplx_cmplx                    5           5      0.08s  |
|   o-> comms_reduce_gv_complex                     5           5      0.03s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          2                         |
|  /                                                                          |
| O-> cell_restore_wrapped                          2           2      0.13s  |
