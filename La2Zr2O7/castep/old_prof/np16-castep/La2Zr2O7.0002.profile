...
|   o-> phonon_prepare_and_diagonalise           1667        1667      2.63s  |
|   o-> phonon_accumulate_adp                    1667        1667      0.07s  |
|   o-> comms_send_complex                       1667        1667    352.33s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1667        1667     12.20s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5002        5002     14.88s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            5002        5002     11.06s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      88406       88406      9.60s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1668        1668      1.33s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_distribute_grids                      1           1      0.33s  |
...
| O-> comms_map_transpose                           2           2      0.32s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.32s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.32s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.32s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.15s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          2                         |
|  /                                                                          |
| O-> cell_restore_wrapped                          2           2      0.13s  |
