...
|   o-> comms_send_complex                       1666        1666    352.26s  |
|   o-> comms_send_real                          3332        3332      0.02s  |
|   o-> comms_reduce_gv_real                        1           1      0.20s  |
...
|   o-> ion_atom_pseudo_scf                         3           3      1.82s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1666        1666     12.19s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4999        4999     14.87s  |
|    /                                                                        |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      88351       88351      9.59s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           88351                         |
|  /o-- secondd_tr_symmetrize_dmat               4999                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        93350       93350     10.15s  |
|    /                                                                        |
...
|   o-> ion_atom_ps_diag                          108         108      1.35s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            163320      163320      0.53s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               3           3      0.79s  |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.22s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.20s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.20s  |
+-----------------------------------------------------------------------------+
