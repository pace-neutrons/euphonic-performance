...
|   o-> comms_send_complex                       1087        1087    359.06s  |
|   o-> comms_send_real                          2174        2174      0.01s  |
|   o-> comms_reduce_gv_real                        1           1      0.10s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      57662       57662      6.32s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                          108         108      1.68s  |
...
| |/                                                                          |
| O-> ion_atom_regin                           158454      158454      0.86s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               3           3      0.80s  |
...
|   o-> basis_distribute_grids                      1           1      0.38s  |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.12s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              6                         |
|  /                                                                          |
| O-> ion_atom_allocate_pspot                       6           6      0.11s  |
...
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.10s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.10s  |
+-----------------------------------------------------------------------------+
