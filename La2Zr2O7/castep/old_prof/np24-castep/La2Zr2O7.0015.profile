...
|   o-> phonon_calculate                            1           1    373.01s  |
...
|   o-> comms_send_complex                       1087        1087    359.09s  |
|   o-> comms_send_real                          2174        2174      0.01s  |
|   o-> comms_reduce_gv_real                        1           1      0.12s  |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.13s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          2                         |
|  /                                                                          |
| O-> cell_restore_wrapped                          2           2      0.13s  |
...
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.12s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.12s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              6                         |
|  /                                                                          |
| O-> ion_atom_allocate_pspot                       6           6      0.11s  |
