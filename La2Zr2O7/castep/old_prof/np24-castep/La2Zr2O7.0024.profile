...
|   o-> phonon_calculate                            1           1    373.00s  |
|   o-> check_forces_stresses                       1           1      0.00s  |
|   o-> model_write                                 1           1      0.20s  |
...
|   o-> phonon_real_to_fine                      1087        1087      1.12s  |
|   o-> phonon_enforce_dmat_sumrule              1086        1086     10.66s  |
|   o-> phonon_prepare_and_diagonalise           1086        1086      1.81s  |
|   o-> phonon_accumulate_adp                    1086        1086      0.05s  |
|   o-> comms_send_complex                       1086        1086    358.93s  |
...
|   o-> cell_restore_wrapped                        2           2      0.18s  |
...
|   o-> wave_initialise_wv                          1           1      0.19s  |
|   o-> model_read_occ_eigenvalues                  1           1      0.03s  |
...
|   o-> ion_atom_allocate_pspot                     6           6      0.11s  |
|   o-> ion_atom_generate_psp                       3           3     16.66s  |
|   o-> ion_set_data                                3           3      0.12s  |
|   o-> ion_atom_deallocate_pspot                   7           7      0.00s  |
|   o-> ion_set_psp                                 3           3      0.05s  |
|   o-> ion_atom_pseudo_scf                         3           3      2.27s  |
...
|   o-> ion_atom_construct_psp                      3           3     14.92s  |
...
|   o-> ion_atom_radial_transform                  92          92      2.61s  |
...
| O-> phonon_enforce_dmat_sumrule                1086        1086     10.66s  |
|    /                                                                        |
|   o-> phonon_mass_weight_dmat                  2172        2172      0.03s  |
|   o-> phonon_diagonalise_d_cmplx               3258        3258      2.33s  |
|   o-> secondd_find_acoustics                   1086        1086      0.13s  |
|   o-> secondd_symmetrize_dmat_cmplx            1086        1086      8.02s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_real_to_fine                      1087                         |
|  /o-- phonon_enforce_dmat_sumrule              1086                         |
|  /o-- phonon_prepare_and_diagonalise           1086                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              3259        3259      9.82s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             3259        3259      0.01s  |
|   o-> hermitian4                               3259        3259      0.04s  |
|   o-> cell_copy_symmetry                       6518        6518      0.06s  |
|   o-> cell_reduce_symmetry_ops_wrapped         3259        3259      1.14s  |
|   o-> secondd_group_symmetrize_dmat            3259        3259      7.27s  |
|   o-> cell_deallocate                          3259        3259      0.01s  |
|   o-> secondd_find_inversion                   3259        3259      0.01s  |
|   o-> secondd_tr_symmetrize_dmat               3259        3259      1.15s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_gcopy_integer                         436         436      9.69s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> cell_read_wrapped                             1           1      8.92s  |
...
|    /                                                                        |
|   o-> cell_setup_keywords                         1           1      0.00s  |
|   o-> comms_gcopy_integer                        60          60      0.77s  |
|   o-> comms_gcopy_real                           78          78      7.48s  |
|   o-> comms_gcopy_character                      29          29      0.00s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            3259                         |
|  /                                                                          |
| O-> secondd_group_symmetrize_dmat              3259        3259      7.27s  |
|    /                                                                        |
|   o-> cell_factor_group_symmetry_wrapped       3259        3259      0.04s  |
|   o-> secondd_check_equiv_ions                 3259        3259      0.03s  |
|   o-> secondd_apply_symmetry_to_dmat_ion      57611       57611      6.30s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           57611                         |
|  /o-- secondd_tr_symmetrize_dmat               3259                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60870       60870      6.66s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             60870       60870      2.12s  |
+-----------------------------------------------------------------------------+
...
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    96          96      3.18s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              3258                         |
|  /o-- phonon_prepare_and_diagonalise           1086                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 4344        4344      3.11s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              3                         |
|  /                                                                          |
| O-> ion_atom_pseudo_scf                           3           3      2.27s  |
...
|   o-> ion_atom_init_pseudo_atom                   3           3      0.34s  |
|   o-> ion_atom_init_pseudo_H                      3           3      0.00s  |
|   o-> ion_atom_ps_diag                          108         108      1.71s  |
|   o-> ion_atom_set_pseudo_H                     108         108      0.07s  |
|   o-> ion_atom_regin                           6003        6003      0.03s  |
|   o-> ion_atom_basis_pseudo_dealloc               3           3      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      60870                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               60870       60870      2.12s  |
|    /                                                                        |
|   o-> q_is_a_g                                56534       56534      0.17s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1086        1086      0.92s  |
|   o-> phonon_constrain_dmat                    1086        1086      0.00s  |
|   o-> phonon_mass_weight_dmat                  1086        1086      0.01s  |
|   o-> phonon_diagonalise_d_cmplx               1086        1086      0.78s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pseudo_scf                       108                         |
|  /                                                                          |
| O-> ion_atom_ps_diag                            108         108      1.71s  |
|    /                                                                        |
|   o-> ion_atom_regin                         139221      139221      0.77s  |
...
| O-> secondd_tr_symmetrize_dmat                 3259        3259      1.15s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 3259        3259      0.72s  |
|   o-> secondd_apply_symmetry_to_dmat_ion       3259        3259      0.37s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            3259                         |
|  /                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           3259        3259      1.14s  |
|    /                                                                        |
|   o-> cell_check_group                         3259        3259      1.07s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      0.88s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         3259                         |
|  /                                                                          |
| O-> cell_check_group                           3259        3259      1.07s  |
|    /                                                                        |
|   o-> algor_invert_real                       54352       54352      0.16s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           158454      158454      0.87s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       3                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               3           3      0.79s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat            3259                         |
|  /o-- secondd_tr_symmetrize_dmat               3259                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                   6518        6518      0.75s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            106480      106480      0.36s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_ae_scf                           204                         |
|  /                                                                          |
| O-> ion_atom_ae_solve                           204         204      0.75s  |
|    /                                                                        |
|   o-> ion_atom_koelling_harmon_solve            204         204      0.75s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_ae_solve                         204                         |
|  /                                                                          |
| O-> ion_atom_koelling_harmon_solve              204         204      0.75s  |
|    /                                                                        |
|   o-> ion_atom_cfd_solve                       9962        9962      0.52s  |
...
|   o-> ion_atom_core_pseudise                      3           3      0.13s  |
...
|   o-> basis_distribute_grids                      1           1      0.37s  |
...
|   o-> basis_count_plane_waves                     1           1      0.13s  |
...
|   o-> comms_map_transpose                         2           2      0.36s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.36s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.36s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.36s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.36s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               106480                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              106480      106480      0.36s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_locate                         12410       12410      0.06s  |
|   o-> ion_atom_interpolate                    12410       12410      0.06s  |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.33s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.32s  |
|    /                                                                        |
...
|          o-> wave_Sorthonormalise_wv              1           1      0.18s  |
|    /                                                                        |
...
| O-> wave_Sorthonormalise_wv                       1           1      0.18s  |
|    /                                                                        |
|   o-> wave_Sorthonormalise_wv_ks                  5           5      0.18s  |
+-----------------------------------------------------------------------------+
|   o-- wave_Sorthonormalise_wv                     5                         |
|  /                                                                          |
| O-> wave_Sorthonormalise_wv_ks                    5           5      0.18s  |
|    /                                                                        |
|   o-> wave_calc_Soverlap_wv_ks                    5           5      0.17s  |
|   o-> wave_orthonormalise_over_wv_ks              5           5      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                           10                         |
|  /o-- secondd_compute_atom_phases             56534                         |
|  /o-- phonon_prepare_and_diagonalise           2172                         |
| |/                                                                          |
| O-> q_is_a_g                                  58716       58716      0.18s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          2                         |
|  /                                                                          |
| O-> cell_restore_wrapped                          2           2      0.18s  |
...
|   o-> cell_analyse_symmetry_wrapped               2           2      0.17s  |
+-----------------------------------------------------------------------------+
...
|   o-> wave_beta_phi_wv_ks                         5           5      0.15s  |
...
|  /o-- cell_check_group                        54352                         |
| |/                                                                          |
| O-> algor_invert_real                         54365       54365      0.16s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_all_beta_multi_phi_recip                5           5      0.15s  |
+-----------------------------------------------------------------------------+
|   o-- wave_beta_phi_wv_ks                         5                         |
|  /                                                                          |
| O-> ion_all_beta_multi_phi_recip                  5           5      0.15s  |
|    /                                                                        |
|   o-> ion_beta_recip_set                          5           5      0.05s  |
|   o-> algor_matmul_cmplx_cmplx                    5           5      0.03s  |
|   o-> comms_reduce_gv_complex                     5           5      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- basis_initialise                            1                         |
|  /                                                                          |
| O-> basis_count_plane_waves                       1           1      0.13s  |
...
|   o-> comms_reduce_kp_integer                     3           3      0.13s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_regin                           4113        4113      0.03s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_complex                    10                         |
|  /o-- comms_reduce_bnd_complex                    5                         |
| |/                                                                          |
| O-> comms_reduce_array_complex                   15          15      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip                5                         |
|  /o-- wave_calc_Soverlap_wv_ks                    5                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                      10          10      0.06s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                 10          10      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            6518                         |
|  /                                                                          |
| O-> cell_copy_symmetry                         6518        6518      0.06s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_interpolate                      12454       12454      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_init_pseudo_atom               12410                         |
|  /                                                                          |
| O-> ion_atom_locate                           12410       12410      0.06s  |
...
|  /o-- phonon_prepare_and_diagonalise           1086                         |
| |/                                                                          |
| O-> phonon_mass_weight_dmat                    3258        3258      0.04s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            3259                         |
|  /                                                                          |
| O-> hermitian4                                 3259        3259      0.04s  |
...
| O-> model_read_occ_eigenvalues                    1           1      0.03s  |
|    /                                                                        |
|   o-> comms_copy_gv_real                          2           2      0.03s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_deallocate                            3278        3278      0.01s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_generate_ionic_constraints             1           1      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_real_to_fine                      1087                         |
|  /                                                                          |
| O-> check_image_list                           1087        1087      0.01s  |
...
|  /o-- phonon_real_to_fine                      1087                         |
| |/                                                                          |
| O-> cell_num_supercells                        1092        1092      0.00s  |
+-----------------------------------------------------------------------------+
