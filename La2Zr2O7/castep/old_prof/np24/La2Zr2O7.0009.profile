...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              3262        3262      9.28s  |
|    /                                                                        |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      57662       57662      5.71s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           57662                         |
|  /o-- secondd_tr_symmetrize_dmat               3262                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        60924       60924      6.05s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      0.22s  |
+-----------------------------------------------------------------------------+
...
|   o-- phonons                                     1                         |
|  /                                                                          |
| O-> cell_generate_symmetry_wrapped                1           1      0.11s  |
|    /                                                                        |
