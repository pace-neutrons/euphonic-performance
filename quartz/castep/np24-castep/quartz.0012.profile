...
|   o-> phonon_real_to_fine                      1088        1088     32.63s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      1.26s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.39s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.02s  |
|   o-> comms_send_complex                       1087        1087     42.24s  |
...
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                1105        1105     31.39s  |
|    /                                                                        |
...
|   o-> ion_atom_pseudo_scf                         2           2      1.35s  |
...
|   o-> ion_atom_ps_diag                           63          63      1.20s  |
...
| O-> ion_atom_ps_diag                             63          63      1.20s  |
|    /                                                                        |
|   o-> ion_atom_regin                          90972       90972      0.56s  |
...
| |/                                                                          |
| O-> ion_atom_regin                            95801       95801      0.58s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_set_supercell_symmetry                 2           2      0.21s  |
...
|   o-> cell_find_related_atoms_supercell           2           2      0.14s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> model_write                                   1           1      0.15s  |
...
|   o-> algor_matmul_cmplx_cmplx                    7           7      0.02s  |
|   o-> comms_reduce_gv_complex                     7           7      0.04s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              1087                         |
|  /                                                                          |
| O-> secondd_find_acoustics                     1087        1087      0.06s  |
...
| |/                                                                          |
| O-> comms_reduce_array_complex                  123         123      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip                7                         |
|  /o-- wave_calc_Soverlap_wv_ks                    7                         |
|  /o-- ewald_calc_E2_dipole_dipole                34                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                      48          48      0.06s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                 48          48      0.06s  |
+-----------------------------------------------------------------------------+
