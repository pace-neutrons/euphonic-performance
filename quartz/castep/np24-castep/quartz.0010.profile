...
|   o-> phonon_enforce_dmat_sumrule              1087        1087      1.27s  |
...
|   o-> ewald_calc_E2_dipole_dipole              1088        1088     31.34s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                       17                         |
|  /o-- phonon_real_to_fine                      1088                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                1105        1105     31.42s  |
|    /                                                                        |
...
|   o-> ion_initialise                              1           1      1.30s  |
|   o-> basis_initialise                            2           2      0.13s  |
...
|   o-> ion_atom_pseudo_scf                         2           2      1.28s  |
...
|   o-> ion_atom_ps_diag                           63          63      1.11s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      0.64s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pseudo_scf                        63                         |
|  /                                                                          |
| O-> ion_atom_ps_diag                             63          63      1.11s  |
|    /                                                                        |
|   o-> ion_atom_regin                          90972       90972      0.52s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              3362        3362      1.03s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             3362        3362      0.01s  |
|   o-> hermitian4                               3362        3362      0.02s  |
|   o-> cell_copy_symmetry                       6724        6724      0.04s  |
|   o-> cell_reduce_symmetry_ops_wrapped         3362        3362      0.12s  |
|   o-> secondd_group_symmetrize_dmat            3362        3362      0.61s  |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        13442       13442      0.52s  |
|    /                                                                        |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      0.09s  |
...
|   o-> basis_distribute_grids                      1           1      0.12s  |
...
|   o-> comms_map_transpose                         2           2      0.11s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            3362                         |
|  /                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           3362        3362      0.12s  |
|    /                                                                        |
|   o-> cell_check_group                         3362        3362      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                        1                         |
|  /o-- phonon_real_to_fine                      1088                         |
| |/                                                                          |
...
| O-> comms_map_transpose                           2           2      0.11s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.11s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.11s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.11s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- cell_unfold_kpoints_arg_trace               1                         |
|  /o-- cell_generate_MP_set_wrapped                2                         |
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      0.09s  |
|    /                                                                        |
...
|   o-> secondd_apply_symmetry_to_dmat_ion       1140        1140      0.07s  |
+-----------------------------------------------------------------------------+
...
|   o-> algor_matmul_cmplx_cmplx                    7           7      0.04s  |
|   o-> comms_reduce_gv_complex                     7           7      0.02s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              1087                         |
|  /                                                                          |
| O-> secondd_find_acoustics                     1087        1087      0.06s  |
