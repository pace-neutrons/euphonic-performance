...
|   o-> phonon_real_to_fine                      3573        3573    106.09s  |
|   o-> phonon_enforce_dmat_sumrule              3572        3572      3.52s  |
|   o-> phonon_prepare_and_diagonalise           3572        3572      1.13s  |
|   o-> phonon_accumulate_adp                    3572        3572      0.06s  |
|   o-> comms_send_complex                       3572        3572      1.44s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            3573        3573      0.60s  |
|   o-> secondd_symmetrize_born_charges          3573        3573      0.34s  |
|   o-> ewald_calc_E2_dipole_dipole              3573        3573    102.94s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                       17                         |
|  /o-- phonon_real_to_fine                      3573                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                3590        3590    103.03s  |
|    /                                                                        |
...
|   o-> phonon_diagonalise_d_cmplx              10716       10716      1.15s  |
|   o-> secondd_find_acoustics                   3572        3572      0.19s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx             10817       10817      2.98s  |
|    /                                                                        |
|   o-> two_q_is_a_g                            10817       10817      0.03s  |
|   o-> hermitian4                              10817       10817      0.05s  |
|   o-> cell_copy_symmetry                      21634       21634      0.10s  |
|   o-> cell_reduce_symmetry_ops_wrapped        10817       10817      0.35s  |
|   o-> secondd_group_symmetrize_dmat           10817       10817      1.81s  |
|   o-> cell_deallocate                         10817       10817      0.04s  |
|   o-> secondd_find_inversion                  10817       10817      0.04s  |
|   o-> secondd_tr_symmetrize_dmat               3625        3625      0.20s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_check_equiv_ions                10817       10817      0.07s  |
|   o-> secondd_apply_symmetry_to_dmat_ion      39537       39537      1.33s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat            100                         |
|  /o-- secondd_group_symmetrize_dmat           39537                         |
|  /o-- secondd_tr_symmetrize_dmat               3625                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        43262       43262      1.48s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             43262       43262      0.65s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule             10716                         |
|  /o-- phonon_prepare_and_diagonalise           3572                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                14288       14288      1.47s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         3572                         |
|  /                                                                          |
| O-> comms_send_complex                         3572        3572      1.44s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            3572        3572      0.56s  |
...
| O-> cell_reduce_symmetry_ops_wrapped          10817       10817      0.35s  |
|    /                                                                        |
|   o-> cell_check_group                        10817       10817      0.24s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion       3625        3625      0.14s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              3572                         |
|  /                                                                          |
| O-> secondd_find_acoustics                     3572        3572      0.19s  |
...
| O-> model_write                                   1           1      0.15s  |
|    /                                                                        |
|   o-> model_write_all                             1           1      0.10s  |
|   o-> comms_barrier_farm                          1           1      0.00s  |
|   o-> comms_barrier                               1           1      0.05s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                         36050       36050      0.11s  |
+-----------------------------------------------------------------------------+
...
|   o-> density_write_parallel                      1           1      0.10s  |
...
| O-> density_write_parallel                        1           1      0.10s  |
|    /                                                                        |
|   o-> comms_gather_gv_integer                     3           3      0.10s  |
...
| |/                                                                          |
| O-> comms_gather_gv_integer                      18          18      0.10s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      0.10s  |
...
| |/                                                                          |
| O-> cell_deallocate                           10839       10839      0.04s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           10817                         |
|  /                                                                          |
| O-> secondd_find_inversion                    10817       10817      0.04s  |
