...
|   o-> model_continuation                          1           1      9.83s  |
...
|   o-> comms_send_complex                       1087        1087     42.19s  |
|   o-> comms_send_real                          2174        2174      0.01s  |
|   o-> comms_reduce_gv_real                        1           1      0.04s  |
...
|   o-> ewald_calc_E2_dipole_dipole              1088        1088     31.40s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                       17                         |
|  /o-- phonon_real_to_fine                      1088                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                1105        1105     31.48s  |
|    /                                                                        |
...
|   o-> comms_reduce_gv_complex                    34          34      0.02s  |
...
|   o-> ion_initialise                              1           1      1.32s  |
|   o-> basis_initialise                            2           2      0.11s  |
...
| |/                                                                          |
| O-> comms_gcopy_integer                         462         462      9.44s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> cell_read_wrapped                             1           1      8.68s  |
...
|   o-> comms_gcopy_integer                        64          64      8.67s  |
...
| |/                                                                          |
| O-> comms_gcopy_real                            561         561      7.53s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> ion_initialise                                1           1      1.32s  |
...
|   o-> ion_atom_pseudo_scf                         2           2      1.30s  |
...
|   o-> ion_atom_ps_diag                           63          63      1.14s  |
...
|   o-> phonon_diagonalise_d_cmplx               3261        3261      0.42s  |
...
| O-> ion_atom_ps_diag                             63          63      1.14s  |
|    /                                                                        |
|   o-> ion_atom_regin                          90972       90972      0.53s  |
...
|   o-> secondd_tr_symmetrize_dmat               1140        1140      0.09s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_gather_gv_integer                    12          12      0.05s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      0.09s  |
+-----------------------------------------------------------------------------+
...
|   o-> wave_beta_phi_wv_ks                         7           7      0.08s  |
...
|   o-> density_write_parallel                      1           1      0.07s  |
...
|   o-> comms_gather_gv_real                        1           1      0.07s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_complex                  123         123      0.07s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip                7                         |
|  /o-- wave_calc_Soverlap_wv_ks                    7                         |
|  /o-- ewald_calc_E2_dipole_dipole                34                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                      48          48      0.07s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                 48          48      0.07s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_reduce_gv_complex                     7           7      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              1087                         |
|  /                                                                          |
| O-> secondd_find_acoustics                     1087        1087      0.06s  |
...
| |/                                                                          |
| O-> comms_gather_gv_integer                      18          18      0.05s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          5           5      0.04s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     3           3      0.04s  |
+-----------------------------------------------------------------------------+
|   o-- ion_set_projectors                         15                         |
|  /o-- ewald_calc_E2_dipole_dipole                34                         |
|  /o-- bib_output                                  1                         |
| |/                                                                          |
| O-> comms_reduce_gv_logical                      50          50      0.04s  |
|    /                                                                        |
