...
|   o-> model_continuation                          1           1      9.84s  |
...
|   o-> phonon_recip_to_real                        1           1      0.36s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   17          17      0.00s  |
|   o-> cell_supercell                              1           1      0.20s  |
|   o-> phonon_real_to_fine                      1088        1088     32.74s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      1.25s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.39s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.02s  |
|   o-> comms_send_complex                       1087        1087     42.16s  |
...
|   o-> check_image_list                         1088        1088      0.03s  |
|   o-> secondd_symmetrize_dmat_cmplx            1088        1088      0.17s  |
|   o-> secondd_symmetrize_born_charges          1088        1088      0.11s  |
|   o-> ewald_calc_E2_dipole_dipole              1088        1088     31.43s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                       17                         |
|  /o-- phonon_real_to_fine                      1088                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                1105        1105     31.50s  |
|    /                                                                        |
...
|   o-> algor_invert_real                        1105        1105      0.00s  |
...
|   o-> wave_initialise_wv                          1           1      0.11s  |
...
| |/                                                                          |
| O-> comms_gcopy_integer                         462         462      9.45s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> cell_read_wrapped                             1           1      8.69s  |
...
|   o-> comms_gcopy_integer                        64          64      8.68s  |
...
|   o-> comms_gcopy_real                           76          76      7.51s  |
|   o-> comms_gcopy_character                      14          14      0.00s  |
...
| |/                                                                          |
| O-> comms_gcopy_real                            561         561      7.52s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> ion_initialise                                1           1      1.34s  |
...
|   o-> ion_atom_pseudo_scf                         2           2      1.33s  |
...
|   o-> ion_atom_ps_diag                           63          63      1.17s  |
|   o-> ion_atom_set_pseudo_H                      63          63      0.01s  |
|   o-> ion_atom_regin                           4002        4002      0.02s  |
...
|   o-> phonon_diagonalise_d_cmplx               3261        3261      0.43s  |
|   o-> secondd_find_acoustics                   1087        1087      0.06s  |
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      0.63s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pseudo_scf                        63                         |
|  /                                                                          |
| O-> ion_atom_ps_diag                             63          63      1.17s  |
|    /                                                                        |
|   o-> ion_atom_regin                          90972       90972      0.54s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              3362        3362      1.02s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             3362        3362      0.01s  |
|   o-> hermitian4                               3362        3362      0.02s  |
|   o-> cell_copy_symmetry                       6724        6724      0.03s  |
|   o-> cell_reduce_symmetry_ops_wrapped         3362        3362      0.12s  |
|   o-> secondd_group_symmetrize_dmat            3362        3362      0.60s  |
|   o-> cell_deallocate                          3362        3362      0.01s  |
|   o-> secondd_find_inversion                   3362        3362      0.01s  |
|   o-> secondd_tr_symmetrize_dmat               1140        1140      0.08s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            3362                         |
|  /                                                                          |
| O-> secondd_group_symmetrize_dmat              3362        3362      0.60s  |
|    /                                                                        |
|   o-> cell_factor_group_symmetry_wrapped       3362        3362      0.01s  |
|   o-> secondd_check_equiv_ions                 3362        3362      0.02s  |
|   o-> secondd_apply_symmetry_to_dmat_ion      12202       12202      0.44s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                            95801       95801      0.57s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              3261                         |
|  /o-- phonon_prepare_and_diagonalise           1087                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 4348        4348      0.54s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat            100                         |
|  /o-- secondd_group_symmetrize_dmat           12202                         |
|  /o-- secondd_tr_symmetrize_dmat               1140                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        13442       13442      0.50s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             13442       13442      0.23s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                        1                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> cell_supercell                                2           2      0.41s  |
|    /                                                                        |
|   o-> cell_deallocate                             2           2      0.00s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      0.19s  |
|   o-> phonon_constrain_dmat                    1087        1087      0.00s  |
|   o-> phonon_mass_weight_dmat                  1087        1087      0.01s  |
|   o-> phonon_diagonalise_d_cmplx               1087        1087      0.11s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                            1                         |
|  /                                                                          |
| O-> phonon_recip_to_real                          1           1      0.36s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      13442                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               13442       13442      0.23s  |
|    /                                                                        |
|   o-> q_is_a_g                                 8950        8950      0.03s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_set_supercell_symmetry                   2           2      0.19s  |
...
|   o-> cell_num_supercells                         2           2      0.00s  |
|   o-> algor_invert_real                           2           2      0.00s  |
|   o-> cell_reduce_symmetry_supercell              2           2      0.02s  |
...
| O-> model_write                                   1           1      0.15s  |
|    /                                                                        |
|   o-> model_write_all                             1           1      0.07s  |
|   o-> comms_barrier_farm                          1           1      0.00s  |
|   o-> comms_barrier                               1           1      0.08s  |
+-----------------------------------------------------------------------------+
...
| O-> cell_reduce_symmetry_ops_wrapped           3362        3362      0.12s  |
|    /                                                                        |
|   o-> cell_check_group                         3362        3362      0.08s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      0.12s  |
...
|          o-> wave_Sorthonormalise_wv              1           1      0.11s  |
|    /                                                                        |
...
| O-> wave_Sorthonormalise_wv                       1           1      0.11s  |
|    /                                                                        |
|   o-> wave_Sorthonormalise_wv_ks                  7           7      0.11s  |
+-----------------------------------------------------------------------------+
|   o-- wave_Sorthonormalise_wv                     7                         |
|  /                                                                          |
| O-> wave_Sorthonormalise_wv_ks                    7           7      0.11s  |
|    /                                                                        |
|   o-> wave_calc_Soverlap_wv_ks                    7           7      0.10s  |
|   o-> wave_orthonormalise_over_wv_ks              7           7      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                        1                         |
|  /o-- phonon_real_to_fine                      1088                         |
| |/                                                                          |
| O-> secondd_symmetrize_born_charges            1089        1089      0.11s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 1089        1089      0.05s  |
|   o-> secondd_apply_symmetry_to_born           6534        6534      0.03s  |
+-----------------------------------------------------------------------------+
...
|   o-> wave_beta_phi_wv_ks                         7           7      0.10s  |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      0.10s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip             1204        1204      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      0.10s  |
...
|   o-> ion_all_beta_multi_phi_recip                7           7      0.10s  |
+-----------------------------------------------------------------------------+
|   o-- wave_beta_phi_wv_ks                         7                         |
|  /                                                                          |
| O-> ion_all_beta_multi_phi_recip                  7           7      0.10s  |
|    /                                                                        |
|   o-> ion_beta_recip_set                          7           7      0.02s  |
|   o-> algor_matmul_cmplx_cmplx                    7           7      0.05s  |
|   o-> comms_reduce_gv_complex                     7           7      0.03s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal             1204                         |
|  /o-- cell_map_kpoint_subset                      7                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip               1211        1211      0.09s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                   1211        1211      0.02s  |
|   o-> algor_invert_real                        2422        2422      0.01s  |
|   o-> algor_sort                               1211        1211      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            1140                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 1140        1140      0.08s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 1140        1140      0.01s  |
|   o-> secondd_apply_symmetry_to_dmat_ion       1140        1140      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         3362                         |
|  /                                                                          |
| O-> cell_check_group                           3362        3362      0.08s  |
|    /                                                                        |
|   o-> algor_invert_real                        8840        8840      0.03s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_send_real                            2177        2177      0.08s  |
+-----------------------------------------------------------------------------+
|   o-- model_write                                 1                         |
|  /                                                                          |
| O-> comms_barrier                                 1           1      0.08s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_born_charges          1089                         |
|  /o-- secondd_apply_symmetry_to_dmat            100                         |
|  /o-- secondd_group_symmetrize_dmat            3362                         |
|  /o-- secondd_tr_symmetrize_dmat               1140                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                   5691        5691      0.08s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions              8330        8330      0.03s  |
+-----------------------------------------------------------------------------+
|   o-- model_write                                 1                         |
|  /                                                                          |
| O-> model_write_all                               1           1      0.07s  |
...
|   o-> model_write_occ_eigenvalues                 1           1      0.07s  |
...
| |/                                                                          |
| O-> comms_reduce_array_complex                  123         123      0.05s  |
+-----------------------------------------------------------------------------+
...
|  /o-- cell_set_supercell_symmetry                 2                         |
|  /o-- ewald_calc_E2_dipole_dipole              1105                         |
|  /o-- cell_find_kpoint_transform_kpoints        100                         |
|  /o-- cell_check_group                         8840                         |
| |/                                                                          |
| O-> algor_invert_real                         13685       13685      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip                7                         |
|  /o-- wave_calc_Soverlap_wv_ks                    7                         |
|  /o-- ewald_calc_E2_dipole_dipole                34                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                      48          48      0.05s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                 48          48      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip                7                         |
|  /                                                                          |
| O-> algor_matmul_cmplx_cmplx                      7           7      0.05s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_born_charges          6534                         |
|  /                                                                          |
| O-> secondd_apply_symmetry_to_born             6534        6534      0.03s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions                 8330                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions                8330        8330      0.03s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1087                         |
...
| |/                                                                          |
| O-> cell_find_reduced_cell                     1212        1212      0.02s  |
|    /                                                                        |
|   o-> algor_invert_real                        1212        1212      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pseudo_scf                         2                         |
|  /                                                                          |
| O-> ion_atom_init_pseudo_basis                    2           2      0.02s  |
...
|  /o-- phonon_prepare_and_diagonalise           1087                         |
| |/                                                                          |
| O-> phonon_mass_weight_dmat                    3261        3261      0.02s  |
+-----------------------------------------------------------------------------+
|   o-- ion_set_projectors                         15                         |
|  /o-- ewald_calc_E2_dipole_dipole                34                         |
|  /o-- bib_output                                  1                         |
| |/                                                                          |
| O-> comms_reduce_gv_logical                      50          50      0.02s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> cell_deallocate                            3384        3384      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            3362                         |
|  /                                                                          |
| O-> secondd_find_inversion                     3362        3362      0.01s  |
...
|  /o-- bib_output                                  1                         |
| |/                                                                          |
| O-> comms_reduce_kp_logical                      40          40      0.01s  |
|    /                                                                        |
|   o-> comms_lcopy                                 1           1      0.00s  |
+-----------------------------------------------------------------------------+
...
COMMS_BND                               0.00s
COMMS_FARM                              0.00s
     246 different subroutines and functions were traced
Hash collisions:        317
