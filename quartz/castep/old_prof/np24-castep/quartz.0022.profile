...
|   o-> phonon_real_to_fine                      1088        1088     32.66s  |
...
|   o-> comms_send_complex                       1087        1087     42.25s  |
...
|   o-> ion_atom_pseudo_scf                         2           2      1.34s  |
...
|   o-> ion_atom_ps_diag                           63          63      1.19s  |
...
| O-> wave_Sorthonormalise_wv_ks                    7           7      0.11s  |
|    /                                                                        |
|   o-> wave_calc_Soverlap_wv_ks                    7           7      0.11s  |
...
|   o-> comms_reduce_gv_complex                     7           7      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      0.10s  |
...
| |/                                                                          |
| O-> comms_reduce_array_real                      11          11      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              2                         |
|  /                                                                          |
| O-> ion_atom_read_recpot                          2           2      0.01s  |
