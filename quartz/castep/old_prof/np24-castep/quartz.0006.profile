...
|   o-> phonon_real_to_fine                      1088        1088     32.73s  |
...
|   o-> comms_send_complex                       1087        1087     42.13s  |
...
|   o-> ewald_calc_E2_dipole_dipole              1088        1088     31.41s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                       17                         |
|  /o-- phonon_real_to_fine                      1088                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                1105        1105     31.49s  |
|    /                                                                        |
...
| O-> ion_atom_ps_diag                             63          63      1.20s  |
|    /                                                                        |
|   o-> ion_atom_regin                          90972       90972      0.55s  |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          5           5      0.06s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> comms_reduce_array_real                      11          11      0.06s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_complex                  123         123      0.02s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip                7                         |
|  /o-- wave_calc_Soverlap_wv_ks                    7                         |
|  /o-- ewald_calc_E2_dipole_dipole                34                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                      48          48      0.02s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                 48          48      0.02s  |
+-----------------------------------------------------------------------------+
