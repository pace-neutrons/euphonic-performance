...
|   o-> phonon_diagonalise_d_cmplx               4998        4998      0.56s  |
|   o-> secondd_find_acoustics                   1666        1666      0.07s  |
|   o-> secondd_symmetrize_dmat_cmplx            1666        1666      0.83s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5099        5099      1.38s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            5099        5099      0.81s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      18571       18571      0.58s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              4998                         |
|  /o-- phonon_prepare_and_diagonalise           1666                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 6664        6664      0.72s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_real                       9           9      0.03s  |
+-----------------------------------------------------------------------------+
