...
|   o-> model_continuation                          1           1      9.23s  |
...
|   o-> phonon_calculate                            1           1    260.84s  |
|   o-> check_forces_stresses                       1           1      0.00s  |
|   o-> model_write                                 1           1      0.12s  |
...
|   o-> phonon_real_to_fine                      8335        8335    246.31s  |
|   o-> phonon_enforce_dmat_sumrule              8334        8334      8.12s  |
|   o-> phonon_prepare_and_diagonalise           8334        8334      2.61s  |
|   o-> phonon_accumulate_adp                    8334        8334      0.14s  |
|   o-> comms_send_complex                       8334        8334      2.78s  |
|   o-> comms_send_real                         16668       16668      0.06s  |
...
|   o-> check_image_list                         8335        8335      0.05s  |
|   o-> secondd_symmetrize_dmat_cmplx            8335        8335      1.33s  |
|   o-> secondd_symmetrize_born_charges          8335        8335      0.79s  |
|   o-> ewald_calc_E2_dipole_dipole              8335        8335    239.19s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                       17                         |
|  /o-- phonon_real_to_fine                      8335                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                8352        8352    239.35s  |
|    /                                                                        |
...
|   o-> algor_invert_real                        8352        8352      0.03s  |
...
|   o-> comms_gcopy_integer                        64          64      8.72s  |
...
|   o-> comms_gcopy_real                           76          76      7.45s  |
|   o-> comms_gcopy_character                      14          14      0.00s  |
...
| O-> phonon_enforce_dmat_sumrule                8334        8334      8.12s  |
|    /                                                                        |
|   o-> phonon_mass_weight_dmat                 16668       16668      0.08s  |
|   o-> phonon_diagonalise_d_cmplx              25002       25002      2.65s  |
|   o-> secondd_find_acoustics                   8334        8334      0.43s  |
|   o-> secondd_symmetrize_dmat_cmplx            8334        8334      4.14s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
...
| |/                                                                          |
| O-> comms_gcopy_real                            561         561      7.46s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                      100                         |
|  /o-- phonon_real_to_fine                      8335                         |
|  /o-- phonon_enforce_dmat_sumrule              8334                         |
|  /o-- phonon_prepare_and_diagonalise           8334                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx             25103       25103      6.78s  |
|    /                                                                        |
|   o-> two_q_is_a_g                            25103       25103      0.08s  |
|   o-> hermitian4                              25103       25103      0.12s  |
|   o-> cell_copy_symmetry                      50206       50206      0.23s  |
|   o-> cell_reduce_symmetry_ops_wrapped        25103       25103      0.80s  |
|   o-> secondd_group_symmetrize_dmat           25103       25103      4.10s  |
|   o-> cell_deallocate                         25103       25103      0.09s  |
|   o-> secondd_find_inversion                  25103       25103      0.09s  |
|   o-> secondd_tr_symmetrize_dmat               8387        8387      0.45s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           25103                         |
|  /                                                                          |
| O-> secondd_group_symmetrize_dmat             25103       25103      4.10s  |
|    /                                                                        |
|   o-> cell_factor_group_symmetry_wrapped      25103       25103      0.09s  |
|   o-> secondd_check_equiv_ions                25103       25103      0.15s  |
|   o-> secondd_apply_symmetry_to_dmat_ion      91919       91919      2.99s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule             25002                         |
|  /o-- phonon_prepare_and_diagonalise           8334                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                33336       33336      3.40s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat            100                         |
|  /o-- secondd_group_symmetrize_dmat           91919                         |
|  /o-- secondd_tr_symmetrize_dmat               8387                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       100406      100406      3.32s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            100406      100406      1.50s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         8334                         |
|  /                                                                          |
| O-> comms_send_complex                         8334        8334      2.78s  |
...
| O-> phonon_prepare_and_diagonalise             8334        8334      2.61s  |
|    /                                                                        |
|   o-> q_is_a_g                                16668       16668      0.05s  |
|   o-> secondd_symmetrize_dmat_cmplx            8334        8334      1.28s  |
|   o-> phonon_constrain_dmat                    8334        8334      0.03s  |
|   o-> phonon_mass_weight_dmat                  8334        8334      0.04s  |
|   o-> phonon_diagonalise_d_cmplx               8334        8334      0.75s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion     100406                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases              100406      100406      1.50s  |
|    /                                                                        |
|   o-> q_is_a_g                                66926       66926      0.20s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> ion_initialise                                1           1      0.84s  |
...
|   o-> ion_atom_pseudo_scf                         2           2      0.83s  |
...
|   o-> ion_atom_ps_diag                           63          63      0.69s  |
...
| O-> cell_reduce_symmetry_ops_wrapped          25103       25103      0.80s  |
|    /                                                                        |
|   o-> cell_check_group                        25103       25103      0.57s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                        1                         |
|  /o-- phonon_real_to_fine                      8335                         |
| |/                                                                          |
| O-> secondd_symmetrize_born_charges            8336        8336      0.79s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 8336        8336      0.35s  |
|   o-> secondd_apply_symmetry_to_born          50016       50016      0.23s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pseudo_scf                        63                         |
|  /                                                                          |
| O-> ion_atom_ps_diag                             63          63      0.69s  |
|    /                                                                        |
|   o-> ion_atom_regin                          90972       90972      0.31s  |
|   o-> ion_atom_rectoreal                        126         126      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped        25103                         |
|  /                                                                          |
| O-> cell_check_group                          25103       25103      0.57s  |
|    /                                                                        |
|   o-> algor_invert_real                       66816       66816      0.20s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_born_charges          8336                         |
|  /o-- secondd_apply_symmetry_to_dmat            100                         |
|  /o-- secondd_group_symmetrize_dmat           25103                         |
|  /o-- secondd_tr_symmetrize_dmat               8387                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  41926       41926      0.53s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions             59059       59059      0.18s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            8387                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 8387        8387      0.45s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 8387        8387      0.03s  |
|   o-> secondd_apply_symmetry_to_dmat_ion       8387        8387      0.32s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              8334                         |
|  /                                                                          |
| O-> secondd_find_acoustics                     8334        8334      0.43s  |
...
| |/                                                                          |
| O-> ion_atom_regin                            95801       95801      0.32s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate_dynamical_dfpt            27                         |
|  /o-- secondd_compute_atom_phases             66926                         |
|  /o-- phonon_calculate                           17                         |
|  /o-- phonon_prepare_and_diagonalise          16668                         |
| |/                                                                          |
| O-> q_is_a_g                                  83638       83638      0.25s  |
+-----------------------------------------------------------------------------+
...
|  /o-- ewald_calc_E2_dipole_dipole              8352                         |
|  /o-- cell_find_kpoint_transform_kpoints        100                         |
|  /o-- cell_check_group                        66816                         |
| |/                                                                          |
| O-> algor_invert_real                         78908       78908      0.24s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           50206                         |
|  /                                                                          |
| O-> cell_copy_symmetry                        50206       50206      0.23s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_born_charges         50016                         |
|  /                                                                          |
| O-> secondd_apply_symmetry_to_born            50016       50016      0.23s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions                59059                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions               59059       59059      0.18s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
...
|  /o-- phonon_prepare_and_diagonalise           8334                         |
| |/                                                                          |
| O-> phonon_mass_weight_dmat                   25002       25002      0.11s  |
+-----------------------------------------------------------------------------+
|   o-- cell_set_supercell_symmetry                 2                         |
|  /                                                                          |
| O-> cell_find_related_atoms_supercell             2           2      0.10s  |
...
| |/                                                                          |
| O-> cell_deallocate                           25125       25125      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           25103                         |
|  /                                                                          |
| O-> secondd_find_inversion                    25103       25103      0.09s  |
...
|   o-> density_write_parallel                      1           1      0.08s  |
...
| O-> density_write_parallel                        1           1      0.08s  |
|    /                                                                        |
|   o-> comms_gather_gv_integer                     3           3      0.08s  |
...
|   o-> cell_sort_kpoints_with_recip             1204        1204      0.06s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip               1211        1211      0.06s  |
|    /                                                                        |
...
| O-> ion_all_beta_multi_phi_recip                  7           7      0.06s  |
|    /                                                                        |
|   o-> ion_beta_recip_set                          7           7      0.04s  |
...
|   o-> ion_beta_recip_interpolation              315         315      0.02s  |
...
| |/                                                                          |
| O-> comms_reduce_array_complex                  123         123      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip                7                         |
|  /o-- wave_calc_Soverlap_wv_ks                    7                         |
|  /o-- ewald_calc_E2_dipole_dipole                34                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                      48          48      0.01s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                 48          48      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> bib_output                                    1           1      0.01s  |
...
|   o-> comms_reduce_gv_logical                     1           1      0.01s  |
