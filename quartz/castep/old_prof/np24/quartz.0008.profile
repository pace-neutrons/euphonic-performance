...
|   o-> phonon_real_to_fine                      1088        1088     32.57s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      1.14s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.38s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.02s  |
|   o-> comms_send_complex                       1087        1087     41.71s  |
...
|   o-> ewald_calc_E2_dipole_dipole              1088        1088     31.29s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                       17                         |
|  /o-- phonon_real_to_fine                      1088                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                1105        1105     31.33s  |
|    /                                                                        |
...
|   o-> phonon_diagonalise_d_cmplx               3261        3261      0.39s  |
|   o-> secondd_find_acoustics                   1087        1087      0.05s  |
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      0.58s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              3362        3362      0.97s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            3362        3362      0.57s  |
|   o-> cell_deallocate                          3362        3362      0.01s  |
|   o-> secondd_find_inversion                   3362        3362      0.01s  |
|   o-> secondd_tr_symmetrize_dmat               1140        1140      0.07s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      12202       12202      0.40s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              3261                         |
|  /o-- phonon_prepare_and_diagonalise           1087                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 4348        4348      0.50s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat            100                         |
|  /o-- secondd_group_symmetrize_dmat           12202                         |
|  /o-- secondd_tr_symmetrize_dmat               1140                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        13442       13442      0.45s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             13442       13442      0.19s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_set_supercell_symmetry                 2           2      0.20s  |
|   o-> cell_copy_kpoints                           2           2      0.00s  |
|   o-> cell_kpoints_spacing_wrapped                2           2      0.11s  |
...
|   o-> ewald_calc_E2_dipole_dipole                17          17      0.04s  |
...
|   o-> cell_find_related_atoms_supercell           2           2      0.13s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      0.11s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      0.11s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      0.11s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip             1202        1202      0.10s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                        1                         |
|  /o-- phonon_real_to_fine                      1088                         |
| |/                                                                          |
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip               1209        1209      0.10s  |
|    /                                                                        |
...
|   o-> secondd_apply_symmetry_to_dmat_ion       1140        1140      0.04s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                         13680       13680      0.06s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_real                       9           9      0.05s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonons                                     1                         |
| |/                                                                          |
| O-> cell_deallocate                            3386        3385      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            3362                         |
|  /                                                                          |
| O-> secondd_find_inversion                     3362        3362      0.01s  |
