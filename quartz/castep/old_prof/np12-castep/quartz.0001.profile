...
|   o-> comms_recv_complex                      25000       25000      0.34s  |
|   o-> comms_recv_real                         50000       50000      0.26s  |
|   o-> phonon_diag_and_output                  25000       25000     72.56s  |
...
|   o-> phonon_prepare_and_diagonalise          25000       25000      8.62s  |
|   o-> secondd_calc_irreps                     25000       25000      5.46s  |
|   o-> phonon_write                            50000       50000     52.69s  |
...
|   o-> phonon_write_freqs                      50000       50000      9.61s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> q_is_a_g                                50000       50000      0.15s  |
|   o-> secondd_symmetrize_dmat_cmplx           25000       25000      3.74s  |
|   o-> phonon_constrain_dmat                   25000       25000      0.08s  |
|   o-> phonon_mass_weight_dmat                 25000       25000      0.11s  |
|   o-> phonon_diagonalise_d_cmplx              25000       25000      3.17s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_symmetry_symbol_wrapped_wrapped    50000       50000      0.47s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx             25101       25101      3.76s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat           25101       25101      1.88s  |
...
| |/                                                                          |
| O-> cell_check_group                         100103      100103      1.89s  |
|    /                                                                        |
|   o-> algor_invert_real                      225156      225156      0.68s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_symmetry_symbol_wrapped_wrapped     200006      200006      1.86s  |
|    /                                                                        |
|   o-> algor_invert_real                      200006      200006      0.60s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_calc_irreps                     25000                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped          50101       50101      0.95s  |
|    /                                                                        |
|   o-> cell_check_group                        50101       50101      0.49s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> ion_initialise                                1           1      0.94s  |
...
|   o-> ion_atom_pseudo_scf                         2           2      0.93s  |
...
|   o-> ion_atom_ps_diag                           63          63      0.79s  |
...
| O-> ion_atom_ps_diag                             63          63      0.79s  |
|    /                                                                        |
|   o-> ion_atom_regin                          90972       90972      0.36s  |
...
|  /o-- secondd_calc_irreps                     50000                         |
| |/                                                                          |
| O-> cell_copy_symmetry                       100202      100202      0.44s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                            95801       95801      0.37s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                        25000                         |
|  /                                                                          |
| O-> comms_recv_complex                        25000       25000      0.34s  |
...
|  /o-- phonon_print_irreps                     25000                         |
| |/                                                                          |
| O-> cell_factor_group_symmetry_wrapped       100103      100103      0.32s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                            1                         |
|  /                                                                          |
| O-> phonon_recip_to_real                          1           1      0.32s  |
...
| |/                                                                          |
| O-> comms_recv_real                           50003       50003      0.26s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_calc_irreps                     25000                         |
|  /                                                                          |
| O-> cell_conjugacy_classes_wrapped            25000       25000      0.26s  |
...
| |/                                                                          |
| O-> cell_deallocate                           50123       50123      0.19s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_calc_irreps                     25000                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  50257       50257      0.17s  |
|    /                                                                        |
...
|  /o-- cell_supercell                              2                         |
| |/                                                                          |
| O-> cell_generate_ionic_constraints               3           3      0.10s  |
|    /                                                                        |
...
|  /o-- phonon_real_to_fine                         1                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                  18          18      0.09s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> comms_gather_gv_integer                      18          18      0.01s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_set_projectors                           15          15      0.01s  |
|    /                                                                        |
