...
|   o-> phonon_enforce_dmat_sumrule              1667        1667      1.76s  |
|   o-> phonon_prepare_and_diagonalise           1667        1667      0.55s  |
|   o-> phonon_accumulate_adp                    1667        1667      0.03s  |
|   o-> comms_send_complex                       1667        1667     23.07s  |
...
|   o-> ewald_calc_E2_dipole_dipole              1668        1668     48.01s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                       17                         |
|  /o-- phonon_real_to_fine                      1668                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                1685        1685     48.06s  |
|    /                                                                        |
...
|   o-> secondd_symmetrize_dmat_cmplx            1667        1667      0.90s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5102        5102      1.46s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            5102        5102      0.87s  |
|   o-> cell_deallocate                          5102        5102      0.02s  |
|   o-> secondd_find_inversion                   5102        5102      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               1720        1720      0.11s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> ion_initialise                                1           1      1.03s  |
...
|   o-> ion_atom_ps_diag                           63          63      0.87s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      18582       18582      0.64s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        20402       20402      0.72s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             20402       20402      0.33s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1667                         |
|  /                                                                          |
| O-> phonon_prepare_and_diagonalise             1667        1667      0.55s  |
