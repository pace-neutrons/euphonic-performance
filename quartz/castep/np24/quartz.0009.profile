...
|   o-> phonon_real_to_fine                      1088        1088     32.67s  |
...
|   o-> comms_send_complex                       1087        1087     42.22s  |
...
|   o-> ewald_calc_E2_dipole_dipole              1088        1088     31.37s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                       17                         |
|  /o-- phonon_real_to_fine                      1088                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                1105        1105     31.45s  |
|    /                                                                        |
...
|   o-> ion_atom_pseudo_scf                         2           2      1.32s  |
...
|   o-> ion_atom_ps_diag                           63          63      1.15s  |
...
| O-> density_write_parallel                        1           1      0.07s  |
|    /                                                                        |
|   o-> comms_gather_gv_integer                     3           3      0.07s  |
...
|   o-> algor_matmul_cmplx_cmplx                    7           7      0.03s  |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          5           5      0.05s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     3           3      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        3                         |
|  /o-- comms_reduce_bnd_real                       5                         |
|  /o-- comms_reduce_kp_real                        3                         |
| |/                                                                          |
| O-> comms_reduce_array_real                      11          11      0.05s  |
+-----------------------------------------------------------------------------+
