...
|   o-> phonon_real_to_fine                      2274        2274     67.56s  |
|   o-> phonon_enforce_dmat_sumrule              2273        2273      2.25s  |
|   o-> phonon_prepare_and_diagonalise           2273        2273      0.72s  |
|   o-> phonon_accumulate_adp                    2273        2273      0.04s  |
|   o-> comms_send_complex                       2273        2273      3.07s  |
...
|   o-> ewald_calc_E2_dipole_dipole              2274        2274     65.39s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                       17                         |
|  /o-- phonon_real_to_fine                      2274                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                2291        2291     65.45s  |
|    /                                                                        |
...
|   o-> secondd_symmetrize_dmat_cmplx            2273        2273      1.15s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              6920        6920      1.87s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            6920        6920      1.12s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      25248       25248      0.82s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> ion_initialise                                1           1      0.95s  |
...
|   o-> ion_atom_pseudo_scf                         2           2      0.94s  |
...
|   o-> ion_atom_ps_diag                           63          63      0.80s  |
...
| |/                                                                          |
| O-> ion_atom_regin                            95801       95801      0.38s  |
+-----------------------------------------------------------------------------+
...
| O-> density_write_parallel                        1           1      0.06s  |
|    /                                                                        |
|   o-> comms_gather_gv_integer                     3           3      0.06s  |
