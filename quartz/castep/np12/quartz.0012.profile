...
|   o-> model_continuation                          1           1      9.35s  |
...
|   o-> phonon_calculate                            1           1     74.24s  |
|   o-> check_forces_stresses                       1           1      0.00s  |
|   o-> model_write                                 1           1      0.10s  |
...
|   o-> phonon_real_to_fine                      2273        2273     68.06s  |
|   o-> phonon_enforce_dmat_sumrule              2272        2272      2.26s  |
|   o-> phonon_prepare_and_diagonalise           2272        2272      0.72s  |
|   o-> phonon_accumulate_adp                    2272        2272      0.04s  |
|   o-> comms_send_complex                       2272        2272      2.53s  |
...
|   o-> check_image_list                         2273        2273      0.03s  |
|   o-> secondd_symmetrize_dmat_cmplx            2273        2273      0.35s  |
|   o-> secondd_symmetrize_born_charges          2273        2273      0.22s  |
|   o-> ewald_calc_E2_dipole_dipole              2273        2273     65.80s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                       17                         |
|  /o-- phonon_real_to_fine                      2273                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                2290        2290     65.86s  |
|    /                                                                        |
...
|   o-> algor_invert_real                        2290        2290      0.01s  |
...
| |/                                                                          |
| O-> comms_gcopy_integer                         462         462      9.43s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> model_continuation                            1           1      9.35s  |
...
|   o-> comms_gcopy_real                           76          76      7.50s  |
|   o-> comms_gcopy_character                      14          14      0.00s  |
...
|   o-> phonon_diagonalise_d_cmplx               6816        6816      0.74s  |
|   o-> secondd_find_acoustics                   2272        2272      0.12s  |
|   o-> secondd_symmetrize_dmat_cmplx            2272        2272      1.15s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              6917        6917      1.88s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             6917        6917      0.02s  |
|   o-> hermitian4                               6917        6917      0.03s  |
|   o-> cell_copy_symmetry                      13834       13834      0.07s  |
|   o-> cell_reduce_symmetry_ops_wrapped         6917        6917      0.23s  |
|   o-> secondd_group_symmetrize_dmat            6917        6917      1.12s  |
|   o-> cell_deallocate                          6917        6917      0.03s  |
|   o-> secondd_find_inversion                   6917        6917      0.03s  |
|   o-> secondd_tr_symmetrize_dmat               2325        2325      0.13s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            6917                         |
|  /                                                                          |
| O-> secondd_group_symmetrize_dmat              6917        6917      1.12s  |
|    /                                                                        |
|   o-> cell_factor_group_symmetry_wrapped       6917        6917      0.02s  |
|   o-> secondd_check_equiv_ions                 6917        6917      0.04s  |
|   o-> secondd_apply_symmetry_to_dmat_ion      25237       25237      0.82s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              6816                         |
|  /o-- phonon_prepare_and_diagonalise           2272                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 9088        9088      0.95s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat            100                         |
|  /o-- secondd_group_symmetrize_dmat           25237                         |
|  /o-- secondd_tr_symmetrize_dmat               2325                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        27662       27662      0.92s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             27662       27662      0.42s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> ion_initialise                                1           1      0.91s  |
...
|   o-> ion_atom_pseudo_scf                         2           2      0.89s  |
...
|   o-> ion_atom_ps_diag                           63          63      0.75s  |
...
| O-> ion_atom_ps_diag                             63          63      0.75s  |
|    /                                                                        |
|   o-> ion_atom_regin                          90972       90972      0.34s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            2272        2272      0.35s  |
|   o-> phonon_constrain_dmat                    2272        2272      0.01s  |
|   o-> phonon_mass_weight_dmat                  2272        2272      0.01s  |
|   o-> phonon_diagonalise_d_cmplx               2272        2272      0.21s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      27662                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               27662       27662      0.42s  |
|    /                                                                        |
|   o-> q_is_a_g                                18430       18430      0.06s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                            95801       95801      0.36s  |
+-----------------------------------------------------------------------------+
...
| O-> cell_reduce_symmetry_ops_wrapped           6917        6917      0.23s  |
|    /                                                                        |
|   o-> cell_check_group                         6917        6917      0.16s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                        1                         |
|  /o-- phonon_real_to_fine                      2273                         |
| |/                                                                          |
...
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 2274        2274      0.10s  |
|   o-> secondd_apply_symmetry_to_born          13644       13644      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_set_supercell_symmetry                   2           2      0.17s  |
...
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         6917                         |
|  /                                                                          |
| O-> cell_check_group                           6917        6917      0.16s  |
|    /                                                                        |
|   o-> algor_invert_real                       18320       18320      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_born_charges          2274                         |
|  /o-- secondd_apply_symmetry_to_dmat            100                         |
|  /o-- secondd_group_symmetrize_dmat            6917                         |
|  /o-- secondd_tr_symmetrize_dmat               2325                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  11616       11616      0.15s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions             16625       16625      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            2325                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 2325        2325      0.13s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 2325        2325      0.01s  |
|   o-> secondd_apply_symmetry_to_dmat_ion       2325        2325      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              2272                         |
|  /                                                                          |
| O-> secondd_find_acoustics                     2272        2272      0.12s  |
...
|  /o-- cell_set_supercell_symmetry                 2                         |
|  /o-- ewald_calc_E2_dipole_dipole              2290                         |
|  /o-- cell_find_kpoint_transform_kpoints        100                         |
|  /o-- cell_check_group                        18320                         |
| |/                                                                          |
| O-> algor_invert_real                         24350       24350      0.08s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      0.07s  |
...
|  /o-- secondd_compute_atom_phases             18430                         |
|  /o-- phonon_calculate                           17                         |
|  /o-- phonon_prepare_and_diagonalise           4544                         |
| |/                                                                          |
| O-> q_is_a_g                                  23018       23018      0.07s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           13834                         |
|  /                                                                          |
| O-> cell_copy_symmetry                        13834       13834      0.07s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_born_charges         13644                         |
|  /                                                                          |
| O-> secondd_apply_symmetry_to_born            13644       13644      0.06s  |
+-----------------------------------------------------------------------------+
...
| O-> comms_local_map                               2           2      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions                16625                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions               16625       16625      0.05s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_prepare_and_diagonalise           2272                         |
| |/                                                                          |
| O-> phonon_mass_weight_dmat                    6816        6816      0.03s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_deallocate                            6939        6939      0.03s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            6917                         |
|  /                                                                          |
| O-> secondd_find_inversion                     6917        6917      0.03s  |
