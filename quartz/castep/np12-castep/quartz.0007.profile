...
|   o-> phonon_real_to_fine                      2274        2274     67.65s  |
|   o-> phonon_enforce_dmat_sumrule              2273        2273      2.24s  |
|   o-> phonon_prepare_and_diagonalise           2273        2273      0.71s  |
|   o-> phonon_accumulate_adp                    2273        2273      0.04s  |
|   o-> comms_send_complex                       2273        2273      3.01s  |
...
|   o-> ewald_calc_E2_dipole_dipole              2274        2274     65.45s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                       17                         |
|  /o-- phonon_real_to_fine                      2274                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                2291        2291     65.51s  |
|    /                                                                        |
...
|   o-> phonon_diagonalise_d_cmplx               6819        6819      0.73s  |
|   o-> secondd_find_acoustics                   2273        2273      0.12s  |
|   o-> secondd_symmetrize_dmat_cmplx            2273        2273      1.14s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              6920        6920      1.86s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             6920        6920      0.02s  |
|   o-> hermitian4                               6920        6920      0.03s  |
|   o-> cell_copy_symmetry                      13840       13840      0.06s  |
|   o-> cell_reduce_symmetry_ops_wrapped         6920        6920      0.22s  |
|   o-> secondd_group_symmetrize_dmat            6920        6920      1.11s  |
|   o-> cell_deallocate                          6920        6920      0.03s  |
|   o-> secondd_find_inversion                   6920        6920      0.03s  |
|   o-> secondd_tr_symmetrize_dmat               2326        2326      0.13s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      25248       25248      0.81s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> ion_initialise                                1           1      0.94s  |
...
|  /o-- phonon_prepare_and_diagonalise           2273                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 9092        9092      0.94s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              2                         |
|  /                                                                          |
| O-> ion_atom_pseudo_scf                           2           2      0.93s  |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        27674       27674      0.91s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             27674       27674      0.41s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion       2326        2326      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              2273                         |
|  /                                                                          |
| O-> secondd_find_acoustics                     2273        2273      0.12s  |
...
| |/                                                                          |
| O-> comms_send_real                            4549        4549      0.08s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                         24359       24359      0.08s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      0.07s  |
...
| |/                                                                          |
| O-> cell_deallocate                            6942        6942      0.03s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            6920                         |
|  /                                                                          |
| O-> secondd_find_inversion                     6920        6920      0.03s  |
...
| O-> model_read_occ_eigenvalues                    1           1      0.02s  |
|    /                                                                        |
|   o-> comms_copy_kp_real                         42          42      0.02s  |
