...
|   o-> comms_recv_complex                      25000       25000      0.32s  |
|   o-> comms_recv_real                         50000       50000      0.29s  |
|   o-> phonon_diag_and_output                  25000       25000     73.24s  |
...
|   o-> phonon_prepare_and_diagonalise          25000       25000      8.60s  |
|   o-> secondd_calc_irreps                     25000       25000      5.29s  |
|   o-> phonon_write                            50000       50000     53.61s  |
...
|   o-> phonon_write_freqs                      50000       50000      9.35s  |
+-----------------------------------------------------------------------------+
...
|   o-> phonon_diagonalise_d_cmplx              25000       25000      3.19s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                  25000                         |
|  /                                                                          |
| O-> secondd_calc_irreps                       25000       25000      5.29s  |
...
| |/                                                                          |
| O-> cell_check_group                         100102      100101      1.91s  |
|    /                                                                        |
...
|  /o-- cell_supercell                              2                         |
| |/                                                                          |
| O-> cell_generate_ionic_constraints               3           2      0.11s  |
|    /                                                                        |
|   o-> algor_uniform_random                     7236        7200      0.03s  |
+-----------------------------------------------------------------------------+
|   o-- cell_set_supercell_symmetry                 2                         |
|  /                                                                          |
| O-> cell_find_related_atoms_supercell             2           2      0.10s  |
...
| |/                                                                          |
| O-> cell_generate_MP_set_wrapped                  4           2      0.08s  |
|    /                                                                        |
|   o-> bib_add                                     4           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                4           2      0.08s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip             1216        1202      0.07s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           25101                         |
|  /                                                                          |
| O-> two_q_is_a_g                              25101       25101      0.08s  |
...
|  /o-- phonon_real_to_fine                         1                         |
| |/                                                                          |
| O-> ewald_calc_E2_dipole_dipole                  18          18      0.07s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip               1223        1209      0.07s  |
|    /                                                                        |
