...
|   o-> model_continuation                          1           1     15.10s  |
...
|   o-> phonon_calculate                            1           1    140.39s  |
...
|   o-> phonon_recip_to_real                        1           1      7.91s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> phonon_print_force_const_matrix             1           1      0.03s  |
|   o-> cell_supercell                              1           1      6.77s  |
|   o-> phonon_real_to_fine                     12501       12501     21.15s  |
|   o-> phonon_enforce_dmat_sumrule             12500       12500     27.57s  |
|   o-> phonon_prepare_and_diagonalise          12500       12500      6.66s  |
|   o-> phonon_accumulate_adp                   12500       12500      0.14s  |
|   o-> phonon_diag_and_output                  25000       25000     69.31s  |
...
| |/                                                                          |
| O-> phonon_diag_and_output                    25035       25035     69.42s  |
|    /                                                                        |
|   o-> q_is_a_g                                50070       50070      0.15s  |
|   o-> phonon_prepare_and_diagonalise          25035       25035     15.50s  |
|   o-> secondd_calc_irreps                     25035       25035      4.05s  |
|   o-> phonon_write                            50035       50035      7.68s  |
|   o-> phonon_print_irreps                     25035       25035     40.94s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx             63265       63265     49.23s  |
|    /                                                                        |
|   o-> two_q_is_a_g                            63265       63265      0.20s  |
|   o-> hermitian4                              63265       63265      0.20s  |
|   o-> cell_copy_symmetry                     126530      126530      0.84s  |
|   o-> cell_reduce_symmetry_ops_wrapped        63265       63265     12.94s  |
|   o-> secondd_group_symmetrize_dmat           63265       63265     15.42s  |
|   o-> cell_deallocate                         63265       63265      0.24s  |
|   o-> secondd_find_inversion                  63265       63265      0.20s  |
|   o-> secondd_tr_symmetrize_dmat              63265       63265     17.10s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                  25035                         |
|  /                                                                          |
| O-> phonon_print_irreps                       25035       25035     40.94s  |
|    /                                                                        |
|   o-> cell_check_group                        25035       25035     22.96s  |
|   o-> cell_factor_group_symmetry_wrapped      25035       25035      0.79s  |
|   o-> cell_symmetry_symbol_wrapped_wrapped  1201680     1201680     11.41s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_check_group                         138372      138372     35.46s  |
|    /                                                                        |
|   o-> algor_invert_real                     1904163     1904163      5.83s  |
+-----------------------------------------------------------------------------+
...
|   o-> phonon_diagonalise_d_cmplx              37500       37500      0.28s  |
|   o-> secondd_find_acoustics                  12500       12500      0.27s  |
|   o-> secondd_symmetrize_dmat_cmplx           12500       12500     25.82s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                  25035                         |
|  /o-- phonon_calculate                        12500                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise            37535       37535     22.15s  |
|    /                                                                        |
|   o-> q_is_a_g                                75070       75070      0.23s  |
|   o-> secondd_symmetrize_dmat_cmplx           37535       37535     17.22s  |
|   o-> phonon_constrain_dmat                   37535       37535      0.12s  |
|   o-> phonon_mass_weight_dmat                 37535       37535      0.12s  |
|   o-> phonon_print_dynamical_matrix           25035       25035      1.67s  |
...
|   o-> secondd_symmetrize_dmat_cmplx           12501       12501      5.82s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           63265                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                63265       63265     17.10s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                63265       63265     15.38s  |
|   o-> secondd_apply_symmetry_to_dmat_ion      63265       63265      1.10s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_check_equiv_ions                 152294      152294     16.02s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions           2488735     2488735      7.60s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           63265                         |
|  /                                                                          |
| O-> secondd_group_symmetrize_dmat             63265       63265     15.42s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion     715242      715242     11.50s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> model_continuation                            1           1     15.10s  |
...
|   o-> wave_initialise_wv                          1           1      0.12s  |
...
|  /o-- cell_reread                                 1                         |
| |/                                                                          |
| O-> cell_read_phonon_fine_data                    2           2     13.86s  |
|    /                                                                        |
|   o-> cell_detect_MP                              2           2     13.36s  |
+-----------------------------------------------------------------------------+
|   o-- cell_read_phonon_fine_data                  2                         |
|  /o-- cell_generate_qpoints_local                 2                         |
|  /o-- cell_restore_global_wrapped                 4                         |
| |/                                                                          |
| O-> cell_detect_MP                                8           8     13.82s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           63265                         |
|  /o-- secondd_calc_irreps                     25035                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped          88300       88300     13.55s  |
|    /                                                                        |
|   o-> cell_check_group                        88300       88300     12.25s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                        1                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> cell_supercell                                2           2     13.53s  |
|    /                                                                        |
|   o-> cell_deallocate                             2           2      0.00s  |
...
|   o-> cell_set_supercell_symmetry                 2           2      7.70s  |
|   o-> cell_copy_kpoints                           2           2      0.00s  |
|   o-> cell_kpoints_spacing_wrapped                2           2      4.49s  |
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       779236      779236     12.61s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            779236      779236      7.56s  |
+-----------------------------------------------------------------------------+
|   o-- cell_output_wrapped                        48                         |
|  /o-- secondd_calc_irreps                     50348                         |
|  /o-- phonon_print_irreps                   1201680                         |
| |/                                                                          |
| O-> cell_symmetry_symbol_wrapped_wrapped    1252076     1252076     11.89s  |
|    /                                                                        |
|   o-> algor_invert_real                     1252076     1252076      3.86s  |
+-----------------------------------------------------------------------------+
|   o-- cell_generate_symmetry_wrapped              1                         |
|  /o-- cell_find_reduced_cell                  70185                         |
|  /o-- cell_sort_kpoints_with_recip           140368                         |
|  /o-- cell_check_group                      1904163                         |
...
| |/                                                                          |
| O-> algor_invert_real                       3367529     3367529     10.34s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> cell_read_wrapped                             1           1      9.46s  |
...
|   o-> phonon_write_freqs                      50035       50035      2.49s  |
|   o-> secondd_find_acoustics                      1           1      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion     779236                         |
|  /o-- secondd_calc_irreps                     25205                         |
| |/                                                                          |
| O-> secondd_compute_atom_phases              804441      804441      7.64s  |
|    /                                                                        |
|   o-> q_is_a_g                               679268      679268      2.09s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions              2488735                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions             2488735     2488735      7.60s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
...
|   o-> ion_atom_generate_psp                       1           1      5.42s  |
...
|   o-> ion_atom_output_psp                         1           1      0.73s  |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  6           6      4.73s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       6           6      0.00s  |
|   o-> cell_sort_kpoints_with_recip            70135       70135      4.44s  |
+-----------------------------------------------------------------------------+
|   o-- cell_kpoints_mp_wrapped                     3                         |
|  /o-- cell_kpoints_spacing_wrapped                2                         |
| |/                                                                          |
| O-> cell_generate_MP_set_wrapped                  5           5      4.71s  |
|    /                                                                        |
|   o-> bib_add                                     5           5      0.00s  |
|   o-> cell_reduce_kpoints_internal                5           5      4.70s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      4.49s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      4.48s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            70135                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70184       70184      4.45s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70184       70184      0.67s  |
|   o-> algor_invert_real                      140368      140368      0.43s  |
...
| O-> secondd_calc_irreps                       25035       25035      4.05s  |
|    /                                                                        |
|   o-> cell_copy_symmetry                      50070       50070      0.33s  |
...
| |/                                                                          |
| O-> q_is_a_g                                 879532      879532      2.70s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_write                            50035                         |
|  /                                                                          |
| O-> phonon_write_freqs                        50035       50035      2.49s  |
...
|  /o-- phonon_print_irreps                     25035                         |
| |/                                                                          |
| O-> cell_factor_group_symmetry_wrapped       138372      138372      1.50s  |
+-----------------------------------------------------------------------------+
|   o-- cell_read_wrapped                           1                         |
|  /o-- cell_supercell                              2                         |
| |/                                                                          |
...
| |/                                                                          |
| O-> cell_copy_symmetry                       176600      176600      1.17s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_pseudo_scf                           1           1      0.98s  |
...
| |/                                                                          |
| O-> cell_find_reduced_cell                    70185       70185      0.67s  |
|    /                                                                        |
|   o-> algor_invert_real                       70185       70185      0.22s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_prepare_and_diagonalise          37535                         |
|  /o-- phonon_enforce_dmat_sumrule             37500                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                75035       75035      0.54s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_deallocate                           88322       88322      0.33s  |
+-----------------------------------------------------------------------------+
|   o-- cell_set_supercell_symmetry                 2                         |
|  /                                                                          |
| O-> cell_reduce_symmetry_supercell                2           2      0.28s  |
...
|  /o-- phonon_enforce_dmat_sumrule             12500                         |
| |/                                                                          |
| O-> secondd_find_acoustics                    12501       12501      0.27s  |
+-----------------------------------------------------------------------------+
|   o-- cell_sort_kpoints_with_recip            70184                         |
...
| |/                                                                          |
| O-> phonon_mass_weight_dmat                   62535       62535      0.20s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                        12500                         |
|  /                                                                          |
| O-> phonon_accumulate_adp                     12500       12500      0.14s  |
...
|          o-> wave_Sorthonormalise_wv              1           1      0.10s  |
|    /                                                                        |
...
| O-> wave_Sorthonormalise_wv                       1           1      0.10s  |
|    /                                                                        |
|   o-> wave_Sorthonormalise_wv_ks                 95          95      0.10s  |
+-----------------------------------------------------------------------------+
|   o-- wave_Sorthonormalise_wv                    95                         |
|  /                                                                          |
| O-> wave_Sorthonormalise_wv_ks                   95          95      0.10s  |
|    /                                                                        |
|   o-> wave_calc_Soverlap_wv_ks                   95          95      0.10s  |
...
| O-> wave_calc_Soverlap_wv_ks                     95          95      0.10s  |
|    /                                                                        |
|   o-> coeffs_dot_all_self                        95          95      0.01s  |
|   o-> wave_beta_phi_wv_ks                        95          95      0.08s  |
...
| |/                                                                          |
| O-> comms_recv_real                           25003       25003      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       1                         |
|  /                                                                          |
| O-> ion_atom_descreen_psp                         1           1      0.08s  |
...
|   o-> ion_all_beta_multi_phi_recip               95          95      0.08s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_beta_recip_interpolation             1710        1710      0.03s  |
...
| O-> coeffs_dot_all_self                          95          95      0.01s  |
|    /                                                                        |
|   o-> local_dot_all_self                         95          95      0.01s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_uniform_random_array                 1047        1047      0.00s  |
|    /                                                                        |
|   o-> algor_set_random_seed                       1           1      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip               95                         |
...
| |/                                                                          |
| O-> comms_reduce_array_complex                  285         285      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_core_pseudise                      1                         |
|  /o-- ion_atom_qc_pseudise_fn                     6                         |
| |/                                                                          |
...
COMMS_BND                               0.06s
COMMS_FARM                              0.00s
     317 different subroutines and functions were traced
Hash collisions:          7
