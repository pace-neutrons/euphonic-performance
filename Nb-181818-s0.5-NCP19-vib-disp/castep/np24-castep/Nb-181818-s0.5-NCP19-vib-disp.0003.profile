...
|   o-> phonon_real_to_fine                      1088        1088      2.87s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.95s  |
...
|   o-> ion_atom_generate_psp                       1           1      4.80s  |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      5.98s  |
|    /                                                                        |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.95s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.95s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_construct_psp                      1           1      4.10s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.17s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> algor_invert_real                        267566      267566      1.21s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.18s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145036      145036      0.53s  |
+-----------------------------------------------------------------------------+
