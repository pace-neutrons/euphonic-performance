...
|   o-> phonon_recip_to_real                        1           1      8.80s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      7.58s  |
|   o-> phonon_real_to_fine                      1088        1088      2.50s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      2.75s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.68s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     21.27s  |
|   o-> comms_send_real                          2174        2174     50.02s  |
|   o-> comms_reduce_gv_real                        1           1      0.71s  |
...
|   o-> cell_generate_ionic_constraints             2           2      1.42s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_generate_psp                       1           1      4.79s  |
...
|   o-> algor_invert_real                      140074      140074      0.67s  |
...
|   o-> ion_atom_construct_psp                      1           1      4.09s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.24s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             4026        4026      0.02s  |
|   o-> hermitian4                               4026        4026      0.02s  |
|   o-> cell_copy_symmetry                       8052        8052      0.06s  |
|   o-> cell_reduce_symmetry_ops_wrapped         4026        4026      1.18s  |
|   o-> secondd_group_symmetrize_dmat            4026        4026      1.60s  |
...
|   o-> ion_atom_radial_transform                  36          36      1.07s  |
...
|   o-> secondd_find_acoustics                   1087        1087      0.03s  |
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      2.58s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1088        1088      0.59s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_pseudo_scf                           1           1      1.82s  |
...
|   o-> ion_atom_ps_diag                           59          59      1.70s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60266       60266      1.22s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.42s  |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65021       65021      1.31s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65021       65021      0.80s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       3                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      1.28s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_define_psp                         1                         |
|  /o-- ion_atom_construct_psp                     36                         |
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    38          38      1.26s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        267568      267568      1.22s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.19s  |
...
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           4061        4061      1.18s  |
|    /                                                                        |
|   o-> cell_check_group                         4061        4061      1.12s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         4061                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           4096        4096      1.12s  |
|    /                                                                        |
|   o-> algor_invert_real                       56560       56560      0.21s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           134061      134061      0.79s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1122        1122      0.64s  |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.71s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.71s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
...
|   o-> algor_matmul_cmplx_cmplx                   95          95      0.06s  |
|   o-> comms_reduce_gv_complex                    95          95      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> model_read_occ_eigenvalues                    1           1      0.12s  |
...
|  /o-- wave_calc_Soverlap_wv_ks                   95                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                     190         190      0.05s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                190         190      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_complex                   190                         |
|  /o-- comms_reduce_bnd_complex                   95                         |
| |/                                                                          |
| O-> comms_reduce_array_complex                  285         285      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip               95                         |
|  /                                                                          |
| O-> ion_beta_recip_set                           95          95      0.05s  |
...
|   o-> comms_map_transpose                         2           2      0.03s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 4383        4383      0.04s  |
+-----------------------------------------------------------------------------+
...
| O-> comms_map_transpose                           2           2      0.03s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.03s  |
+-----------------------------------------------------------------------------+
