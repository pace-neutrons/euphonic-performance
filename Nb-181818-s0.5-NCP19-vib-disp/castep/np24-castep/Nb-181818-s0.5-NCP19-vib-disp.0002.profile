...
|   o-> phonon_real_to_fine                      1088        1088      2.64s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      2.74s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.67s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     20.69s  |
|   o-> comms_send_real                          2174        2174     49.64s  |
...
|   o-> ion_initialise                              1           1      6.78s  |
|   o-> basis_initialise                            2           2      0.43s  |
...
|   o-> ion_atom_pseudo_scf                         1           1      1.86s  |
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      5.59s  |
|    /                                                                        |
...
|   o-> ion_atom_construct_psp                      1           1      4.06s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.23s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            4026        4026      1.59s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1088        1088      0.60s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                           59          59      1.73s  |
...
| O-> ion_atom_ps_diag                             59          59      1.73s  |
|    /                                                                        |
|   o-> ion_atom_regin                         128915      128915      0.80s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60272       60272      1.21s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.37s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60272                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65027       65027      1.31s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65027       65027      0.80s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        267574      267574      1.23s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           4061        4061      1.19s  |
|    /                                                                        |
...
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           4096        4096      1.13s  |
|    /                                                                        |
|   o-> algor_invert_real                       56566       56566      0.22s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145044      145044      0.53s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           134061      134061      0.83s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      65027                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               65027       65027      0.80s  |
|    /                                                                        |
|   o-> q_is_a_g                                60303       60303      0.23s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               145044                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              145044      145044      0.53s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_compute_atom_phases             60303                         |
|  /o-- phonon_calculate                           35                         |
| |/                                                                          |
| O-> q_is_a_g                                  62705       62705      0.24s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> wave_initialise_wv                            1           1      0.22s  |
