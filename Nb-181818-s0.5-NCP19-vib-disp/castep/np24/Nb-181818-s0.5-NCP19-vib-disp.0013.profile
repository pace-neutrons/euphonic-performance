...
|   o-> model_continuation                          1           1     15.92s  |
...
|   o-> phonon_calculate_dynamical_dfpt             1           1      7.65s  |
|   o-> phonon_recip_to_real                        1           1      8.57s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      6.70s  |
|   o-> phonon_real_to_fine                      1088        1088      2.83s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      2.67s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.67s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     20.92s  |
|   o-> comms_send_real                          2174        2174     42.77s  |
|   o-> comms_reduce_gv_real                        1           1      1.58s  |
|   o-> comms_reduce_bnd_real                       1           1      0.00s  |
|   o-> comms_reduce_kp_real                        1           1      0.58s  |
...
| |/                                                                          |
| O-> comms_send_real                            2177        2177     42.80s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_initialise                              1           1      6.77s  |
|   o-> basis_initialise                            2           2      0.44s  |
|   o-> model_store_dependencies                    1           1      0.00s  |
|   o-> cell_reread                                 1           1      8.27s  |
...
|   o-> cell_set_supercell_symmetry                 2           2      7.69s  |
|   o-> cell_copy_kpoints                           2           2      0.00s  |
|   o-> cell_kpoints_spacing_wrapped                2           2      4.93s  |
...
| |/                                                                          |
| O-> comms_gcopy_integer                         439         439      9.73s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> cell_read_wrapped                             1           1      9.43s  |
...
|   o-> comms_gcopy_integer                        64          64      8.96s  |
...
|   o-> cell_generate_qpoints_local                 1           1      0.46s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                            1                         |
|  /                                                                          |
| O-> phonon_recip_to_real                          1           1      8.57s  |
|    /                                                                        |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> cell_supercell                              1           1      7.27s  |
|   o-> cell_map_kpoint_subset                      1           1      0.01s  |
|   o-> cell_find_kpoint_transform_kpoints        729         729      0.02s  |
|   o-> secondd_apply_symmetry_to_dmat            729         729      0.03s  |
|   o-> secondd_symmetrize_dmat_cmplx             729         729      0.51s  |
...
|   o-> comms_gcopy_real                           78          78      7.52s  |
|   o-> comms_gcopy_character                       4           4      0.00s  |
...
|   o-> comms_reduce_kp_logical                     2           2      7.61s  |
|   o-> comms_reduce_bnd_logical                    2           2      0.00s  |
|   o-> phonon_diag_and_output                     35          35      0.04s  |
+-----------------------------------------------------------------------------+
...
|  /o-- bib_output                                  1                         |
| |/                                                                          |
| O-> comms_reduce_kp_logical                       6           6      7.61s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> comms_gcopy_real                            526         526      7.54s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> ion_initialise                                1           1      6.77s  |
...
|   o-> ion_atom_allocate_pspot                     2           2      0.07s  |
|   o-> ion_atom_generate_psp                       1           1      4.77s  |
|   o-> ion_set_data                                1           1      0.05s  |
|   o-> ion_atom_deallocate_pspot                   3           3      0.00s  |
|   o-> ion_set_psp                                 1           1      0.03s  |
|   o-> ion_atom_pseudo_scf                         1           1      1.85s  |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      4.96s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      4.65s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      4.93s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      4.93s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      4.93s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_generate_psp                         1           1      4.77s  |
...
|   o-> ion_atom_construct_psp                      1           1      4.07s  |
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      4.65s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70037       70037      0.77s  |
|   o-> algor_invert_real                      140074      140074      0.50s  |
|   o-> algor_sort                              70037       70037      0.27s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_prepare_and_diagonalise           1122                         |
|  /o-- phonon_recip_to_real                      729                         |
|  /o-- phonon_real_to_fine                      1088                         |
|  /o-- phonon_enforce_dmat_sumrule              1087                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.21s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             4026        4026      0.02s  |
|   o-> hermitian4                               4026        4026      0.02s  |
|   o-> cell_copy_symmetry                       8052        8052      0.06s  |
|   o-> cell_reduce_symmetry_ops_wrapped         4026        4026      1.16s  |
|   o-> secondd_group_symmetrize_dmat            4026        4026      1.56s  |
|   o-> cell_deallocate                          4026        4026      0.02s  |
|   o-> secondd_find_inversion                   4026        4026      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               4026        4026      1.21s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1088        1088      0.57s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1087                         |
|  /                                                                          |
| O-> phonon_enforce_dmat_sumrule                1087        1087      2.67s  |
|    /                                                                        |
|   o-> phonon_mass_weight_dmat                  2174        2174      0.01s  |
|   o-> phonon_diagonalise_d_cmplx               3261        3261      0.02s  |
|   o-> secondd_find_acoustics                   1087        1087      0.02s  |
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      2.52s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       3                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      2.16s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_pseudo_scf                           1           1      1.85s  |
...
|   o-> ion_atom_ps_diag                           59          59      1.72s  |
|   o-> ion_atom_set_pseudo_H                      59          59      0.04s  |
...
| O-> ion_atom_ps_diag                             59          59      1.72s  |
|    /                                                                        |
|   o-> ion_atom_regin                         128915      128915      0.78s  |
|   o-> ion_atom_rectoreal                        236         236      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.58s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      1.58s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_group_symmetrize_dmat              4026        4026      1.56s  |
|    /                                                                        |
|   o-> cell_factor_group_symmetry_wrapped       4026        4026      0.05s  |
|   o-> secondd_check_equiv_ions                 4026        4026      0.05s  |
|   o-> secondd_apply_symmetry_to_dmat_ion      60264       60264      1.19s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.34s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60264                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65019       65019      1.29s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65019       65019      0.78s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_define_psp                         1                         |
|  /o-- ion_atom_construct_psp                     36                         |
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    38          38      1.24s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.21s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 4026        4026      1.08s  |
|   o-> secondd_apply_symmetry_to_dmat_ion       4026        4026      0.08s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           4061        4061      1.16s  |
|    /                                                                        |
|   o-> cell_check_group                         4061        4061      1.10s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat            4026                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_calc_irreps                        35                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                   8816        8816      1.13s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145036      145036      0.54s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         4061                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           4096        4096      1.10s  |
|    /                                                                        |
|   o-> algor_invert_real                       56558       56558      0.21s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pn_pseudise                        1                         |
|  /o-- cell_find_reduced_cell                  70038                         |
|  /o-- cell_sort_kpoints_with_recip           140074                         |
|  /o-- cell_check_group                        56558                         |
...
| |/                                                                          |
| O-> algor_invert_real                        267566      267566      0.96s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           134061      134061      0.81s  |
+-----------------------------------------------------------------------------+
|   o-- cell_read_wrapped                           1                         |
|  /o-- nlxc_initialise                             1                         |
| |/                                                                          |
| O-> cell_generate_qpoints_local                   2           2      0.80s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       2           2      0.00s  |
|   o-> cell_detect_MP                              2           2      0.44s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      65019                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               65019       65019      0.78s  |
|    /                                                                        |
|   o-> q_is_a_g                                60279       60279      0.23s  |
+-----------------------------------------------------------------------------+
|   o-- cell_sort_kpoints_with_recip            70037                         |
|  /o-- check_image_list                            1                         |
| |/                                                                          |
| O-> cell_find_reduced_cell                    70038       70038      0.77s  |
|    /                                                                        |
|   o-> algor_invert_real                       70038       70038      0.25s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         1087                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             1122        1122      0.70s  |
|    /                                                                        |
|   o-> q_is_a_g                                 2244        2244      0.01s  |
|   o-> secondd_symmetrize_dmat_cmplx            1122        1122      0.61s  |
|   o-> phonon_constrain_dmat                    1122        1122      0.00s  |
|   o-> phonon_mass_weight_dmat                  1122        1122      0.00s  |
|   o-> phonon_diagonalise_d_cmplx               1122        1122      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_kp_real                          3           3      0.58s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.58s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               145036                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              145036      145036      0.54s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_count_plane_waves                     1           1      0.39s  |
...
|   o-> comms_reduce_kp_integer                     3           3      0.39s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_sort                                70039       70039      0.27s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_prepare_and_diagonalise           2244                         |
|  /o-- secondd_compute_atom_phases             60279                         |
|  /o-- phonon_calculate                           35                         |
| |/                                                                          |
| O-> q_is_a_g                                  62681       62681      0.23s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> wave_initialise_wv                            1           1      0.22s  |
...
| O-> wave_Sorthonormalise_wv                       1           1      0.21s  |
|    /                                                                        |
|   o-> wave_Sorthonormalise_wv_ks                 95          95      0.20s  |
+-----------------------------------------------------------------------------+
|   o-- wave_Sorthonormalise_wv                    95                         |
|  /                                                                          |
| O-> wave_Sorthonormalise_wv_ks                   95          95      0.20s  |
|    /                                                                        |
|   o-> wave_calc_Soverlap_wv_ks                   95          95      0.20s  |
...
|   o-> wave_beta_phi_wv_ks                        95          95      0.18s  |
|   o-> wave_q_dot_all_self_c                      95          95      0.00s  |
|   o-> comms_reduce_gv_complex                    95          95      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- wave_calc_Soverlap_wv_ks                   95                         |
|  /                                                                          |
| O-> wave_beta_phi_wv_ks                          95          95      0.18s  |
|    /                                                                        |
|   o-> ion_set_projectors                         95          95      0.01s  |
|   o-> wave_calc_ps_q_nonzero                     95          95      0.00s  |
|   o-> ion_all_beta_multi_phi_recip               95          95      0.17s  |
+-----------------------------------------------------------------------------+
...
|   o-> algor_matmul_cmplx_cmplx                   95          95      0.00s  |
|   o-> comms_reduce_gv_complex                    95          95      0.11s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> model_read_occ_eigenvalues                    1           1      0.12s  |
...
|  /o-- wave_calc_Soverlap_wv_ks                   95                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                     190         190      0.11s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                190         190      0.11s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_complex                   190                         |
|  /o-- comms_reduce_bnd_complex                   95                         |
| |/                                                                          |
| O-> comms_reduce_array_complex                  285         285      0.11s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       1                         |
|  /                                                                          |
| O-> ion_atom_descreen_psp                         1           1      0.09s  |
...
| O-> ion_atom_allocate_pspot                       2           2      0.07s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            8052                         |
|  /o-- secondd_calc_irreps                        70                         |
| |/                                                                          |
| O-> cell_copy_symmetry                         8122        8122      0.06s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_qc_pseudise                        6           6      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pseudise                           6                         |
|  /                                                                          |
| O-> ion_atom_qc_pseudise                          6           6      0.05s  |
|    /                                                                        |
|   o-> ion_atom_qc_pseudise_fn                     6           6      0.05s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_factor_group_symmetry_wrapped         4061        4061      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- basis_initialise                            1                         |
|  /                                                                          |
| O-> basis_distribute_grids                        1           1      0.04s  |
...
|   o-> comms_gather_gv_integer                    12          12      0.02s  |
...
| O-> model_write                                   1           1      0.04s  |
|    /                                                                        |
|   o-> model_write_all                             1           1      0.02s  |
|   o-> comms_barrier_farm                          1           1      0.00s  |
|   o-> comms_barrier                               1           1      0.02s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pseudo_scf                        59                         |
|  /                                                                          |
| O-> ion_atom_set_pseudo_H                        59          59      0.04s  |
...
|   o-> ion_atom_regin                           2183        2183      0.02s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion        729         729      0.02s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> model_check_dependencies                      1           1      0.03s  |
...
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 4383        4383      0.03s  |
+-----------------------------------------------------------------------------+
...
|   o-> model_write_occ_eigenvalues                 1           1      0.02s  |
...
|  /o-- phonon_calculate                            2                         |
| |/                                                                          |
| O-> cell_deallocate                            4083        4083      0.02s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> phonon_mass_weight_dmat                    3296        3296      0.01s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_initialise                           1                         |
| |/                                                                          |
| O-> comms_gcopy_character                       446         446      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> parameters_restore                            1           1      0.00s  |
...
|  /o-- phonon_real_to_fine                      1088                         |
| |/                                                                          |
| O-> cell_num_supercells                        1097        1097      0.00s  |
+-----------------------------------------------------------------------------+
...
COMMS_BND                               0.06s
COMMS_FARM                              0.00s
     282 different subroutines and functions were traced
Hash collisions:          2
