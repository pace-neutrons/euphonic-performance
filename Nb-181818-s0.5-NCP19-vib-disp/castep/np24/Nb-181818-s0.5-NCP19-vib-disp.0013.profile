...
|   o-> phonon_recip_to_real                        1           1      8.74s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      7.66s  |
|   o-> phonon_real_to_fine                      1088        1088      3.07s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      3.04s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.79s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     20.71s  |
|   o-> comms_send_real                          2174        2174     40.71s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      6.19s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      6.19s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      6.19s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      5.78s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69986                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      5.78s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70035       70035      1.10s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.78s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            4026        4026      1.84s  |
|   o-> cell_deallocate                          4026        4026      0.02s  |
|   o-> secondd_find_inversion                   4026        4026      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               4026        4026      1.37s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1088        1088      0.69s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1087                         |
|  /                                                                          |
| O-> phonon_enforce_dmat_sumrule                1087        1087      3.04s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      2.88s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       1                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      2.05s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60264       60264      1.40s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60264                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65019       65019      1.51s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65019       65019      0.90s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.37s  |
...
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.37s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 4026        4026      1.22s  |
...
| |/                                                                          |
| O-> algor_invert_real                        267560      267560      1.32s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                   8816        8816      1.28s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145036      145036      0.61s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
...
|    /                                                                        |
|   o-> algor_invert_real                       56558       56558      0.25s  |
+-----------------------------------------------------------------------------+
|   o-- cell_sort_kpoints_with_recip            70035                         |
|  /o-- check_image_list                            1                         |
| |/                                                                          |
| O-> cell_find_reduced_cell                    70036       70036      1.10s  |
|    /                                                                        |
...
| O-> secondd_compute_atom_phases               65019       65019      0.90s  |
|    /                                                                        |
|   o-> q_is_a_g                                60279       60279      0.27s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         1087                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             1122        1122      0.83s  |
|    /                                                                        |
|   o-> q_is_a_g                                 2244        2244      0.01s  |
|   o-> secondd_symmetrize_dmat_cmplx            1122        1122      0.73s  |
...
|   o-> comms_copy_bnd_logical                  18050       18050      0.07s  |
