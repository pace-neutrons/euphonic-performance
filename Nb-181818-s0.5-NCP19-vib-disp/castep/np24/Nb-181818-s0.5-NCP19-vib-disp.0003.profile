...
|   o-> phonon_enforce_dmat_sumrule              1087        1087      3.07s  |
...
|   o-> comms_send_real                          2174        2174     41.58s  |
|   o-> comms_reduce_gv_real                        1           1      1.02s  |
...
|   o-> cell_set_supercell_symmetry                 2           2      7.86s  |
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      5.82s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_reduce_symmetry_ops_wrapped         4026        4026      1.27s  |
|   o-> secondd_group_symmetrize_dmat            4026        4026      1.85s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60264       60264      1.41s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60264                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65019       65019      1.52s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65019       65019      0.91s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.38s  |
...
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           4096        4096      1.21s  |
|    /                                                                        |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.02s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      1.02s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       1                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      1.02s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1122        1122      0.72s  |
