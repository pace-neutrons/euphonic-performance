...
|   o-> phonon_recip_to_real                        1           1      8.78s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      7.61s  |
|   o-> phonon_real_to_fine                      1088        1088      2.52s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      2.52s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.62s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     29.29s  |
|   o-> comms_send_real                          2174        2174     42.96s  |
|   o-> comms_reduce_gv_real                        1           1      0.58s  |
...
|   o-> cell_set_supercell_symmetry                 2           2      7.78s  |
|   o-> cell_copy_kpoints                           2           2      0.00s  |
|   o-> cell_kpoints_spacing_wrapped                2           2      6.03s  |
|   o-> cell_generate_ionic_constraints             2           2      1.37s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_gcopy_integer                         439         439      9.74s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> cell_read_wrapped                             1           1      9.43s  |
...
|   o-> comms_gcopy_integer                        64          64      8.97s  |
...
|   o-> secondd_symmetrize_dmat_cmplx             729         729      0.43s  |
...
|   o-> cell_find_related_atoms_supercell           2           2      5.05s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      6.06s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      5.67s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      6.03s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      6.03s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      6.03s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69988                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      5.67s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70037       70037      1.06s  |
|   o-> algor_invert_real                      140074      140074      0.69s  |
|   o-> algor_sort                              70037       70037      0.36s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      3.92s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             4026        4026      0.01s  |
|   o-> hermitian4                               4026        4026      0.01s  |
|   o-> cell_copy_symmetry                       8052        8052      0.06s  |
|   o-> cell_reduce_symmetry_ops_wrapped         4026        4026      1.14s  |
|   o-> secondd_group_symmetrize_dmat            4026        4026      1.42s  |
|   o-> cell_deallocate                          4026        4026      0.02s  |
|   o-> secondd_find_inversion                   4026        4026      0.01s  |
|   o-> secondd_tr_symmetrize_dmat               4026        4026      1.11s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1087                         |
|  /                                                                          |
| O-> phonon_enforce_dmat_sumrule                1087        1087      2.52s  |
...
|   o-> phonon_diagonalise_d_cmplx               3261        3261      0.03s  |
|   o-> secondd_find_acoustics                   1087        1087      0.02s  |
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      2.36s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1088        1088      0.55s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_pseudo_scf                           1           1      1.84s  |
...
|   o-> ion_atom_ps_diag                           59          59      1.71s  |
...
| O-> ion_atom_ps_diag                             59          59      1.71s  |
|    /                                                                        |
|   o-> ion_atom_regin                         128915      128915      0.81s  |
...
| O-> secondd_group_symmetrize_dmat              4026        4026      1.42s  |
|    /                                                                        |
|   o-> cell_factor_group_symmetry_wrapped       4026        4026      0.04s  |
|   o-> secondd_check_equiv_ions                 4026        4026      0.04s  |
|   o-> secondd_apply_symmetry_to_dmat_ion      60270       60270      1.07s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.37s  |
...
| |/                                                                          |
| O-> algor_invert_real                        267572      267572      1.24s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60270                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65025       65025      1.16s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65025       65025      0.71s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           4061        4061      1.14s  |
|    /                                                                        |
|   o-> cell_check_group                         4061        4061      1.08s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.11s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 4026        4026      0.99s  |
|   o-> secondd_apply_symmetry_to_dmat_ion       4026        4026      0.08s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         4061                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           4096        4096      1.08s  |
|    /                                                                        |
|   o-> algor_invert_real                       56564       56564      0.19s  |
+-----------------------------------------------------------------------------+
|   o-- cell_sort_kpoints_with_recip            70037                         |
|  /o-- check_image_list                            1                         |
| |/                                                                          |
| O-> cell_find_reduced_cell                    70038       70038      1.06s  |
|    /                                                                        |
|   o-> algor_invert_real                       70038       70038      0.35s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                   8816        8816      1.04s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145042      145042      0.49s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           134061      134061      0.84s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_gcopy_integer                         4           4      0.01s  |
|   o-> comms_gcopy_logical                         2           2      0.00s  |
|   o-> cell_unfold_kpoints_arg_trace               1           1      0.03s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      65025                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               65025       65025      0.71s  |
|    /                                                                        |
|   o-> q_is_a_g                                60297       60297      0.20s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         1087                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             1122        1122      0.66s  |
|    /                                                                        |
|   o-> q_is_a_g                                 2244        2244      0.01s  |
|   o-> secondd_symmetrize_dmat_cmplx            1122        1122      0.58s  |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.58s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.58s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               145042                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              145042      145042      0.49s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_distribute_grids                      1           1      0.43s  |
...
|   o-> comms_map_transpose                         2           2      0.41s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.41s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.41s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.41s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.41s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_sort                                70039       70039      0.36s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_radial_transform                   1           1      0.20s  |
...
|  /o-- secondd_compute_atom_phases             60297                         |
|  /o-- phonon_calculate                           35                         |
| |/                                                                          |
| O-> q_is_a_g                                  62699       62699      0.21s  |
+-----------------------------------------------------------------------------+
...
|   o-> wave_orthonormalise_over_wv_ks             95          95      0.00s  |
+-----------------------------------------------------------------------------+
...
|   o-> wave_beta_phi_wv_ks                        95          95      0.19s  |
...
| O-> ion_all_beta_multi_phi_recip                 95          95      0.17s  |
|    /                                                                        |
|   o-> ion_beta_recip_set                         95          95      0.06s  |
|   o-> algor_matmul_cmplx_cmplx                   95          95      0.02s  |
|   o-> comms_reduce_gv_complex                    95          95      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> model_read_occ_eigenvalues                    1           1      0.12s  |
...
|  /o-- wave_calc_Soverlap_wv_ks                   95                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                     190         190      0.10s  |
|    /                                                                        |
|   o-> comms_reduce_array_complex                190         190      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_complex                   190                         |
|  /o-- comms_reduce_bnd_complex                   95                         |
| |/                                                                          |
| O-> comms_reduce_array_complex                  285         285      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       1                         |
|  /                                                                          |
| O-> ion_atom_descreen_psp                         1           1      0.09s  |
...
|   o-> comms_reduce_kp_logical                     2           2      0.00s  |
|   o-> comms_reduce_bnd_logical                    2           2      0.00s  |
|   o-> phonon_diag_and_output                     35          35      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_set_data                                  1           1      0.06s  |
...
|   o-> density_allocate                            1           1      0.00s  |
|   o-> density_copy                                1           1      0.00s  |
|   o-> density_write_parallel                      1           1      0.02s  |
|   o-> density_deallocate                          1           1      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- density_write                               1                         |
|  /                                                                          |
...
|   o-> comms_gather_gv_real                        1           1      0.02s  |
+-----------------------------------------------------------------------------+
...
|  /o-- bib_output                                  1                         |
| |/                                                                          |
| O-> comms_reduce_gv_logical                     192         192      0.02s  |
|    /                                                                        |
