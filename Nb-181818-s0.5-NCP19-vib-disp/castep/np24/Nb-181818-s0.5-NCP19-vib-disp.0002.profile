...
|   o-> phonon_real_to_fine                      1088        1088      3.09s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      2.96s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.79s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     21.09s  |
|   o-> comms_send_real                          2174        2174     40.41s  |
|   o-> comms_reduce_gv_real                        1           1      2.04s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      6.13s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      6.13s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      6.13s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      5.73s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69986                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      5.73s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70035       70035      1.09s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.68s  |
|    /                                                                        |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      2.04s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      2.04s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60272       60272      1.35s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60272                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65027       65027      1.46s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65027       65027      0.87s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.38s  |
...
| |/                                                                          |
| O-> algor_invert_real                        267568      267568      1.29s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145044      145044      0.61s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
...
|    /                                                                        |
|   o-> algor_invert_real                       56566       56566      0.24s  |
+-----------------------------------------------------------------------------+
|   o-- cell_sort_kpoints_with_recip            70035                         |
|  /o-- check_image_list                            1                         |
| |/                                                                          |
| O-> cell_find_reduced_cell                    70036       70036      1.09s  |
|    /                                                                        |
...
|   o-> cell_restore_wrapped                        2           2      0.08s  |
...
|   o-> cell_analyse_symmetry_wrapped               2           2      0.03s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                            1                         |
|  /                                                                          |
| O-> phonon_calculate_dynamical_dfpt               1           1      0.07s  |
