...
|   o-> cell_supercell                              1           1      7.64s  |
|   o-> phonon_real_to_fine                      1088        1088      3.13s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      2.98s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.79s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     21.65s  |
|   o-> comms_send_real                          2174        2174     38.91s  |
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      5.71s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70035       70035      1.08s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.71s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            4026        4026      1.80s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      2.83s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       1                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      2.95s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60266       60266      1.37s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_find_reduced_cell                    70036       70036      1.08s  |
|    /                                                                        |
