...
|   o-> cell_supercell                              1           1      7.58s  |
|   o-> phonon_real_to_fine                      1088        1088      2.41s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      2.50s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.62s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     21.38s  |
|   o-> comms_send_real                          2174        2174     50.13s  |
|   o-> comms_reduce_gv_real                        1           1      0.96s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.94s  |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      5.97s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      5.57s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      5.94s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.94s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.94s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      3.90s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             4026        4026      0.01s  |
|   o-> hermitian4                               4026        4026      0.01s  |
|   o-> cell_copy_symmetry                       8052        8052      0.05s  |
|   o-> cell_reduce_symmetry_ops_wrapped         4026        4026      1.12s  |
|   o-> secondd_group_symmetrize_dmat            4026        4026      1.41s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60266       60266      1.07s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.37s  |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65021       65021      1.16s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65021       65021      0.70s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
...
|    /                                                                        |
|   o-> cell_check_group                         4061        4061      1.06s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.11s  |
...
|    /                                                                        |
|   o-> algor_invert_real                       56560       56560      0.19s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145038      145038      0.49s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> algor_invert_real                       70038       70038      0.34s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.96s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.96s  |
+-----------------------------------------------------------------------------+
...
| O-> wave_Sorthonormalise_wv_ks                   95          95      0.20s  |
|    /                                                                        |
|   o-> wave_calc_Soverlap_wv_ks                   95          95      0.19s  |
...
|  /o-- wave_calc_Soverlap_wv_ks                   95                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                     190         190      0.12s  |
|    /                                                                        |
