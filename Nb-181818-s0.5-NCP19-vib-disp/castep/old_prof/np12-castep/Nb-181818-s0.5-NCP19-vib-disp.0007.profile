...
|   o-> cell_supercell                              1           1      6.96s  |
|   o-> phonon_real_to_fine                      2274        2274      4.47s  |
|   o-> phonon_enforce_dmat_sumrule              2273        2273      5.37s  |
|   o-> phonon_prepare_and_diagonalise           2273        2273      1.35s  |
|   o-> phonon_accumulate_adp                    2273        2273      0.03s  |
|   o-> comms_send_complex                       2273        2273     19.48s  |
|   o-> comms_send_real                          4546        4546     38.53s  |
...
| |/                                                                          |
| O-> comms_send_real                            4549        4549     38.77s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_initialise                              1           1      5.98s  |
|   o-> basis_initialise                            2           2      0.20s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      4.88s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              7584        7584      7.83s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             7584        7584      0.03s  |
|   o-> hermitian4                               7584        7584      0.03s  |
|   o-> cell_copy_symmetry                      15168       15168      0.10s  |
|   o-> cell_reduce_symmetry_ops_wrapped         7584        7584      2.34s  |
|   o-> secondd_group_symmetrize_dmat            7584        7584      2.97s  |
|   o-> cell_deallocate                          7584        7584      0.03s  |
|   o-> secondd_find_inversion                   7584        7584      0.03s  |
|   o-> secondd_tr_symmetrize_dmat               7584        7584      2.03s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_set_supercell_symmetry                   2           2      7.68s  |
...
|   o-> ion_atom_pseudo_scf                         1           1      1.18s  |
...
|   o-> phonon_diagonalise_d_cmplx               6819        6819      0.05s  |
|   o-> secondd_find_acoustics                   2273        2273      0.05s  |
|   o-> secondd_symmetrize_dmat_cmplx            2273        2273      5.05s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      4.90s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      4.60s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      4.88s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      4.88s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      4.88s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_generate_psp                         1           1      4.70s  |
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      4.60s  |
|    /                                                                        |
...
|   o-> secondd_symmetrize_dmat_cmplx            2274        2274      1.17s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion     123132      123132      2.28s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          123132                         |
|  /o-- secondd_tr_symmetrize_dmat               7584                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       131445      131445      2.43s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            131445      131445      1.48s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7584                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           7619        7619      2.34s  |
|    /                                                                        |
|   o-> cell_check_group                         7619        7619      2.22s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         7619                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           7654        7654      2.23s  |
|    /                                                                        |
|   o-> algor_invert_real                      115868      115868      0.40s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7584                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 7584        7584      2.03s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 7584        7584      1.80s  |
|   o-> secondd_apply_symmetry_to_dmat_ion       7584        7584      0.15s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  15932       15932      1.88s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            261274      261274      0.90s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion     131445                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases              131445      131445      1.48s  |
|    /                                                                        |
|   o-> q_is_a_g                               121981      121981      0.42s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         2273                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             2308        2308      1.38s  |
|    /                                                                        |
|   o-> q_is_a_g                                 4616        4616      0.02s  |
|   o-> secondd_symmetrize_dmat_cmplx            2308        2308      1.21s  |
|   o-> phonon_constrain_dmat                    2308        2308      0.01s  |
|   o-> phonon_mass_weight_dmat                  2308        2308      0.01s  |
|   o-> phonon_diagonalise_d_cmplx               2308        2308      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.34s  |
...
|   o-> ion_atom_ps_diag                           59          59      1.07s  |
...
| |/                                                                          |
| O-> algor_invert_real                        326876      326876      1.15s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               261274                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              261274      261274      0.90s  |
+-----------------------------------------------------------------------------+
...
|   o-> model_write_occ_eigenvalues                 1           1      0.23s  |
...
|   o-> comms_gather_gv_integer                    12          12      0.07s  |
...
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 9127        9127      0.06s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_deallocate                            7641        7641      0.03s  |
+-----------------------------------------------------------------------------+
