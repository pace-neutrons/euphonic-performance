...
|   o-> phonon_real_to_fine                      2274        2274      4.34s  |
|   o-> phonon_enforce_dmat_sumrule              2273        2273      5.36s  |
|   o-> phonon_prepare_and_diagonalise           2273        2273      1.35s  |
|   o-> phonon_accumulate_adp                    2273        2273      0.03s  |
|   o-> comms_send_complex                       2273        2273     19.13s  |
|   o-> comms_send_real                          4546        4546     38.67s  |
|   o-> comms_reduce_gv_real                        1           1      0.82s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              7584        7584      7.81s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            7584        7584      2.96s  |
...
|   o-> ion_atom_pseudo_scf                         1           1      1.26s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            2273        2273      5.04s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            2274        2274      1.16s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion     123128      123128      2.27s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          123128                         |
|  /o-- secondd_tr_symmetrize_dmat               7584                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       131441      131441      2.43s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            131441      131441      1.47s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7584                         |
...
|    /                                                                        |
|   o-> algor_invert_real                      115864      115864      0.40s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7584                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 7584        7584      2.03s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            261270      261270      0.90s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion     131441                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases              131441      131441      1.47s  |
|    /                                                                        |
|   o-> q_is_a_g                               121969      121969      0.42s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            2308        2308      1.20s  |
...
|   o-> ion_atom_ps_diag                           59          59      1.15s  |
...
| O-> ion_atom_ps_diag                             59          59      1.15s  |
|    /                                                                        |
|   o-> ion_atom_regin                         128915      128915      0.52s  |
...
| |/                                                                          |
| O-> algor_invert_real                        326872      326872      1.14s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.82s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.82s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           134061      134061      0.54s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> q_is_a_g                                 126743      126743      0.44s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       1                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               1           1      0.37s  |
