...
|   o-> cell_supercell                              1           1      6.98s  |
|   o-> phonon_real_to_fine                      2274        2274      4.95s  |
...
|   o-> comms_send_complex                       2273        2273     19.34s  |
|   o-> comms_send_real                          4546        4546     38.17s  |
|   o-> comms_reduce_gv_real                        1           1      0.40s  |
...
|   o-> cell_set_supercell_symmetry                 2           2      7.71s  |
|   o-> cell_copy_kpoints                           2           2      0.00s  |
|   o-> cell_kpoints_spacing_wrapped                2           2      4.89s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              7584        7584      7.86s  |
|    /                                                                        |
...
|   o-> ion_atom_pseudo_scf                         1           1      1.19s  |
...
|   o-> cell_sort_kpoints_with_recip            69988       69988      4.61s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      4.89s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      4.89s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      4.89s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_generate_psp                         1           1      4.67s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion     123128      123128      2.28s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          123128                         |
|  /o-- secondd_tr_symmetrize_dmat               7584                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       131441      131441      2.44s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            131441      131441      1.48s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7584                         |
...
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           7654        7654      2.25s  |
|    /                                                                        |
...
| O-> secondd_compute_atom_phases              131441      131441      1.48s  |
|    /                                                                        |
|   o-> q_is_a_g                               121969      121969      0.43s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        326872      326872      1.16s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.40s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.40s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       3                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.40s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       1                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               1           1      0.37s  |
...
|   o-> basis_distribute_grids                      1           1      0.21s  |
