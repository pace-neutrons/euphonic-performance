...
|   o-> phonon_recip_to_real                        1           1      7.92s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      6.93s  |
|   o-> phonon_real_to_fine                      2273        2273      4.84s  |
|   o-> phonon_enforce_dmat_sumrule              2272        2272      5.23s  |
|   o-> phonon_prepare_and_diagonalise           2272        2272      1.30s  |
|   o-> phonon_accumulate_adp                    2272        2272      0.02s  |
|   o-> comms_send_complex                       2272        2272     19.79s  |
|   o-> comms_send_real                          4544        4544     38.64s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              7581        7581      7.67s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            7581        7581      2.87s  |
|   o-> cell_deallocate                          7581        7581      0.03s  |
|   o-> secondd_find_inversion                   7581        7581      0.03s  |
|   o-> secondd_tr_symmetrize_dmat               7581        7581      1.99s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         2272                         |
|  /                                                                          |
| O-> phonon_enforce_dmat_sumrule                2272        2272      5.23s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            2272        2272      4.94s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      4.55s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      4.55s  |
|    /                                                                        |
...
|   o-> secondd_apply_symmetry_to_dmat_ion     123079      123079      2.18s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7581                         |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       131389      131389      2.34s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            131389      131389      1.40s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> algor_invert_real                      115818      115818      0.39s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7581                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 7581        7581      1.99s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 7581        7581      1.77s  |
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  15926       15926      1.85s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            261176      261176      0.88s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion     131389                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases              131389      131389      1.40s  |
|    /                                                                        |
|   o-> q_is_a_g                               121929      121929      0.41s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            2307        2307      1.17s  |
...
| |/                                                                          |
| O-> algor_invert_real                        326820      326820      1.14s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      0.48s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> q_is_a_g                                 126701      126701      0.43s  |
+-----------------------------------------------------------------------------+
|   o-- cell_set_supercell_symmetry                 2                         |
|  /                                                                          |
| O-> cell_reduce_symmetry_supercell                2           2      0.28s  |
...
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 9123        9123      0.07s  |
+-----------------------------------------------------------------------------+
