...
|   o-> phonon_recip_to_real                        1           1      7.90s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      6.92s  |
|   o-> phonon_real_to_fine                      2274        2274      4.83s  |
|   o-> phonon_enforce_dmat_sumrule              2273        2273      5.23s  |
|   o-> phonon_prepare_and_diagonalise           2273        2273      1.30s  |
|   o-> phonon_accumulate_adp                    2273        2273      0.02s  |
|   o-> comms_send_complex                       2273        2273     19.60s  |
|   o-> comms_send_real                          4546        4546     38.90s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      4.82s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              7584        7584      7.67s  |
|    /                                                                        |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      4.82s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      4.82s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      4.52s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            2308        2308      1.16s  |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      0.44s  |
+-----------------------------------------------------------------------------+
