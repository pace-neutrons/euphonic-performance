...
|   o-> phonon_enforce_dmat_sumrule              1087        1087      2.97s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.79s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     21.50s  |
|   o-> comms_send_real                          2174        2174     39.05s  |
|   o-> comms_reduce_gv_real                        1           1      1.99s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      6.12s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      6.12s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      6.12s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      5.72s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69986                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      5.72s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70035       70035      1.07s  |
|   o-> algor_invert_real                      140070      140070      0.70s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.70s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            4026        4026      1.79s  |
|   o-> cell_deallocate                          4026        4026      0.02s  |
|   o-> secondd_find_inversion                   4026        4026      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               4026        4026      1.36s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      2.81s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.99s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      1.99s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60270       60270      1.36s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60270                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65025       65025      1.46s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65025       65025      0.87s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.39s  |
...
| |/                                                                          |
| O-> algor_invert_real                        267566      267566      1.29s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           4061        4061      1.24s  |
|    /                                                                        |
|   o-> cell_check_group                         4061        4061      1.17s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> algor_invert_real                       56564       56564      0.24s  |
+-----------------------------------------------------------------------------+
