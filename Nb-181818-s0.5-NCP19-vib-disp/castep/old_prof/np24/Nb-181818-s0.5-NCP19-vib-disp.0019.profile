...
|   o-> phonon_real_to_fine                      1088        1088      3.08s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      3.03s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.79s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     21.55s  |
|   o-> comms_send_real                          2174        2174     38.97s  |
|   o-> comms_reduce_gv_real                        1           1      1.95s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      6.21s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      6.21s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      6.21s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      5.80s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69986                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      5.80s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.77s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             4026        4026      0.02s  |
|   o-> hermitian4                               4026        4026      0.02s  |
|   o-> cell_copy_symmetry                       8052        8052      0.06s  |
|   o-> cell_reduce_symmetry_ops_wrapped         4026        4026      1.25s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      2.87s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       1                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      2.93s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.95s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      1.95s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60270       60270      1.40s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60270                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65025       65025      1.50s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65025       65025      0.90s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.37s  |
...
| |/                                                                          |
| O-> algor_invert_real                        267566      267566      1.32s  |
+-----------------------------------------------------------------------------+
...
|   o-> model_read_occ_eigenvalues                  1           1      0.15s  |
...
| O-> model_read_occ_eigenvalues                    1           1      0.15s  |
|    /                                                                        |
|   o-> comms_copy_gv_real                          2           2      0.15s  |
+-----------------------------------------------------------------------------+
