...
|   o-> cell_supercell                              1           1      7.70s  |
|   o-> phonon_real_to_fine                      1088        1088      3.10s  |
...
|   o-> comms_send_real                          2174        2174     40.60s  |
|   o-> comms_reduce_gv_real                        1           1      1.07s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      6.23s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      6.23s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      6.23s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      5.81s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.81s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      2.04s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60266       60266      1.42s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60266                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65021       65021      1.52s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65021       65021      0.91s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.38s  |
...
| |/                                                                          |
| O-> algor_invert_real                        267562      267562      1.33s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145038      145038      0.62s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
...
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           4096        4096      1.20s  |
|    /                                                                        |
|   o-> algor_invert_real                       56560       56560      0.25s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.07s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      1.07s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
...
|   o-> cell_restore_global_wrapped                 2           2      0.05s  |
