...
|   o-> comms_send_complex                       1087        1087     20.00s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      6.29s  |
...
|   o-> secondd_symmetrize_dmat_cmplx             729         729      0.48s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      6.29s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      6.29s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      5.87s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69986                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      5.88s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70035       70035      1.12s  |
|   o-> algor_invert_real                      140070      140070      0.73s  |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65023       65023      1.53s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> algor_invert_real                        267564      267564      1.36s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145040      145040      0.61s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           4061        4061      1.27s  |
|    /                                                                        |
|   o-> cell_check_group                         4061        4061      1.20s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> algor_invert_real                       56562       56562      0.26s  |
+-----------------------------------------------------------------------------+
|   o-- cell_sort_kpoints_with_recip            70035                         |
|  /o-- check_image_list                            1                         |
| |/                                                                          |
| O-> cell_find_reduced_cell                    70036       70036      1.12s  |
|    /                                                                        |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.03s  |
|    /                                                                        |
