...
|   o-> phonon_real_to_fine                      1088        1088      3.05s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      3.02s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.79s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     19.90s  |
|   o-> comms_send_real                          2174        2174     40.68s  |
|   o-> comms_reduce_gv_real                        1           1      2.94s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.75s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            4026        4026      1.82s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      2.86s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      2.94s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      2.94s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60270       60270      1.39s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60270                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65025       65025      1.49s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65025       65025      0.89s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.37s  |
...
| |/                                                                          |
| O-> algor_invert_real                        267566      267566      1.30s  |
+-----------------------------------------------------------------------------+
