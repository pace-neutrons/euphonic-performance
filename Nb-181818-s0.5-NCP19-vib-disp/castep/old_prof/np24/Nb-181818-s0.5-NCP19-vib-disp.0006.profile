...
|   o-> comms_send_complex                       1087        1087     19.94s  |
|   o-> comms_send_real                          2174        2174     40.68s  |
|   o-> comms_reduce_gv_real                        1           1      2.95s  |
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      5.70s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      2.95s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      2.95s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        267566      267566      1.28s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                         1087                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             1122        1122      0.86s  |
|    /                                                                        |
|   o-> q_is_a_g                                 2244        2244      0.01s  |
|   o-> secondd_symmetrize_dmat_cmplx            1122        1122      0.75s  |
