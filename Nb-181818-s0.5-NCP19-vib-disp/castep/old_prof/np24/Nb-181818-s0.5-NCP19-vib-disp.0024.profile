...
|   o-> phonon_real_to_fine                      1087        1087      3.09s  |
|   o-> phonon_enforce_dmat_sumrule              1086        1086      2.97s  |
|   o-> phonon_prepare_and_diagonalise           1086        1086      0.79s  |
|   o-> phonon_accumulate_adp                    1086        1086      0.01s  |
|   o-> comms_send_complex                       1086        1086     20.69s  |
|   o-> comms_send_real                          2172        2172     39.84s  |
|   o-> comms_reduce_gv_real                        1           1      1.97s  |
...
|   o-> cell_set_supercell_symmetry                 2           2      7.85s  |
|   o-> cell_copy_kpoints                           2           2      0.00s  |
|   o-> cell_kpoints_spacing_wrapped                2           2      6.16s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      6.16s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      6.16s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      5.74s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69986                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      5.75s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4023        4023      4.70s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             4023        4023      0.02s  |
|   o-> hermitian4                               4023        4023      0.02s  |
|   o-> cell_copy_symmetry                       8046        8046      0.06s  |
|   o-> cell_reduce_symmetry_ops_wrapped         4023        4023      1.24s  |
|   o-> secondd_group_symmetrize_dmat            4023        4023      1.79s  |
|   o-> cell_deallocate                          4023        4023      0.02s  |
|   o-> secondd_find_inversion                   4023        4023      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               4023        4023      1.35s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      0.68s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1086                         |
|  /                                                                          |
| O-> phonon_enforce_dmat_sumrule                1086        1086      2.97s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1086        1086      2.82s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       1                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      2.94s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.97s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      1.97s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60217       60217      1.36s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60217                         |
|  /o-- secondd_tr_symmetrize_dmat               4023                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        64969       64969      1.47s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             64969       64969      0.88s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.38s  |
...
| O-> secondd_tr_symmetrize_dmat                 4023        4023      1.35s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 4023        4023      1.21s  |
|   o-> secondd_apply_symmetry_to_dmat_ion       4023        4023      0.09s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        267516      267516      1.30s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                   8810        8810      1.27s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            144944      144944      0.61s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4023                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           4058        4058      1.24s  |
|    /                                                                        |
|   o-> cell_check_group                         4058        4058      1.17s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         4058                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           4093        4093      1.17s  |
|    /                                                                        |
|   o-> algor_invert_real                       56514       56514      0.24s  |
+-----------------------------------------------------------------------------+
...
| O-> secondd_compute_atom_phases               64969       64969      0.88s  |
|    /                                                                        |
|   o-> q_is_a_g                                60245       60245      0.27s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         1086                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             1121        1121      0.84s  |
|    /                                                                        |
|   o-> q_is_a_g                                 2242        2242      0.01s  |
|   o-> secondd_symmetrize_dmat_cmplx            1121        1121      0.73s  |
|   o-> phonon_constrain_dmat                    1121        1121      0.00s  |
|   o-> phonon_mass_weight_dmat                  1121        1121      0.00s  |
|   o-> phonon_diagonalise_d_cmplx               1121        1121      0.02s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 4379        4379      0.05s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonons                                     1                         |
| |/                                                                          |
| O-> cell_deallocate                            4082        4081      0.02s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4023                         |
|  /                                                                          |
| O-> secondd_find_inversion                     4023        4023      0.02s  |
