...
|   o-> comms_send_real                          2174        2174     40.74s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      6.20s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      6.20s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      6.20s  |
+-----------------------------------------------------------------------------+
...
|   o-> algor_invert_real                      140070      140070      0.72s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60270       60270      1.37s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60270                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65025       65025      1.47s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65025       65025      0.88s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.38s  |
...
| |/                                                                          |
| O-> algor_invert_real                        267566      267566      1.31s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145042      145042      0.60s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
