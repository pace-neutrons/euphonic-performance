...
|   o-> phonon_real_to_fine                      1088        1088      3.03s  |
...
|   o-> comms_send_complex                       1087        1087     19.99s  |
|   o-> comms_send_real                          2174        2174     42.33s  |
|   o-> comms_reduce_gv_real                        1           1      1.03s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      6.31s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      6.31s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      6.31s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      5.88s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69986                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      5.89s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            4026        4026      1.87s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      2.92s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60274       60274      1.42s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60274                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65029       65029      1.53s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65029       65029      0.92s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.37s  |
...
| |/                                                                          |
| O-> algor_invert_real                        267570      267570      1.35s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145046      145046      0.61s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
...
|    /                                                                        |
|   o-> algor_invert_real                       56568       56568      0.25s  |
+-----------------------------------------------------------------------------+
