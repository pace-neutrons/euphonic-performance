...
|   o-> phonon_real_to_fine                      1668        1668      4.11s  |
|   o-> phonon_enforce_dmat_sumrule              1667        1667      4.07s  |
|   o-> phonon_prepare_and_diagonalise           1667        1667      1.03s  |
|   o-> phonon_accumulate_adp                    1667        1667      0.02s  |
|   o-> comms_send_complex                       1667        1667     20.63s  |
|   o-> comms_send_real                          3334        3334     38.38s  |
|   o-> comms_reduce_gv_real                        1           1      1.27s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.14s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5766        5766      6.11s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             5766        5766      0.02s  |
|   o-> hermitian4                               5766        5766      0.02s  |
|   o-> cell_copy_symmetry                      11532       11532      0.08s  |
|   o-> cell_reduce_symmetry_ops_wrapped         5766        5766      1.78s  |
|   o-> secondd_group_symmetrize_dmat            5766        5766      2.30s  |
|   o-> cell_deallocate                          5766        5766      0.02s  |
|   o-> secondd_find_inversion                   5766        5766      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               5766        5766      1.64s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      5.14s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.14s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.14s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      4.82s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      4.83s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70035       70035      0.84s  |
|   o-> algor_invert_real                      140070      140070      0.55s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1668        1668      0.91s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1667                         |
|  /                                                                          |
| O-> phonon_enforce_dmat_sumrule                1667        1667      4.07s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1667        1667      3.85s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      91010       91010      1.75s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           91010                         |
|  /o-- secondd_tr_symmetrize_dmat               5766                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        97505       97505      1.88s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             97505       97505      1.12s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5766                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           5801        5801      1.78s  |
|    /                                                                        |
|   o-> cell_check_group                         5801        5801      1.69s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         5801                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           5836        5836      1.69s  |
|    /                                                                        |
|   o-> algor_invert_real                       85564       85564      0.32s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5766                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 5766        5766      1.64s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 5766        5766      1.46s  |
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  12296       12296      1.53s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            201882      201882      0.73s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.35s  |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.27s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      1.27s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        296566      296566      1.14s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      97505                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               97505       97505      1.12s  |
|    /                                                                        |
|   o-> q_is_a_g                                90457       90457      0.33s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         1667                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             1702        1702      1.07s  |
|    /                                                                        |
...
|   o-> phonon_diagonalise_d_cmplx               1702        1702      0.02s  |
+-----------------------------------------------------------------------------+
...
|   o-> model_read_occ_eigenvalues                  1           1      0.11s  |
...
| O-> model_read_occ_eigenvalues                    1           1      0.11s  |
|    /                                                                        |
|   o-> comms_copy_gv_real                          2           2      0.11s  |
+-----------------------------------------------------------------------------+
