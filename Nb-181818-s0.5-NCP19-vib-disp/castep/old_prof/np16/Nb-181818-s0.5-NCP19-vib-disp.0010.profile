...
|   o-> phonon_real_to_fine                      1668        1668      4.05s  |
...
|   o-> comms_send_complex                       1667        1667     20.24s  |
|   o-> comms_send_real                          3334        3334     38.89s  |
...
|   o-> secondd_tr_symmetrize_dmat               5766        5766      1.61s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      5.07s  |
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      4.75s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      91004       91004      1.73s  |
+-----------------------------------------------------------------------------+
...
| O-> secondd_tr_symmetrize_dmat                 5766        5766      1.61s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 5766        5766      1.43s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            201876      201876      0.71s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.35s  |
