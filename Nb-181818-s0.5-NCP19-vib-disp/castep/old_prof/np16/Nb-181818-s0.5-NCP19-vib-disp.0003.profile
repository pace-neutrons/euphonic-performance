...
|   o-> phonon_real_to_fine                      1668        1668      3.91s  |
|   o-> phonon_enforce_dmat_sumrule              1667        1667      4.03s  |
|   o-> phonon_prepare_and_diagonalise           1667        1667      1.04s  |
|   o-> phonon_accumulate_adp                    1667        1667      0.02s  |
|   o-> comms_send_complex                       1667        1667     20.54s  |
|   o-> comms_send_real                          3334        3334     38.69s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.16s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5766        5766      6.06s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            5766        5766      2.28s  |
|   o-> cell_deallocate                          5766        5766      0.02s  |
|   o-> secondd_find_inversion                   5766        5766      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               5766        5766      1.63s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      5.16s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.16s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.16s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      4.84s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      4.84s  |
|    /                                                                        |
...
|   o-> secondd_symmetrize_dmat_cmplx            1667        1667      3.81s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1668        1668      0.89s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      91014       91014      1.74s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           91014                         |
|  /o-- secondd_tr_symmetrize_dmat               5766                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        97509       97509      1.86s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             97509       97509      1.12s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5766                         |
...
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           5836        5836      1.68s  |
|    /                                                                        |
|   o-> algor_invert_real                       85568       85568      0.31s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5766                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 5766        5766      1.63s  |
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  12296       12296      1.52s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            201886      201886      0.73s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.35s  |
...
| |/                                                                          |
| O-> algor_invert_real                        296570      296570      1.13s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      97509                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               97509       97509      1.12s  |
|    /                                                                        |
|   o-> q_is_a_g                                90469       90469      0.33s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         1667                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             1702        1702      1.08s  |
|    /                                                                        |
|   o-> q_is_a_g                                 3404        3404      0.01s  |
|   o-> secondd_symmetrize_dmat_cmplx            1702        1702      0.94s  |
