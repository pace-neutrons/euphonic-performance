...
|   o-> phonon_real_to_fine                      1667        1667      4.00s  |
...
|   o-> comms_send_complex                       1666        1666     20.32s  |
|   o-> comms_send_real                          3332        3332     38.85s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.12s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5763        5763      6.04s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            5763        5763      2.28s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.12s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.12s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      4.80s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1666        1666      3.82s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      90953       90953      1.73s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           90953                         |
|  /o-- secondd_tr_symmetrize_dmat               5763                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        97445       97445      1.86s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             97445       97445      1.11s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5763                         |
...
|    /                                                                        |
|   o-> algor_invert_real                       85510       85510      0.31s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5763                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 5763        5763      1.61s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            201780      201780      0.72s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.35s  |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      1.31s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        296512      296512      1.12s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      97445                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               97445       97445      1.11s  |
|    /                                                                        |
|   o-> q_is_a_g                                90393       90393      0.33s  |
+-----------------------------------------------------------------------------+
