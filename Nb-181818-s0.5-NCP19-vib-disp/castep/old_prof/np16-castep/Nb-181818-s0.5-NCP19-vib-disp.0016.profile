...
|   o-> phonon_recip_to_real                        1           1      8.27s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      7.06s  |
|   o-> phonon_real_to_fine                      1667        1667      3.72s  |
|   o-> phonon_enforce_dmat_sumrule              1666        1666      3.93s  |
|   o-> phonon_prepare_and_diagonalise           1666        1666      0.97s  |
|   o-> phonon_accumulate_adp                    1666        1666      0.02s  |
|   o-> comms_send_complex                       1666        1666     19.37s  |
|   o-> comms_send_real                          3332        3332     44.81s  |
|   o-> comms_reduce_gv_real                        1           1      1.01s  |
|   o-> comms_reduce_bnd_real                       1           1      0.00s  |
|   o-> comms_reduce_kp_real                        1           1      0.25s  |
|   o-> cell_deallocate                             2           2      0.00s  |
|   o-> secondd_finalise                            1           1      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         3332                         |
|  /                                                                          |
| O-> comms_send_real                            3332        3332     44.81s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1666                         |
|  /                                                                          |
| O-> comms_send_complex                         1666        1666     19.37s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
...
|   o-> ion_initialise                              1           1      6.17s  |
|   o-> basis_initialise                            2           2      0.30s  |
...
|   o-> wave_initialise_wv                          1           1      0.16s  |
...
|   o-> cell_set_supercell_symmetry                 2           2      7.74s  |
|   o-> cell_copy_kpoints                           2           2      0.00s  |
|   o-> cell_kpoints_spacing_wrapped                2           2      5.06s  |
...
|   o-> cell_find_related_atoms_supercell           2           2      5.03s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
...
|   o-> ion_atom_pseudo_scf                         1           1      1.36s  |
|   o-> ion_clebsch_gordan                          1           1      0.00s  |
|   o-> ion_atom_radial_transform                   1           1      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_prepare_and_diagonalise           1701                         |
|  /o-- phonon_recip_to_real                      729                         |
|  /o-- phonon_real_to_fine                      1667                         |
|  /o-- phonon_enforce_dmat_sumrule              1666                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5763        5763      5.83s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             5763        5763      0.02s  |
|   o-> hermitian4                               5763        5763      0.02s  |
|   o-> cell_copy_symmetry                      11526       11526      0.08s  |
|   o-> cell_reduce_symmetry_ops_wrapped         5763        5763      1.73s  |
|   o-> secondd_group_symmetrize_dmat            5763        5763      2.18s  |
|   o-> cell_deallocate                          5763        5763      0.02s  |
|   o-> secondd_find_inversion                   5763        5763      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               5763        5763      1.56s  |
+-----------------------------------------------------------------------------+
|   o-- cell_unfold_kpoints_arg_trace               1                         |
|  /o-- cell_generate_MP_set_wrapped                2                         |
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      5.09s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      4.77s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      5.06s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.06s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.06s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      4.77s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70037       70037      0.81s  |
|   o-> algor_invert_real                      140074      140074      0.52s  |
|   o-> algor_sort                              70037       70037      0.28s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_generate_psp                         1           1      4.70s  |
...
| O-> phonon_enforce_dmat_sumrule                1666        1666      3.93s  |
|    /                                                                        |
|   o-> phonon_mass_weight_dmat                  3332        3332      0.01s  |
|   o-> phonon_diagonalise_d_cmplx               4998        4998      0.04s  |
|   o-> secondd_find_acoustics                   1666        1666      0.04s  |
|   o-> secondd_symmetrize_dmat_cmplx            1666        1666      3.69s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1667                         |
|  /                                                                          |
| O-> phonon_real_to_fine                        1667        1667      3.72s  |
|    /                                                                        |
|   o-> cell_num_supercells                      1667        1667      0.01s  |
|   o-> check_image_list                         1667        1667      0.01s  |
|   o-> secondd_symmetrize_dmat_cmplx            1667        1667      0.86s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5763                         |
|  /                                                                          |
| O-> secondd_group_symmetrize_dmat              5763        5763      2.18s  |
|    /                                                                        |
|   o-> cell_factor_group_symmetry_wrapped       5763        5763      0.07s  |
|   o-> secondd_check_equiv_ions                 5763        5763      0.06s  |
|   o-> secondd_apply_symmetry_to_dmat_ion      90959       90959      1.67s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           90959                         |
|  /o-- secondd_tr_symmetrize_dmat               5763                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        97451       97451      1.79s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             97451       97451      1.09s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5763                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           5798        5798      1.73s  |
|    /                                                                        |
|   o-> cell_check_group                         5798        5798      1.64s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         5798                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           5833        5833      1.64s  |
|    /                                                                        |
|   o-> algor_invert_real                       85516       85516      0.30s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5763                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 5763        5763      1.56s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 5763        5763      1.39s  |
|   o-> secondd_apply_symmetry_to_dmat_ion       5763        5763      0.11s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat            5763                         |
|  /o-- secondd_tr_symmetrize_dmat               5763                         |
|  /o-- secondd_calc_irreps                        35                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  12290       12290      1.45s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            201786      201786      0.69s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_pseudo_scf                           1           1      1.36s  |
...
|   o-> ion_atom_ps_diag                           59          59      1.24s  |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      1.25s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pseudo_scf                        59                         |
|  /                                                                          |
| O-> ion_atom_ps_diag                             59          59      1.24s  |
|    /                                                                        |
|   o-> ion_atom_regin                         128915      128915      0.57s  |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      97451                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               97451       97451      1.09s  |
|    /                                                                        |
|   o-> q_is_a_g                                90411       90411      0.31s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pn_pseudise                        1                         |
|  /o-- cell_find_reduced_cell                  70038                         |
|  /o-- cell_sort_kpoints_with_recip           140074                         |
|  /o-- cell_check_group                        85516                         |
...
| |/                                                                          |
| O-> algor_invert_real                        296524      296524      1.09s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.01s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      1.01s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         1666                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             1701        1701      1.00s  |
|    /                                                                        |
|   o-> q_is_a_g                                 3402        3402      0.01s  |
|   o-> secondd_symmetrize_dmat_cmplx            1701        1701      0.87s  |
|   o-> phonon_constrain_dmat                    1701        1701      0.01s  |
|   o-> phonon_mass_weight_dmat                  1701        1701      0.01s  |
|   o-> phonon_diagonalise_d_cmplx               1701        1701      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- cell_sort_kpoints_with_recip            70037                         |
|  /o-- check_image_list                            1                         |
| |/                                                                          |
| O-> cell_find_reduced_cell                    70038       70038      0.81s  |
|    /                                                                        |
|   o-> algor_invert_real                       70038       70038      0.26s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               201786                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              201786      201786      0.69s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           134061      134061      0.59s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_prepare_and_diagonalise           3402                         |
|  /o-- secondd_compute_atom_phases             90411                         |
|  /o-- phonon_calculate                           35                         |
| |/                                                                          |
| O-> q_is_a_g                                  93971       93971      0.32s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_distribute_grids                      1           1      0.18s  |
...
|   o-> basis_count_plane_waves                     1           1      0.12s  |
...
| |/                                                                          |
| O-> algor_sort                                70039       70039      0.28s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_kp_real                          3           3      0.25s  |
|    /                                                                        |
...
|   o-> comms_map_transpose                         2           2      0.16s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> wave_initialise_wv                            1           1      0.16s  |
...
|          o-> wave_Sorthonormalise_wv              1           1      0.15s  |
|    /                                                                        |
...
| O-> comms_map_transpose                           2           2      0.16s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.16s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.16s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.16s  |
+-----------------------------------------------------------------------------+
...
| O-> wave_Sorthonormalise_wv                       1           1      0.15s  |
|    /                                                                        |
|   o-> wave_Sorthonormalise_wv_ks                 95          95      0.15s  |
+-----------------------------------------------------------------------------+
|   o-- wave_Sorthonormalise_wv                    95                         |
|  /                                                                          |
| O-> wave_Sorthonormalise_wv_ks                   95          95      0.15s  |
|    /                                                                        |
|   o-> wave_calc_Soverlap_wv_ks                   95          95      0.14s  |
...
|   o-> wave_beta_phi_wv_ks                        95          95      0.13s  |
...
|   o-> ion_all_beta_multi_phi_recip               95          95      0.12s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_reduce_kp_integer                     3           3      0.12s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           11526                         |
|  /o-- secondd_calc_irreps                        70                         |
| |/                                                                          |
| O-> cell_copy_symmetry                        11596       11596      0.08s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat            5763                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_factor_group_symmetry_wrapped         5798        5798      0.07s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              2                         |
|  /                                                                          |
| O-> ion_atom_allocate_pspot                       2           2      0.05s  |
...
+-----------------------------------------------------------------------------+
|   o-- phonon_prepare_and_diagonalise           1701                         |
|  /o-- phonon_enforce_dmat_sumrule              4998                         |
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 6699        6699      0.05s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_deallocate                            5820        5820      0.02s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_recip_to_real                      729                         |
|  /                                                                          |
| O-> secondd_apply_symmetry_to_dmat              729         729      0.02s  |
...
+-----------------------------------------------------------------------------+
|   o-- phonon_prepare_and_diagonalise           1701                         |
|  /o-- phonon_enforce_dmat_sumrule              3332                         |
| |/                                                                          |
| O-> phonon_mass_weight_dmat                    5033        5033      0.02s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_real_to_fine                      1667                         |
| |/                                                                          |
| O-> cell_num_supercells                        1676        1676      0.01s  |
+-----------------------------------------------------------------------------+
