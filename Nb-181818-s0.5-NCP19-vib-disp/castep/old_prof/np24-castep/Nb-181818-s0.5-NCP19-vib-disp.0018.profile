...
|   o-> phonon_recip_to_real                        1           1      8.81s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      7.60s  |
|   o-> phonon_real_to_fine                      1088        1088      2.39s  |
...
|   o-> comms_send_complex                       1087        1087     21.76s  |
|   o-> comms_send_real                          2174        2174     50.62s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.98s  |
...
|   o-> cell_find_related_atoms_supercell           2           2      5.06s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
...
|   o-> ion_atom_pseudo_scf                         1           1      1.80s  |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      6.01s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      5.61s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      5.98s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.98s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.98s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69988                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      5.61s  |
|    /                                                                        |
...
|   o-> ion_atom_ps_diag                           59          59      1.67s  |
...
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65021       65021      0.71s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
...
|  /o-- wave_calc_Soverlap_wv_ks                   95                         |
| |/                                                                          |
| O-> comms_reduce_gv_complex                     190         190      0.09s  |
|    /                                                                        |
...
|  /o-- bib_output                                  1                         |
| |/                                                                          |
| O-> comms_reduce_kp_logical                       6           6      0.01s  |
|    /                                                                        |
|   o-> comms_lcopy                                 1           1      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
