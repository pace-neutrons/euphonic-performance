...
|   o-> comms_send_real                          2174        2174     49.28s  |
...
|   o-> secondd_tr_symmetrize_dmat               4026        4026      1.16s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60264       60264      1.18s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.37s  |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65019       65019      1.27s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65019       65019      0.77s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        267566      267566      1.20s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145036      145036      0.52s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_map_transpose                         2           2      0.39s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.39s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.39s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_gather_gv_integer                      18          18      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip               95                         |
|  /                                                                          |
| O-> ion_beta_recip_set                           95          95      0.06s  |
