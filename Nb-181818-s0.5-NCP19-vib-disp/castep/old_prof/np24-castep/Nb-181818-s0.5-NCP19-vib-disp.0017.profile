...
|   o-> cell_supercell                              1           1      7.50s  |
|   o-> phonon_real_to_fine                      1088        1088      2.90s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      2.66s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.67s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     20.91s  |
|   o-> comms_send_real                          2174        2174     49.40s  |
|   o-> comms_reduce_gv_real                        1           1      1.59s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.84s  |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      5.86s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      5.47s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      5.84s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.84s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.84s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69988                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      5.47s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70037       70037      0.99s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.12s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            4026        4026      1.54s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      2.50s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                           59          59      1.69s  |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.59s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      1.59s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60266       60266      1.17s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.37s  |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65021       65021      1.27s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65021       65021      0.77s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        267568      267568      1.18s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.17s  |
...
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           4061        4061      1.15s  |
|    /                                                                        |
...
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           4096        4096      1.09s  |
|    /                                                                        |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145038      145038      0.52s  |
+-----------------------------------------------------------------------------+
|   o-- cell_sort_kpoints_with_recip            70037                         |
|  /o-- check_image_list                            1                         |
| |/                                                                          |
| O-> cell_find_reduced_cell                    70038       70038      0.99s  |
|    /                                                                        |
