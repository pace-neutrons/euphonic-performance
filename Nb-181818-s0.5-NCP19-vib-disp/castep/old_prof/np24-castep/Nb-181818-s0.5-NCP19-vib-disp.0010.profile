...
|   o-> comms_send_complex                       1087        1087     28.19s  |
|   o-> comms_send_real                          2174        2174     43.21s  |
|   o-> comms_reduce_gv_real                        1           1      1.54s  |
...
|   o-> cell_set_supercell_symmetry                 2           2      7.82s  |
...
| |/                                                                          |
| O-> comms_gcopy_integer                         439         439      9.75s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> cell_read_wrapped                             1           1      9.43s  |
...
|   o-> cell_num_supercells                         2           2      0.00s  |
|   o-> algor_invert_real                           2           2      0.00s  |
|   o-> cell_reduce_symmetry_supercell              2           2      0.32s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      3.89s  |
|    /                                                                        |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.54s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      1.54s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60268       60268      1.07s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.37s  |
...
| |/                                                                          |
| O-> algor_invert_real                        267570      267570      1.18s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60268                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65023       65023      1.16s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65023       65023      0.71s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
...
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           4096        4096      1.06s  |
|    /                                                                        |
|   o-> algor_invert_real                       56562       56562      0.19s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145040      145040      0.49s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      65023                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               65023       65023      0.71s  |
|    /                                                                        |
|   o-> q_is_a_g                                60291       60291      0.20s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               145040                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              145040      145040      0.49s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_distribute_grids                      1           1      0.45s  |
...
|   o-> comms_map_transpose                         2           2      0.43s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.43s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.43s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.43s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.43s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_compute_atom_phases             60291                         |
|  /o-- phonon_calculate                           35                         |
| |/                                                                          |
| O-> q_is_a_g                                  62693       62693      0.21s  |
+-----------------------------------------------------------------------------+
