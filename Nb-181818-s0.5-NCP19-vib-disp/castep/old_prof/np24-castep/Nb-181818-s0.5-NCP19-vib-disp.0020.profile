...
|   o-> phonon_recip_to_real                        1           1      8.79s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      7.62s  |
|   o-> phonon_real_to_fine                      1088        1088      2.49s  |
...
|   o-> comms_send_complex                       1087        1087     21.73s  |
|   o-> comms_send_real                          2174        2174     50.57s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      6.04s  |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      6.07s  |
|    /                                                                        |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      6.04s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      6.04s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70037       70037      1.05s  |
|   o-> algor_invert_real                      140074      140074      0.69s  |
|   o-> algor_sort                              70037       70037      0.37s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_radial_transform                  36          36      1.04s  |
...
| O-> ion_atom_ps_diag                             59          59      1.68s  |
|    /                                                                        |
|   o-> ion_atom_regin                         128915      128915      0.76s  |
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60264       60264      1.07s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.37s  |
...
| |/                                                                          |
| O-> algor_invert_real                        267566      267566      1.22s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           60264                         |
|  /o-- secondd_tr_symmetrize_dmat               4026                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65019       65019      1.16s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65019       65019      0.71s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
...
|    /                                                                        |
|   o-> algor_invert_real                       56558       56558      0.19s  |
+-----------------------------------------------------------------------------+
|   o-- cell_sort_kpoints_with_recip            70037                         |
|  /o-- check_image_list                            1                         |
| |/                                                                          |
| O-> cell_find_reduced_cell                    70038       70038      1.05s  |
|    /                                                                        |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145036      145036      0.49s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_sort                                70039       70039      0.37s  |
+-----------------------------------------------------------------------------+
