...
|   o-> phonon_recip_to_real                        1           1      8.71s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      7.61s  |
|   o-> phonon_real_to_fine                      1088        1088      2.06s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      2.51s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.62s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     21.49s  |
|   o-> comms_send_real                          2174        2174     50.34s  |
|   o-> comms_reduce_gv_real                        1           1      0.97s  |
...
|   o-> ion_initialise                              1           1      6.73s  |
|   o-> basis_initialise                            2           2      0.48s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.97s  |
|   o-> cell_generate_ionic_constraints             2           2      1.36s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      6.00s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      5.59s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      5.97s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.97s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.97s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69988                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      5.60s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70037       70037      1.03s  |
|   o-> algor_invert_real                      140074      140074      0.66s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      3.91s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             4026        4026      0.01s  |
|   o-> hermitian4                               4026        4026      0.01s  |
|   o-> cell_copy_symmetry                       8052        8052      0.05s  |
|   o-> cell_reduce_symmetry_ops_wrapped         4026        4026      1.13s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      2.35s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                           59          59      1.68s  |
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      1.54s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        267572      267572      1.18s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           4061        4061      1.13s  |
|    /                                                                        |
|   o-> cell_check_group                         4061        4061      1.07s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.11s  |
...
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           4096        4096      1.07s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> cell_find_reduced_cell                    70038       70038      1.03s  |
|    /                                                                        |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.97s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.97s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_map_transpose                         2           2      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              2                         |
|  /                                                                          |
| O-> ion_atom_allocate_pspot                       2           2      0.06s  |
...
| O-> comms_map_transpose                           2           2      0.06s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.06s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.06s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_copy_symmetry                         8122        8122      0.05s  |
+-----------------------------------------------------------------------------+
|   o-- ion_all_beta_multi_phi_recip               95                         |
|  /                                                                          |
| O-> ion_beta_recip_set                           95          95      0.05s  |
...
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_factor_group_symmetry_wrapped         4061        4061      0.04s  |
+-----------------------------------------------------------------------------+
...
COMMS_BND                               0.00s
COMMS_FARM                              0.00s
     278 different subroutines and functions were traced
Hash collisions:          2
