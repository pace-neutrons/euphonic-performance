...
|   o-> comms_send_complex                       1087        1087     28.51s  |
|   o-> comms_send_real                          2174        2174     41.62s  |
|   o-> comms_reduce_gv_real                        1           1      1.61s  |
...
|   o-> ion_initialise                              1           1      6.79s  |
|   o-> basis_initialise                            2           2      0.42s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.90s  |
...
|   o-> ion_atom_pseudo_scf                         1           1      1.87s  |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      5.93s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      5.54s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      5.90s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.90s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.90s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69988                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      5.54s  |
|    /                                                                        |
...
|   o-> ion_atom_ps_diag                           59          59      1.74s  |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.61s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      1.61s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        267568      267568      1.20s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.18s  |
