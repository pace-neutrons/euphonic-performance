...
|   o-> phonon_real_to_fine                      1088        1088      3.00s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      2.68s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.66s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     20.37s  |
|   o-> comms_send_real                          2174        2174     49.70s  |
|   o-> comms_reduce_gv_real                        1           1      1.62s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.15s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             4026        4026      0.01s  |
|   o-> hermitian4                               4026        4026      0.01s  |
|   o-> cell_copy_symmetry                       8052        8052      0.06s  |
|   o-> cell_reduce_symmetry_ops_wrapped         4026        4026      1.17s  |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.62s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      1.62s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60270       60270      1.17s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.37s  |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65025       65025      1.27s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> algor_invert_real                        267572      267572      1.21s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
...
|    /                                                                        |
|   o-> cell_check_group                         4061        4061      1.11s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.17s  |
...
|   o-> comms_gather_gv_integer                    12          12      0.04s  |
