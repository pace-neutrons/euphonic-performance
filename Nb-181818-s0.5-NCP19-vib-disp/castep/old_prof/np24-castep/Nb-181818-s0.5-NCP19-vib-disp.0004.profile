...
|   o-> phonon_real_to_fine                      1088        1088      2.51s  |
|   o-> phonon_enforce_dmat_sumrule              1087        1087      2.75s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.69s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     28.62s  |
|   o-> comms_send_real                          2174        2174     41.84s  |
...
|   o-> ion_initialise                              1           1      6.75s  |
|   o-> basis_initialise                            2           2      0.46s  |
...
|   o-> ion_atom_pseudo_scf                         1           1      1.81s  |
...
|   o-> cell_sort_kpoints_with_recip            69988       69988      5.55s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      5.92s  |
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      5.55s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      4.26s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            4026        4026      1.61s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      2.59s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      60268       60268      1.22s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.37s  |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        65023       65023      1.32s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65023       65023      0.80s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        267570      267570      1.21s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.19s  |
...
|    /                                                                        |
|   o-> algor_invert_real                       56562       56562      0.21s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            145040      145040      0.53s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_distribute_grids                      1           1      0.46s  |
...
|   o-> comms_map_transpose                         2           2      0.44s  |
+-----------------------------------------------------------------------------+
...
| O-> comms_map_transpose                           2           2      0.44s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.44s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.44s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.44s  |
+-----------------------------------------------------------------------------+
