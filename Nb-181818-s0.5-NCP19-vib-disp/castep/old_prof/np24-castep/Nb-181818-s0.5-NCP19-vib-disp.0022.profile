...
|   o-> phonon_enforce_dmat_sumrule              1087        1087      2.49s  |
|   o-> phonon_prepare_and_diagonalise           1087        1087      0.61s  |
|   o-> phonon_accumulate_adp                    1087        1087      0.01s  |
|   o-> comms_send_complex                       1087        1087     21.35s  |
|   o-> comms_send_real                          2174        2174     50.07s  |
...
|   o-> cell_set_supercell_symmetry                 2           2      7.80s  |
|   o-> cell_copy_kpoints                           2           2      0.00s  |
|   o-> cell_kpoints_spacing_wrapped                2           2      5.92s  |
...
|   o-> ion_atom_pseudo_scf                         1           1      1.83s  |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      5.95s  |
|    /                                                                        |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.92s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.92s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69988                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      5.56s  |
|    /                                                                        |
...
|   o-> ion_atom_radial_transform                  36          36      1.06s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              4026        4026      3.88s  |
|    /                                                                        |
...
|   o-> secondd_tr_symmetrize_dmat               4026        4026      1.10s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1088        1088      0.54s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1087                         |
|  /                                                                          |
| O-> phonon_enforce_dmat_sumrule                1087        1087      2.49s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1087        1087      2.34s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_pseudo_scf                           1           1      1.83s  |
...
|    /                                                                        |
|   o-> secondd_compute_atom_phases             65025       65025      0.70s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            4026                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           4061        4061      1.12s  |
|    /                                                                        |
...
| O-> secondd_tr_symmetrize_dmat                 4026        4026      1.10s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 4026        4026      0.98s  |
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                   8816        8816      1.03s  |
|    /                                                                        |
...
|  /o-- phonon_calculate                         1087                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             1122        1122      0.65s  |
|    /                                                                        |
|   o-> q_is_a_g                                 2244        2244      0.01s  |
|   o-> secondd_symmetrize_dmat_cmplx            1122        1122      0.57s  |
