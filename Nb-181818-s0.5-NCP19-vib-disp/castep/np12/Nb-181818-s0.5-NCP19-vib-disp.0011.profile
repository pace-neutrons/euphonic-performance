...
|   o-> phonon_recip_to_real                        1           1      7.88s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      6.90s  |
|   o-> phonon_real_to_fine                      2273        2273      3.92s  |
|   o-> phonon_enforce_dmat_sumrule              2272        2272      4.88s  |
|   o-> phonon_prepare_and_diagonalise           2272        2272      1.19s  |
|   o-> phonon_accumulate_adp                    2272        2272      0.02s  |
|   o-> comms_send_complex                       2272        2272     19.94s  |
|   o-> comms_send_real                          4544        4544     39.68s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      4.79s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              7581        7581      7.11s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             7581        7581      0.02s  |
|   o-> hermitian4                               7581        7581      0.02s  |
|   o-> cell_copy_symmetry                      15162       15162      0.10s  |
|   o-> cell_reduce_symmetry_ops_wrapped         7581        7581      2.25s  |
|   o-> secondd_group_symmetrize_dmat            7581        7581      2.60s  |
|   o-> cell_deallocate                          7581        7581      0.03s  |
|   o-> secondd_find_inversion                   7581        7581      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               7581        7581      1.82s  |
+-----------------------------------------------------------------------------+
...
| O-> phonon_enforce_dmat_sumrule                2272        2272      4.88s  |
|    /                                                                        |
|   o-> phonon_mass_weight_dmat                  4544        4544      0.01s  |
|   o-> phonon_diagonalise_d_cmplx               6816        6816      0.04s  |
|   o-> secondd_find_acoustics                   2272        2272      0.04s  |
|   o-> secondd_symmetrize_dmat_cmplx            2272        2272      4.60s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      4.79s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      4.79s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      4.79s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      4.50s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70035       70035      0.75s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            2273        2273      1.05s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion     123075      123075      1.97s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7581                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           7616        7616      2.25s  |
|    /                                                                        |
|   o-> cell_check_group                         7616        7616      2.14s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         7616                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           7651        7651      2.14s  |
|    /                                                                        |
|   o-> algor_invert_real                      115814      115814      0.35s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          123075                         |
|  /o-- secondd_tr_symmetrize_dmat               7581                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       131385      131385      2.11s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            131385      131385      1.27s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7581                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 7581        7581      1.82s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 7581        7581      1.62s  |
|   o-> secondd_apply_symmetry_to_dmat_ion       7581        7581      0.13s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  15926       15926      1.69s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            261172      261172      0.80s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.34s  |
...
| O-> secondd_compute_atom_phases              131385      131385      1.27s  |
|    /                                                                        |
|   o-> q_is_a_g                               121917      121917      0.37s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         2272                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             2307        2307      1.23s  |
|    /                                                                        |
|   o-> q_is_a_g                                 4614        4614      0.01s  |
|   o-> secondd_symmetrize_dmat_cmplx            2307        2307      1.06s  |
|   o-> phonon_constrain_dmat                    2307        2307      0.01s  |
|   o-> phonon_mass_weight_dmat                  2307        2307      0.01s  |
|   o-> phonon_diagonalise_d_cmplx               2307        2307      0.03s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        326816      326816      1.09s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      0.75s  |
+-----------------------------------------------------------------------------+
|   o-- cell_sort_kpoints_with_recip            70035                         |
|  /o-- check_image_list                            1                         |
| |/                                                                          |
| O-> cell_find_reduced_cell                    70036       70036      0.75s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> q_is_a_g                                 126689      126689      0.39s  |
+-----------------------------------------------------------------------------+
|   o-- basis_calculate_cut_off                     2                         |
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
...
|  /o-- phonons                                     1                         |
| |/                                                                          |
| O-> cell_deallocate                            7640        7639      0.03s  |
+-----------------------------------------------------------------------------+
