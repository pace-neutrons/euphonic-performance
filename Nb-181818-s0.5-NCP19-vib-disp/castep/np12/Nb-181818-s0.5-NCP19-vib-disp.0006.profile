...
|   o-> phonon_real_to_fine                      2274        2274      4.85s  |
|   o-> phonon_enforce_dmat_sumrule              2273        2273      5.25s  |
|   o-> phonon_prepare_and_diagonalise           2273        2273      1.31s  |
|   o-> phonon_accumulate_adp                    2273        2273      0.02s  |
|   o-> comms_send_complex                       2273        2273     19.71s  |
|   o-> comms_send_real                          4546        4546     38.69s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      4.83s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              7584        7584      7.69s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            7584        7584      2.87s  |
|   o-> cell_deallocate                          7584        7584      0.03s  |
|   o-> secondd_find_inversion                   7584        7584      0.03s  |
|   o-> secondd_tr_symmetrize_dmat               7584        7584      2.00s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_set_supercell_symmetry                   2           2      7.68s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            2273        2273      4.96s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      4.83s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      4.83s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      4.54s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69986                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      4.54s  |
|    /                                                                        |
...
|   o-> secondd_apply_symmetry_to_dmat_ion     123130      123130      2.19s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7584                         |
...
|    /                                                                        |
|   o-> cell_check_group                         7619        7619      2.23s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          123130                         |
|  /o-- secondd_tr_symmetrize_dmat               7584                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       131443      131443      2.34s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            131443      131443      1.41s  |
+-----------------------------------------------------------------------------+
...
| O-> secondd_tr_symmetrize_dmat                 7584        7584      2.00s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 7584        7584      1.77s  |
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  15932       15932      1.85s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            261272      261272      0.88s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                         2273                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             2308        2308      1.35s  |
|    /                                                                        |
|   o-> q_is_a_g                                 4616        4616      0.02s  |
|   o-> secondd_symmetrize_dmat_cmplx            2308        2308      1.17s  |
...
| |/                                                                          |
| O-> algor_invert_real                        326868      326868      1.14s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> q_is_a_g                                 126749      126749      0.43s  |
+-----------------------------------------------------------------------------+
|   o-- cell_set_supercell_symmetry                 2                         |
|  /                                                                          |
| O-> cell_reduce_symmetry_supercell                2           2      0.28s  |
