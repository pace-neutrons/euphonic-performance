...
|   o-> phonon_real_to_fine                      2274        2274      4.90s  |
|   o-> phonon_enforce_dmat_sumrule              2273        2273      5.28s  |
|   o-> phonon_prepare_and_diagonalise           2273        2273      1.32s  |
|   o-> phonon_accumulate_adp                    2273        2273      0.02s  |
|   o-> comms_send_complex                       2273        2273     20.08s  |
|   o-> comms_send_real                          4546        4546     38.20s  |
|   o-> comms_reduce_gv_real                        1           1      0.48s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              7584        7584      7.74s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            7584        7584      2.89s  |
|   o-> cell_deallocate                          7584        7584      0.03s  |
|   o-> secondd_find_inversion                   7584        7584      0.03s  |
|   o-> secondd_tr_symmetrize_dmat               7584        7584      2.01s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_set_supercell_symmetry                   2           2      7.69s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            2273        2273      4.98s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      4.56s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70035       70035      0.77s  |
|   o-> algor_invert_real                      140070      140070      0.49s  |
|   o-> algor_sort                              70035       70035      0.27s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion     123132      123132      2.20s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7584                         |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       131445      131445      2.35s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            131445      131445      1.41s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  15932       15932      1.86s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            261274      261274      0.89s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        326870      326870      1.15s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_find_reduced_cell                    70036       70036      0.77s  |
|    /                                                                        |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.48s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.48s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> q_is_a_g                                 126755      126755      0.43s  |
+-----------------------------------------------------------------------------+
|   o-- cell_set_supercell_symmetry                 2                         |
|  /                                                                          |
| O-> cell_reduce_symmetry_supercell                2           2      0.28s  |
...
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 9127        9127      0.08s  |
+-----------------------------------------------------------------------------+
