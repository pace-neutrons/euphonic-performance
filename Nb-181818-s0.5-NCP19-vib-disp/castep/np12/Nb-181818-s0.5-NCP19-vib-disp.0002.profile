...
|   o-> phonon_recip_to_real                        1           1      8.14s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      6.95s  |
|   o-> phonon_real_to_fine                      2274        2274      5.08s  |
|   o-> phonon_enforce_dmat_sumrule              2273        2273      5.40s  |
|   o-> phonon_prepare_and_diagonalise           2273        2273      1.34s  |
|   o-> phonon_accumulate_adp                    2273        2273      0.03s  |
|   o-> comms_send_complex                       2273        2273     19.05s  |
|   o-> comms_send_real                          4546        4546     38.35s  |
|   o-> comms_reduce_gv_real                        1           1      0.41s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      4.90s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              7584        7584      7.87s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             7584        7584      0.03s  |
|   o-> hermitian4                               7584        7584      0.03s  |
|   o-> cell_copy_symmetry                      15168       15168      0.10s  |
|   o-> cell_reduce_symmetry_ops_wrapped         7584        7584      2.36s  |
|   o-> secondd_group_symmetrize_dmat            7584        7584      2.98s  |
|   o-> cell_deallocate                          7584        7584      0.03s  |
|   o-> secondd_find_inversion                   7584        7584      0.03s  |
|   o-> secondd_tr_symmetrize_dmat               7584        7584      2.04s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_set_supercell_symmetry                   2           2      7.68s  |
...
|   o-> ion_atom_pseudo_scf                         1           1      1.23s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            2273        2273      5.08s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            2274        2274      1.19s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      4.92s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      4.62s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      4.90s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      4.90s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      4.90s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_generate_psp                         1           1      4.71s  |
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      4.62s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       131445      131445      2.44s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           7619        7619      2.36s  |
|    /                                                                        |
|   o-> cell_check_group                         7619        7619      2.24s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         7619                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           7654        7654      2.24s  |
|    /                                                                        |
...
| O-> secondd_tr_symmetrize_dmat                 7584        7584      2.04s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 7584        7584      1.81s  |
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  15932       15932      1.89s  |
|    /                                                                        |
...
| O-> secondd_compute_atom_phases              131445      131445      1.48s  |
|    /                                                                        |
|   o-> q_is_a_g                               121981      121981      0.43s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            2308        2308      1.19s  |
...
|   o-> ion_atom_ps_diag                           59          59      1.12s  |
...
|  /o-- ion_initialise                              1                         |
| |/                                                                          |
| O-> ion_atom_radial_transform                    38          38      1.21s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> algor_invert_real                        326876      326876      1.16s  |
+-----------------------------------------------------------------------------+
...
|   o-> density_allocate                            1           1      0.00s  |
|   o-> density_copy                                1           1      0.00s  |
|   o-> density_write_parallel                      1           1      0.23s  |
|   o-> density_deallocate                          1           1      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- density_write                               1                         |
|  /                                                                          |
| O-> density_write_parallel                        1           1      0.23s  |
|    /                                                                        |
|   o-> comms_gather_gv_integer                     3           3      0.23s  |
...
| |/                                                                          |
| O-> comms_gather_gv_integer                      18          18      0.23s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> wave_initialise_wv                            1           1      0.18s  |
