...
|   o-> model_continuation                          1           1     14.73s  |
...
|   o-> phonon_calculate                            1           1     84.87s  |
|   o-> check_forces_stresses                       1           1      0.00s  |
|   o-> model_write                                 1           1      0.25s  |
...
|   o-> phonon_calculate_dynamical_dfpt             1           1      0.04s  |
|   o-> phonon_recip_to_real                        1           1      8.13s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      6.94s  |
|   o-> phonon_real_to_fine                      2273        2273      4.84s  |
|   o-> phonon_enforce_dmat_sumrule              2272        2272      5.38s  |
|   o-> phonon_prepare_and_diagonalise           2272        2272      1.33s  |
|   o-> phonon_accumulate_adp                    2272        2272      0.03s  |
|   o-> comms_send_complex                       2272        2272     19.07s  |
|   o-> comms_send_real                          4544        4544     38.23s  |
|   o-> comms_reduce_gv_real                        1           1      0.36s  |
...
|   o-> ion_initialise                              1           1      5.99s  |
|   o-> basis_initialise                            2           2      0.19s  |
|   o-> model_store_dependencies                    1           1      0.00s  |
|   o-> cell_reread                                 1           1      8.17s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      4.86s  |
...
| |/                                                                          |
| O-> comms_gcopy_integer                         439         439      9.67s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
|  /                                                                          |
| O-> cell_read_wrapped                             1           1      9.37s  |
...
|   o-> comms_gcopy_integer                        64          64      8.92s  |
...
|    /                                                                        |
|   o-> cell_setup_keywords                         1           1      0.00s  |
|   o-> comms_gcopy_integer                        60          60      0.74s  |
|   o-> comms_gcopy_real                           78          78      7.43s  |
|   o-> comms_gcopy_character                       4           4      0.00s  |
...
+-----------------------------------------------------------------------------+
|   o-- phonon_prepare_and_diagonalise           2307                         |
|  /o-- phonon_recip_to_real                      729                         |
|  /o-- phonon_real_to_fine                      2273                         |
|  /o-- phonon_enforce_dmat_sumrule              2272                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              7581        7581      7.83s  |
|    /                                                                        |
|   o-> two_q_is_a_g                             7581        7581      0.03s  |
|   o-> hermitian4                               7581        7581      0.03s  |
|   o-> cell_copy_symmetry                      15162       15162      0.10s  |
|   o-> cell_reduce_symmetry_ops_wrapped         7581        7581      2.37s  |
|   o-> secondd_group_symmetrize_dmat            7581        7581      2.95s  |
|   o-> cell_deallocate                          7581        7581      0.03s  |
|   o-> secondd_find_inversion                   7581        7581      0.03s  |
|   o-> secondd_tr_symmetrize_dmat               7581        7581      2.02s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_set_supercell_symmetry                   2           2      7.69s  |
...
|   o-> cell_find_related_atoms_supercell           2           2      5.01s  |
+-----------------------------------------------------------------------------+
|   o-- castep                                      1                         |
...
| |/                                                                          |
| O-> comms_gcopy_real                            526         526      7.44s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> ion_initialise                                1           1      5.99s  |
...
| O-> phonon_enforce_dmat_sumrule                2272        2272      5.38s  |
|    /                                                                        |
|   o-> phonon_mass_weight_dmat                  4544        4544      0.02s  |
|   o-> phonon_diagonalise_d_cmplx               6816        6816      0.05s  |
|   o-> secondd_find_acoustics                   2272        2272      0.05s  |
|   o-> secondd_symmetrize_dmat_cmplx            2272        2272      5.06s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      4.89s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      4.58s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      4.86s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      4.86s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      4.86s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            2273        2273      1.18s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_generate_psp                         1           1      4.69s  |
...
|   o-> ion_atom_construct_psp                      1           1      4.00s  |
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      4.59s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70037       70037      0.76s  |
|   o-> algor_invert_real                      140074      140074      0.49s  |
...
|   o-> ion_atom_radial_transform                  36          36      0.99s  |
|   o-> ion_atom_fermi_contact                      8           8      0.00s  |
|   o-> ion_atom_apply_Tl                          24          24      0.00s  |
|   o-> ion_atom_real_derivative_kind1             48          48      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7581                         |
|  /                                                                          |
| O-> secondd_group_symmetrize_dmat              7581        7581      2.95s  |
|    /                                                                        |
|   o-> cell_factor_group_symmetry_wrapped       7581        7581      0.09s  |
|   o-> secondd_check_equiv_ions                 7581        7581      0.07s  |
|   o-> secondd_apply_symmetry_to_dmat_ion     123079      123079      2.26s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          123079                         |
|  /o-- secondd_tr_symmetrize_dmat               7581                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       131389      131389      2.42s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            131389      131389      1.47s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7581                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           7616        7616      2.37s  |
|    /                                                                        |
|   o-> cell_check_group                         7616        7616      2.25s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         7616                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           7651        7651      2.25s  |
|    /                                                                        |
|   o-> algor_invert_real                      115818      115818      0.40s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            7581                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 7581        7581      2.02s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 7581        7581      1.80s  |
|   o-> secondd_apply_symmetry_to_dmat_ion       7581        7581      0.14s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat            7581                         |
|  /o-- secondd_tr_symmetrize_dmat               7581                         |
|  /o-- secondd_calc_irreps                        35                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  15926       15926      1.87s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            261176      261176      0.89s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion     131389                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases              131389      131389      1.47s  |
|    /                                                                        |
|   o-> q_is_a_g                               121929      121929      0.42s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         2272                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             2307        2307      1.35s  |
|    /                                                                        |
|   o-> q_is_a_g                                 4614        4614      0.02s  |
|   o-> secondd_symmetrize_dmat_cmplx            2307        2307      1.18s  |
|   o-> phonon_constrain_dmat                    2307        2307      0.01s  |
|   o-> phonon_mass_weight_dmat                  2307        2307      0.01s  |
|   o-> phonon_diagonalise_d_cmplx               2307        2307      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.34s  |
...
|   o-> ion_atom_ps_diag                           59          59      1.08s  |
...
| |/                                                                          |
| O-> algor_invert_real                        326826      326826      1.14s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pseudo_scf                        59                         |
|  /                                                                          |
| O-> ion_atom_ps_diag                             59          59      1.08s  |
|    /                                                                        |
|   o-> ion_atom_regin                         128915      128915      0.49s  |
|   o-> ion_atom_rectoreal                        236         236      0.00s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               261176                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              261176      261176      0.89s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.80s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_find_reduced_cell                    70038       70038      0.76s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> ion_atom_regin                           134061      134061      0.51s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_prepare_and_diagonalise           4614                         |
|  /o-- secondd_compute_atom_phases            121929                         |
|  /o-- phonon_calculate                           35                         |
| |/                                                                          |
| O-> q_is_a_g                                 126701      126701      0.44s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       1                         |
|  /                                                                          |
| O-> ion_atom_ae_scf                               1           1      0.37s  |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.36s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.36s  |
+-----------------------------------------------------------------------------+
...
|   o-> basis_count_plane_waves                     1           1      0.10s  |
...
|          o-> wave_Sorthonormalise_wv              1           1      0.17s  |
|    /                                                                        |
...
| O-> wave_Sorthonormalise_wv                       1           1      0.17s  |
|    /                                                                        |
|   o-> wave_Sorthonormalise_wv_ks                 95          95      0.17s  |
+-----------------------------------------------------------------------------+
|   o-- wave_Sorthonormalise_wv                    95                         |
|  /                                                                          |
| O-> wave_Sorthonormalise_wv_ks                   95          95      0.17s  |
|    /                                                                        |
|   o-> wave_calc_Soverlap_wv_ks                   95          95      0.16s  |
...
|   o-> ion_all_beta_multi_phi_recip               95          95      0.13s  |
+-----------------------------------------------------------------------------+
|   o-- wave_beta_phi_wv_ks                        95                         |
|  /                                                                          |
| O-> ion_all_beta_multi_phi_recip                 95          95      0.13s  |
|    /                                                                        |
|   o-> ion_beta_recip_set                         95          95      0.04s  |
...
| O-> comms_copy_gv_real                            2           2      0.12s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           15162                         |
|  /o-- secondd_calc_irreps                        70                         |
| |/                                                                          |
| O-> cell_copy_symmetry                        15232       15232      0.10s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_reduce_kp_integer                     3           3      0.10s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_factor_group_symmetry_wrapped         7616        7616      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       1                         |
|  /                                                                          |
| O-> ion_atom_descreen_psp                         1           1      0.09s  |
...
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 9123        9123      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              2272                         |
|  /                                                                          |
| O-> secondd_find_acoustics                     2272        2272      0.05s  |
...
| |/                                                                          |
| O-> cell_deallocate                            7638        7638      0.03s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> phonon_mass_weight_dmat                    6851        6851      0.02s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_pseudo_scf                        59                         |
|  /                                                                          |
| O-> ion_atom_set_pseudo_H                        59          59      0.02s  |
...
|  /o-- phonon_real_to_fine                      2273                         |
| |/                                                                          |
| O-> cell_num_supercells                        2282        2282      0.01s  |
+-----------------------------------------------------------------------------+
|   o-- wave_Sorthonormalise_wv_ks                 95                         |
|  /                                                                          |
| O-> wave_orthonormalise_over_wv_ks               95          95      0.01s  |
