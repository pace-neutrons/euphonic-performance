...
|   o-> phonon_real_to_fine                      3573        3573      6.55s  |
|   o-> phonon_enforce_dmat_sumrule              3572        3572      8.25s  |
|   o-> phonon_prepare_and_diagonalise           3572        3572      2.00s  |
|   o-> phonon_accumulate_adp                    3572        3572      0.04s  |
|   o-> comms_send_complex                       3572        3572     17.59s  |
|   o-> comms_send_real                          7144        7144     35.46s  |
|   o-> comms_reduce_gv_real                        1           1      0.27s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      4.74s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx             11481       11481     11.71s  |
|    /                                                                        |
|   o-> two_q_is_a_g                            11481       11481      0.04s  |
|   o-> hermitian4                              11481       11481      0.04s  |
|   o-> cell_copy_symmetry                      22962       22962      0.15s  |
|   o-> cell_reduce_symmetry_ops_wrapped        11481       11481      3.63s  |
|   o-> secondd_group_symmetrize_dmat           11481       11481      4.46s  |
|   o-> cell_deallocate                         11481       11481      0.04s  |
|   o-> secondd_find_inversion                  11481       11481      0.04s  |
|   o-> secondd_tr_symmetrize_dmat              11481       11481      2.90s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            3572        3572      7.76s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                            1                         |
|  /                                                                          |
| O-> phonon_recip_to_real                          1           1      8.04s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            3573        3573      1.78s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> ion_initialise                                1           1      5.93s  |
...
|   o-> ion_atom_pseudo_scf                         1           1      1.13s  |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      4.77s  |
|    /                                                                        |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      4.74s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      4.74s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_generate_psp                         1           1      4.71s  |
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      4.48s  |
|    /                                                                        |
...
|   o-> secondd_apply_symmetry_to_dmat_ion     191975      191975      3.42s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       204185      204185      3.64s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            204185      204185      2.22s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           11481                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped          11516       11516      3.63s  |
|    /                                                                        |
|   o-> cell_check_group                        11516       11516      3.46s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped        11516                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                          11551       11551      3.46s  |
|    /                                                                        |
|   o-> algor_invert_real                      180814      180814      0.61s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           11481                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                11481       11481      2.90s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                11481       11481      2.58s  |
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  23726       23726      2.68s  |
|    /                                                                        |
...
| O-> secondd_compute_atom_phases              204185      204185      2.22s  |
|    /                                                                        |
|   o-> q_is_a_g                               189517      189517      0.63s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         3572                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             3607        3607      2.03s  |
|    /                                                                        |
|   o-> q_is_a_g                                 7214        7214      0.02s  |
|   o-> secondd_symmetrize_dmat_cmplx            3607        3607      1.77s  |
...
| |/                                                                          |
| O-> algor_invert_real                        391822      391822      1.32s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                           59          59      1.02s  |
...
| |/                                                                          |
| O-> q_is_a_g                                 196889      196889      0.65s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.27s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.27s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       3                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.27s  |
+-----------------------------------------------------------------------------+
|   o-- cell_set_supercell_symmetry                 2                         |
|  /                                                                          |
| O-> cell_reduce_symmetry_supercell                2           2      0.27s  |
...
|   o-> wave_beta_phi_wv_ks                        95          95      0.11s  |
...
| |/                                                                          |
| O-> cell_deallocate                           11538       11538      0.04s  |
+-----------------------------------------------------------------------------+
