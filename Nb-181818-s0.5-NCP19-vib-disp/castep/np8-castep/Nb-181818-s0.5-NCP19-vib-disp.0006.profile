...
|   o-> cell_supercell                              1           1      6.86s  |
|   o-> phonon_real_to_fine                      3572        3572      6.56s  |
|   o-> phonon_enforce_dmat_sumrule              3571        3571      8.29s  |
|   o-> phonon_prepare_and_diagonalise           3571        3571      2.01s  |
|   o-> phonon_accumulate_adp                    3571        3571      0.04s  |
|   o-> comms_send_complex                       3571        3571     18.12s  |
|   o-> comms_send_real                          7142        7142     34.88s  |
|   o-> comms_reduce_gv_real                        1           1      0.08s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      4.75s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx             11478       11478     11.76s  |
|    /                                                                        |
|   o-> two_q_is_a_g                            11478       11478      0.04s  |
|   o-> hermitian4                              11478       11478      0.04s  |
|   o-> cell_copy_symmetry                      22956       22956      0.15s  |
|   o-> cell_reduce_symmetry_ops_wrapped        11478       11478      3.67s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            3571        3571      7.79s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            3572        3572      1.79s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> ion_initialise                                1           1      5.90s  |
...
|   o-> ion_atom_pseudo_scf                         1           1      1.12s  |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      4.78s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      4.48s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      4.75s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      4.75s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      4.75s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_generate_psp                         1           1      4.69s  |
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      4.49s  |
|    /                                                                        |
...
|   o-> secondd_apply_symmetry_to_dmat_ion     191932      191932      3.42s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped          11513       11513      3.67s  |
|    /                                                                        |
|   o-> cell_check_group                        11513       11513      3.50s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          191932                         |
|  /o-- secondd_tr_symmetrize_dmat              11478                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       204139      204139      3.64s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            204139      204139      2.22s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped        11513                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                          11548       11548      3.50s  |
|    /                                                                        |
|   o-> algor_invert_real                      180774      180774      0.61s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           11478                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                11478       11478      2.91s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            388484      388484      1.28s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion     204139                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases              204139      204139      2.22s  |
|    /                                                                        |
|   o-> q_is_a_g                               189495      189495      0.63s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         3571                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             3606        3606      2.04s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> algor_invert_real                        391782      391782      1.33s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               388484                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              388484      388484      1.28s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                           59          59      1.01s  |
...
| O-> ion_atom_ps_diag                             59          59      1.01s  |
|    /                                                                        |
|   o-> ion_atom_regin                         128915      128915      0.46s  |
...
|  /o-- secondd_compute_atom_phases            189495                         |
|  /o-- phonon_calculate                           35                         |
| |/                                                                          |
| O-> q_is_a_g                                 196865      196865      0.66s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           134061      134061      0.48s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.08s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.08s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_enforce_dmat_sumrule              3571                         |
|  /                                                                          |
| O-> secondd_find_acoustics                     3571        3571      0.08s  |
