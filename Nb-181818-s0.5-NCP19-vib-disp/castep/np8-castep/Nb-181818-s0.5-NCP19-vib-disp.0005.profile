...
|   o-> model_continuation                          1           1     14.71s  |
...
|   o-> phonon_recip_to_real                        1           1      8.00s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      6.82s  |
|   o-> phonon_real_to_fine                      3572        3572      6.11s  |
|   o-> phonon_enforce_dmat_sumrule              3571        3571      8.15s  |
|   o-> phonon_prepare_and_diagonalise           3571        3571      2.03s  |
|   o-> phonon_accumulate_adp                    3571        3571      0.04s  |
|   o-> comms_send_complex                       3571        3571     18.59s  |
|   o-> comms_send_real                          7142        7142     34.81s  |
|   o-> comms_reduce_gv_real                        1           1      0.32s  |
|   o-> comms_reduce_bnd_real                       1           1      0.00s  |
|   o-> comms_reduce_kp_real                        1           1      0.18s  |
...
| |/                                                                          |
| O-> comms_send_real                            7145        7145     34.83s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_initialise                              1           1      5.92s  |
|   o-> basis_initialise                            2           2      0.18s  |
...
|   o-> wave_initialise_wv                          1           1      0.15s  |
...
|   o-> cell_set_supercell_symmetry                 2           2      7.64s  |
|   o-> cell_copy_kpoints                           2           2      0.00s  |
|   o-> cell_kpoints_spacing_wrapped                2           2      4.67s  |
|   o-> cell_generate_ionic_constraints             2           2      1.34s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_prepare_and_diagonalise           3606                         |
|  /o-- phonon_recip_to_real                      729                         |
|  /o-- phonon_real_to_fine                      3572                         |
|  /o-- phonon_enforce_dmat_sumrule              3571                         |
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx             11478       11478     11.60s  |
|    /                                                                        |
|   o-> two_q_is_a_g                            11478       11478      0.04s  |
|   o-> hermitian4                              11478       11478      0.04s  |
|   o-> cell_copy_symmetry                      22956       22956      0.15s  |
|   o-> cell_reduce_symmetry_ops_wrapped        11478       11478      3.59s  |
|   o-> secondd_group_symmetrize_dmat           11478       11478      4.40s  |
|   o-> cell_deallocate                         11478       11478      0.04s  |
|   o-> secondd_find_inversion                  11478       11478      0.04s  |
|   o-> secondd_tr_symmetrize_dmat              11478       11478      2.90s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_gcopy_integer                        64          64      8.91s  |
...
|   o-> comms_gcopy_real                           78          78      7.53s  |
|   o-> comms_gcopy_character                       4           4      0.00s  |
...
| O-> phonon_enforce_dmat_sumrule                3571        3571      8.15s  |
|    /                                                                        |
|   o-> phonon_mass_weight_dmat                  7142        7142      0.02s  |
|   o-> phonon_diagonalise_d_cmplx              10713       10713      0.07s  |
|   o-> secondd_find_acoustics                   3571        3571      0.08s  |
|   o-> secondd_symmetrize_dmat_cmplx            3571        3571      7.66s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                            1                         |
|  /                                                                          |
| O-> phonon_recip_to_real                          1           1      8.00s  |
...
|   o-> cell_num_supercells                         2           2      0.00s  |
|   o-> algor_invert_real                           2           2      0.00s  |
|   o-> cell_reduce_symmetry_supercell              2           2      0.26s  |
...
|   o-> check_image_list                         3572        3572      0.02s  |
|   o-> secondd_symmetrize_dmat_cmplx            3572        3572      1.75s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> ion_initialise                                1           1      5.92s  |
...
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      4.70s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      4.41s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      4.67s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      4.67s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_generate_psp                         1           1      4.67s  |
...
|   o-> ion_atom_construct_psp                      1           1      3.98s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      4.67s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_kpoints_internal            69988                         |
|  /o-- cell_map_kpoint_subset                     49                         |
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      4.42s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70037       70037      0.72s  |
|   o-> algor_invert_real                      140074      140074      0.46s  |
|   o-> algor_sort                              70037       70037      0.26s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           11478                         |
|  /                                                                          |
| O-> secondd_group_symmetrize_dmat             11478       11478      4.40s  |
|    /                                                                        |
|   o-> cell_factor_group_symmetry_wrapped      11478       11478      0.14s  |
|   o-> secondd_check_equiv_ions                11478       11478      0.10s  |
|   o-> secondd_apply_symmetry_to_dmat_ion     191928      191928      3.37s  |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat          191928                         |
|  /o-- secondd_tr_symmetrize_dmat              11478                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion       204135      204135      3.60s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases            204135      204135      2.19s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           11478                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped          11513       11513      3.59s  |
|    /                                                                        |
|   o-> cell_check_group                        11513       11513      3.42s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped        11513                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                          11548       11548      3.42s  |
|    /                                                                        |
|   o-> algor_invert_real                      180770      180770      0.59s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx           11478                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                11478       11478      2.90s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                11478       11478      2.57s  |
|   o-> secondd_apply_symmetry_to_dmat_ion      11478       11478      0.21s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           11478                         |
|  /o-- secondd_tr_symmetrize_dmat              11478                         |
|  /o-- secondd_calc_irreps                        35                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  23720       23720      2.68s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            388480      388480      1.28s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion     204135                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases              204135      204135      2.19s  |
|    /                                                                        |
|   o-> q_is_a_g                               189483      189483      0.62s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         3571                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             3606        3606      2.06s  |
|    /                                                                        |
|   o-> q_is_a_g                                 7212        7212      0.02s  |
|   o-> secondd_symmetrize_dmat_cmplx            3606        3606      1.80s  |
|   o-> phonon_constrain_dmat                    3606        3606      0.01s  |
|   o-> phonon_mass_weight_dmat                  3606        3606      0.01s  |
|   o-> phonon_diagonalise_d_cmplx               3606        3606      0.02s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.34s  |
...
| |/                                                                          |
| O-> algor_invert_real                        391778      391778      1.29s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               388480                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              388480      388480      1.28s  |
+-----------------------------------------------------------------------------+
...
|   o-> ion_atom_ps_diag                           59          59      1.04s  |
...
| O-> ion_atom_ps_diag                             59          59      1.04s  |
|    /                                                                        |
|   o-> ion_atom_regin                         128915      128915      0.47s  |
...
| |/                                                                          |
| O-> cell_find_reduced_cell                    70038       70038      0.72s  |
|    /                                                                        |
|   o-> algor_invert_real                       70038       70038      0.23s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate_dynamical_dfpt            53                         |
|  /o-- phonon_diag_and_output                     70                         |
|  /o-- phonon_prepare_and_diagonalise           7212                         |
|  /o-- secondd_compute_atom_phases            189483                         |
|  /o-- phonon_calculate                           35                         |
| |/                                                                          |
| O-> q_is_a_g                                 196853      196853      0.65s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       3                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       5           5      0.50s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> ion_atom_regin                           134061      134061      0.49s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.33s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.32s  |
+-----------------------------------------------------------------------------+
|   o-- cell_set_supercell_symmetry                 2                         |
|  /                                                                          |
| O-> cell_reduce_symmetry_supercell                2           2      0.26s  |
...
| |/                                                                          |
| O-> algor_sort                                70039       70039      0.26s  |
+-----------------------------------------------------------------------------+
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_kp_real                          3           3      0.18s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.18s  |
+-----------------------------------------------------------------------------+
...
|   o-> comms_reduce_kp_integer                     3           3      0.15s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> wave_initialise_wv                            1           1      0.15s  |
...
|          o-> wave_Sorthonormalise_wv              1           1      0.14s  |
|    /                                                                        |
...
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_factor_group_symmetry_wrapped        11513       11513      0.14s  |
+-----------------------------------------------------------------------------+
|   o-- wave_initialise_wv                          1                         |
|  /                                                                          |
| O-> wave_Sorthonormalise_wv                       1           1      0.14s  |
|    /                                                                        |
|   o-> wave_Sorthonormalise_wv_ks                 95          95      0.13s  |
+-----------------------------------------------------------------------------+
|   o-- wave_Sorthonormalise_wv                    95                         |
|  /                                                                          |
| O-> wave_Sorthonormalise_wv_ks                   95          95      0.13s  |
|    /                                                                        |
|   o-> wave_calc_Soverlap_wv_ks                   95          95      0.13s  |
...
|   o-> wave_beta_phi_wv_ks                        95          95      0.12s  |
...
|   o-> ion_all_beta_multi_phi_recip               95          95      0.11s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          1                         |
|  /                                                                          |
| O-> model_read_occ_eigenvalues                    1           1      0.12s  |
...
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                14319       14319      0.09s  |
+-----------------------------------------------------------------------------+
|   o-- ion_atom_generate_psp                       1                         |
|  /                                                                          |
| O-> ion_atom_descreen_psp                         1           1      0.09s  |
...
| |/                                                                          |
| O-> cell_deallocate                           11535       11535      0.04s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> phonon_mass_weight_dmat                   10748       10748      0.04s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_set_data                                  1           1      0.03s  |
...
| |/                                                                          |
| O-> ion_set_projectors                          191         191      0.00s  |
|    /                                                                        |
