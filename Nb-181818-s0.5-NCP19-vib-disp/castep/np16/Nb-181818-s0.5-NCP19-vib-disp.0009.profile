...
|   o-> phonon_real_to_fine                      1668        1668      3.41s  |
|   o-> phonon_enforce_dmat_sumrule              1667        1667      3.97s  |
|   o-> phonon_prepare_and_diagonalise           1667        1667      1.00s  |
|   o-> phonon_accumulate_adp                    1667        1667      0.02s  |
|   o-> comms_send_complex                       1667        1667     23.87s  |
|   o-> comms_send_real                          3334        3334     40.45s  |
...
| |/                                                                          |
| O-> comms_send_real                            3337        3337     40.47s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.10s  |
...
|   o-> cell_num_supercells                         2           2      0.00s  |
|   o-> algor_invert_real                           2           2      0.00s  |
|   o-> cell_reduce_symmetry_supercell              2           2      0.35s  |
...
|   o-> ion_atom_generate_psp                       1           1      4.84s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5766        5766      5.91s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            5766        5766      2.22s  |
|   o-> cell_deallocate                          5766        5766      0.02s  |
|   o-> secondd_find_inversion                   5766        5766      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               5766        5766      1.58s  |
+-----------------------------------------------------------------------------+
|   o-- cell_unfold_kpoints_arg_trace               1                         |
|  /o-- cell_generate_MP_set_wrapped                2                         |
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      5.12s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      4.80s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      5.10s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.10s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.10s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      4.80s  |
|    /                                                                        |
...
|   o-> secondd_symmetrize_dmat_cmplx            1667        1667      3.73s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      91008       91008      1.69s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           91008                         |
|  /o-- secondd_tr_symmetrize_dmat               5766                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        97503       97503      1.82s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             97503       97503      1.10s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5766                         |
...
|    /                                                                        |
|   o-> algor_invert_real                       85562       85562      0.30s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5766                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 5766        5766      1.58s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 5766        5766      1.40s  |
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  12296       12296      1.47s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            201880      201880      0.70s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.35s  |
...
| |/                                                                          |
| O-> algor_invert_real                        296570      296570      1.10s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         1667                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             1702        1702      1.03s  |
|    /                                                                        |
|   o-> q_is_a_g                                 3404        3404      0.01s  |
|   o-> secondd_symmetrize_dmat_cmplx            1702        1702      0.90s  |
...
| O-> model_read_occ_eigenvalues                    1           1      0.13s  |
|    /                                                                        |
|   o-> comms_copy_kp_real                        570         570      0.02s  |
...
| |/                                                                          |
| O-> cell_deallocate                            5823        5823      0.03s  |
+-----------------------------------------------------------------------------+
