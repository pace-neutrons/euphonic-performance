...
|   o-> phonon_real_to_fine                      1668        1668      4.15s  |
|   o-> phonon_enforce_dmat_sumrule              1667        1667      4.04s  |
|   o-> phonon_prepare_and_diagonalise           1667        1667      1.02s  |
|   o-> phonon_accumulate_adp                    1667        1667      0.02s  |
|   o-> comms_send_complex                       1667        1667     19.14s  |
|   o-> comms_send_real                          3334        3334     39.90s  |
|   o-> comms_reduce_gv_real                        1           1      1.28s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.09s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5766        5766      6.04s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            5766        5766      2.26s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.09s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.09s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      4.78s  |
|    /                                                                        |
...
|   o-> secondd_symmetrize_dmat_cmplx            1668        1668      0.90s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_calculate                         1667                         |
|  /                                                                          |
| O-> phonon_enforce_dmat_sumrule                1667        1667      4.04s  |
...
|   o-> phonon_diagonalise_d_cmplx               5001        5001      0.05s  |
|   o-> secondd_find_acoustics                   1667        1667      0.04s  |
|   o-> secondd_symmetrize_dmat_cmplx            1667        1667      3.79s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      91004       91004      1.72s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           91004                         |
|  /o-- secondd_tr_symmetrize_dmat               5766                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        97499       97499      1.85s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             97499       97499      1.11s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5766                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           5801        5801      1.77s  |
|    /                                                                        |
...
|    /                                                                        |
|   o-> algor_invert_real                       85558       85558      0.31s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5766                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 5766        5766      1.62s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 5766        5766      1.45s  |
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  12296       12296      1.51s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            201876      201876      0.72s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.35s  |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      1.28s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> algor_invert_real                        296560      296560      1.11s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      97499                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               97499       97499      1.11s  |
|    /                                                                        |
|   o-> q_is_a_g                                90439       90439      0.33s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1702        1702      0.92s  |
...
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 6703        6703      0.07s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat            5766                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
