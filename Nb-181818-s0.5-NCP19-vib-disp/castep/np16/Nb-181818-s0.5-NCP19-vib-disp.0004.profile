...
|   o-> ion_atom_pseudo_scf                         1           1      1.39s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5766        5766      5.86s  |
|    /                                                                        |
...
|   o-> phonon_diagonalise_d_cmplx               5001        5001      0.04s  |
|   o-> secondd_find_acoustics                   1667        1667      0.04s  |
|   o-> secondd_symmetrize_dmat_cmplx            1667        1667      3.71s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1668        1668      0.87s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      91004       91004      1.68s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           91004                         |
|  /o-- secondd_tr_symmetrize_dmat               5766                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        97499       97499      1.80s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             97499       97499      1.10s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5766                         |
...
|    /                                                                        |
|   o-> algor_invert_real                       85558       85558      0.30s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5766                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 5766        5766      1.56s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            201876      201876      0.69s  |
+-----------------------------------------------------------------------------+
|   o-- ion_initialise                              1                         |
|  /                                                                          |
| O-> ion_atom_pseudo_scf                           1           1      1.39s  |
...
|   o-> ion_atom_ps_diag                           59          59      1.28s  |
...
| |/                                                                          |
| O-> algor_invert_real                        296566      296566      1.09s  |
+-----------------------------------------------------------------------------+
|   o-- phonon_diag_and_output                     35                         |
|  /o-- phonon_calculate                         1667                         |
| |/                                                                          |
| O-> phonon_prepare_and_diagonalise             1702        1702      1.01s  |
|    /                                                                        |
