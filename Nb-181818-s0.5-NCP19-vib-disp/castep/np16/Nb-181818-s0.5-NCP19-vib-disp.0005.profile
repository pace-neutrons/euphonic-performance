...
|   o-> comms_send_complex                       1667        1667     20.25s  |
|   o-> comms_send_real                          3334        3334     39.47s  |
|   o-> comms_reduce_gv_real                        1           1      0.66s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.15s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5766        5766      6.10s  |
|    /                                                                        |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.15s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.15s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      4.83s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      91008       91008      1.75s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           91008                         |
|  /o-- secondd_tr_symmetrize_dmat               5766                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        97503       97503      1.87s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             97503       97503      1.13s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5766                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_reduce_symmetry_ops_wrapped           5801        5801      1.79s  |
|    /                                                                        |
...
|  /o-- phonon_calculate                            1                         |
| |/                                                                          |
| O-> comms_reduce_gv_real                          3           3      0.66s  |
|    /                                                                        |
|   o-> comms_reduce_array_real                     1           1      0.66s  |
+-----------------------------------------------------------------------------+
|   o-- comms_reduce_gv_real                        1                         |
|  /o-- comms_reduce_bnd_real                       1                         |
|  /o-- comms_reduce_kp_real                        1                         |
| |/                                                                          |
| O-> comms_reduce_array_real                       3           3      0.66s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 6703        6703      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          2                         |
|  /                                                                          |
| O-> cell_restore_wrapped                          2           2      0.05s  |
