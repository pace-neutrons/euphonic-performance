...
|   o-> phonon_recip_to_real                        1           1      8.24s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      7.05s  |
|   o-> phonon_real_to_fine                      1667        1667      3.08s  |
|   o-> phonon_enforce_dmat_sumrule              1666        1666      3.78s  |
|   o-> phonon_prepare_and_diagonalise           1666        1666      0.94s  |
|   o-> phonon_accumulate_adp                    1666        1666      0.02s  |
|   o-> comms_send_complex                       1666        1666     23.99s  |
|   o-> comms_send_real                          3332        3332     41.44s  |
...
|   o-> ion_initialise                              1           1      6.16s  |
|   o-> basis_initialise                            2           2      0.31s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.04s  |
...
|   o-> ion_atom_pseudo_scf                         1           1      1.34s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5763        5763      5.60s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            5763        5763      2.08s  |
|   o-> cell_deallocate                          5763        5763      0.02s  |
|   o-> secondd_find_inversion                   5763        5763      0.02s  |
|   o-> secondd_tr_symmetrize_dmat               5763        5763      1.49s  |
+-----------------------------------------------------------------------------+
|   o-- cell_unfold_kpoints_arg_trace               1                         |
|  /o-- cell_generate_MP_set_wrapped                2                         |
| |/                                                                          |
| O-> cell_reduce_kpoints_internal                  3           3      5.06s  |
|    /                                                                        |
|   o-> cell_kpoint_tolerance                       3           3      0.00s  |
|   o-> cell_sort_kpoints_with_recip            69988       69988      4.74s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_kpoints_spacing_wrapped                  2           2      5.04s  |
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.04s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.04s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70037       70037      4.75s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70037       70037      0.80s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1666        1666      3.55s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_symmetrize_dmat_cmplx            1667        1667      0.80s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      90957       90957      1.59s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           90957                         |
|  /o-- secondd_tr_symmetrize_dmat               5763                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        97449       97449      1.70s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             97449       97449      1.03s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5763                         |
...
|    /                                                                        |
|   o-> cell_check_group                         5798        5798      1.60s  |
+-----------------------------------------------------------------------------+
|   o-- cell_reduce_symmetry_ops_wrapped         5798                         |
|  /o-- secondd_calc_irreps                        35                         |
| |/                                                                          |
| O-> cell_check_group                           5833        5833      1.60s  |
|    /                                                                        |
|   o-> algor_invert_real                       85514       85514      0.27s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5763                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 5763        5763      1.49s  |
|    /                                                                        |
|   o-> secondd_check_equiv_ions                 5763        5763      1.32s  |
...
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_check_equiv_ions                  12290       12290      1.38s  |
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            201784      201784      0.66s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.35s  |
...
|   o-> ion_atom_ps_diag                           59          59      1.23s  |
...
| |/                                                                          |
| O-> algor_invert_real                        296522      296522      1.06s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      97449                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               97449       97449      1.03s  |
|    /                                                                        |
|   o-> q_is_a_g                                90405       90405      0.30s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_find_reduced_cell                    70038       70038      0.80s  |
|    /                                                                        |
...
+-----------------------------------------------------------------------------+
|   o-- secondd_check_equiv_ions               201784                         |
|  /                                                                          |
| O-> secondd_equiv_atoms_to_ions              201784      201784      0.66s  |
+-----------------------------------------------------------------------------+
...
|  /o-- secondd_compute_atom_phases             90405                         |
|  /o-- phonon_calculate                           35                         |
| |/                                                                          |
| O-> q_is_a_g                                  93965       93965      0.31s  |
+-----------------------------------------------------------------------------+
|   o-- cell_sort_kpoints_with_recip            70037                         |
...
|   o-> comms_map_transpose                         2           2      0.17s  |
+-----------------------------------------------------------------------------+
|   o-- basis_distribute_grids                      2                         |
|  /                                                                          |
| O-> comms_map_transpose                           2           2      0.17s  |
|    /                                                                        |
|   o-> comms_map_transpose_n                       2           2      0.17s  |
+-----------------------------------------------------------------------------+
|   o-- comms_map_transpose                         2                         |
|  /                                                                          |
| O-> comms_map_transpose_n                         2           2      0.17s  |
|    /                                                                        |
|   o-> comms_local_map                             2           2      0.17s  |
+-----------------------------------------------------------------------------+
