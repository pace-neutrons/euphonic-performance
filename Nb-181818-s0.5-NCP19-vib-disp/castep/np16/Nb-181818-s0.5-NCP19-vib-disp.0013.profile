...
|   o-> phonon_recip_to_real                        1           1      8.10s  |
|   o-> cell_num_supercells                         1           1      0.00s  |
|   o-> q_is_a_g                                   35          35      0.00s  |
|   o-> cell_supercell                              1           1      7.09s  |
|   o-> phonon_real_to_fine                      1667        1667      3.90s  |
|   o-> phonon_enforce_dmat_sumrule              1666        1666      4.03s  |
|   o-> phonon_prepare_and_diagonalise           1666        1666      1.02s  |
|   o-> phonon_accumulate_adp                    1666        1666      0.02s  |
|   o-> comms_send_complex                       1666        1666     20.35s  |
|   o-> comms_send_real                          3332        3332     38.92s  |
...
|   o-> cell_kpoints_spacing_wrapped                2           2      5.13s  |
...
| |/                                                                          |
| O-> secondd_symmetrize_dmat_cmplx              5763        5763      6.05s  |
|    /                                                                        |
...
|   o-> secondd_group_symmetrize_dmat            5763        5763      2.27s  |
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_generate_MP_set_wrapped                2           2      5.13s  |
+-----------------------------------------------------------------------------+
...
|    /                                                                        |
|   o-> bib_add                                     2           2      0.00s  |
|   o-> cell_reduce_kpoints_internal                2           2      5.13s  |
+-----------------------------------------------------------------------------+
...
|   o-> cell_sort_kpoints_with_recip            69986       69986      4.81s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_sort_kpoints_with_recip              70035       70035      4.81s  |
|    /                                                                        |
|   o-> cell_find_reduced_cell                  70035       70035      0.84s  |
...
|   o-> secondd_symmetrize_dmat_cmplx            1666        1666      3.81s  |
+-----------------------------------------------------------------------------+
...
|   o-> secondd_apply_symmetry_to_dmat_ion      90959       90959      1.73s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_group_symmetrize_dmat           90959                         |
|  /o-- secondd_tr_symmetrize_dmat               5763                         |
|  /o-- secondd_apply_symmetry_to_dmat            729                         |
| |/                                                                          |
| O-> secondd_apply_symmetry_to_dmat_ion        97451       97451      1.85s  |
|    /                                                                        |
|   o-> secondd_compute_atom_phases             97451       97451      1.11s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5763                         |
...
|    /                                                                        |
|   o-> algor_invert_real                       85516       85516      0.31s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_symmetrize_dmat_cmplx            5763                         |
|  /                                                                          |
| O-> secondd_tr_symmetrize_dmat                 5763        5763      1.62s  |
...
|    /                                                                        |
|   o-> secondd_equiv_atoms_to_ions            201786      201786      0.72s  |
+-----------------------------------------------------------------------------+
|   o-- cell_supercell                              2                         |
|  /                                                                          |
| O-> cell_generate_ionic_constraints               2           2      1.35s  |
...
| |/                                                                          |
| O-> algor_invert_real                        296518      296518      1.12s  |
+-----------------------------------------------------------------------------+
|   o-- secondd_apply_symmetry_to_dmat_ion      97451                         |
|  /                                                                          |
| O-> secondd_compute_atom_phases               97451       97451      1.11s  |
|    /                                                                        |
|   o-> q_is_a_g                                90411       90411      0.33s  |
+-----------------------------------------------------------------------------+
...
| |/                                                                          |
| O-> cell_find_reduced_cell                    70036       70036      0.84s  |
|    /                                                                        |
...
| |/                                                                          |
| O-> phonon_diagonalise_d_cmplx                 6699        6699      0.06s  |
+-----------------------------------------------------------------------------+
|   o-- model_continuation                          2                         |
|  /                                                                          |
| O-> cell_restore_wrapped                          2           2      0.05s  |
